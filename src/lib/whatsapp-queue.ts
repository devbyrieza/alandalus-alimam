...
export function buildMessageOTP(nama: string, otp: string): string {
    return `🔐 *Kode Verifikasi PPDB Al-Andalus Al-Imam*
...
Dashboard: https://pesantren-alimam.com/dashboard/pendaftar/undangan-seleksi
...
Dashboard: https://pesantren-alimam.com/dashboard/pendaftar/isi-data-lengkap
...
export function buildMessageCombinedFinal(
    ...
    let msg = `✅ *Hasil Seleksi PPDB Al-Andalus Al-Imam*
...
Dashboard: https://pesantren-alimam.com/dashboard/pendaftar/daftar-ulang`;
...
Dashboard: https://pesantren-alimam.com/dashboard/pendaftar/pengumuman`;
    } else {
