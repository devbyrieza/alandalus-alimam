    ...
    return (
        <div className="space-y-2" ref={containerRef}>
            ...
            <label className="flex items-center gap-1 text-sm font-semibold text-[var(--color-ink-700)] tracking-[-0.01em]">
                ...
                {required && (
                    <span
                        className="text-[var(--color-maroon-600)] font-bold"
                        aria-hidden="true"
                    >
                        *
                    </span>
                ...
                <button
                    ...
                    className={[
                        ...
                        disabled
                            ...
                            : isOpen
                                ? "bg-[var(--color-white)] border-[var(--color-maroon-500)] shadow-[0_0_0_3px_rgba(128,0,0,0.08),var(--shadow-xs)] text-[var(--color-ink-900)]"
                                : value
                                    ? "bg-[var(--color-white)] border-[var(--color-maroon-200)] hover:border-[var(--color-maroon-400)] shadow-[var(--shadow-xs)] text-[var(--color-ink-900)]"
                                    : "bg-[var(--color-white)] border-[var(--color-maroon-100)] hover:border-[var(--color-maroon-300)] hover:bg-[var(--color-white)] shadow-[var(--shadow-xs)] text-[var(--color-ink-400)]",
                    ].join(" ")}
                >
                    ...
                    <span className="shrink-0 flex items-center">
                        {loading ? (
                            <Loader2
                                className="w-4 h-4 animate-spin text-[var(--color-maroon-500)]"
                    ...
                    {isOpen && !disabled && (
                        ...
                        >
                            ...
                            <div
                                className="p-3"
                                style={{
                                    background: "linear-gradient(180deg, var(--color-cream-50) 0%, var(--color-white) 100%)",
                            ...
                            >
                                <div className="relative">
                                    ...
                                    <input
                                        ...
                                        onFocus={(e) => {
                                            e.currentTarget.style.borderColor = "var(--color-maroon-400)";
                                            e.currentTarget.style.boxShadow = "0 0 0 3px rgba(128,0,0,0.07)";
                                        }}
                                        onBlur={(e) => {
                                            e.currentTarget.style.borderColor = "var(--color-maroon-100)";
                                    ...
                                    <AnimatePresence>
                                        {search && (
                                            <motion.button
                                                ...
                                                onMouseEnter={(e) => {
                                                    (e.currentTarget as HTMLElement).style.background = "var(--color-maroon-100)";
                                                    (e.currentTarget as HTMLElement).style.color = "var(--color-maroon-700)";
                                                }}
                                                onMouseLeave={(e) => {
                                                    (e.currentTarget as HTMLElement).style.background = "var(--color-ink-100)";
                                                    (e.currentTarget as HTMLElement).style.color = "var(--color-ink-400)";
                                                }}
                                            >
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={[
                                                    ...
                                                    isSelected
                                                        ? "bg-[var(--color-maroon-50)] text-[var(--color-maroon-800)]"
                                                        : "text-[var(--color-ink-700)] hover:bg-[var(--color-cream-50)] hover:text-[var(--color-maroon-700)]",
                                                ].join(" ")}
                                            >
                            ...
                            {options.length > 50 && !search && (
                                <div
                                    ...
                                    style={{
                                        borderTop: "1px solid var(--color-cream-100)",
                                ...
                                >
                                    <p
                                        ...
                                        style={{ color: "var(--color-ink-400)" }}
                                    >
                                        Menampilkan 50 dari {options.length.toLocaleString("id-ID")} pilihan
