  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="flex items-center gap-2 px-3 py-1.5 rounded-full border border-slate-200 bg-white hover:border-maroon-300 hover:bg-maroon-50/30 transition-all duration-300 group"
      >
        <Globe className="w-4 h-4 text-slate-400 group-hover:text-maroon-600 transition-colors" />
            ...
            >
                  ...
                  <button
                    ...
                    className={`w-full flex items-center justify-between px-3 py-2 rounded-xl text-sm transition-all ${
                      currentLang === lang.code
                        ? "bg-maroon-50 text-maroon-700 font-bold"
              ...
              <div className="mt-2 pt-2 border-t border-slate-50">
                <button
                  ...
                  className="w-full text-center py-2 text-[10px] font-bold text-slate-400 hover:text-maroon-600 transition-colors uppercase tracking-widest"
                >
                  Bahasa Lainnya...
                </button>
              </div>
