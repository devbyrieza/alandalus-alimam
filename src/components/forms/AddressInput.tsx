...
export default function AddressInput({
  ...
  const inputClass =
    "w-full px-4 py-2.5 border-2 border-stone-200 rounded-lg focus:border-maroon-500 focus:outline-none transition-colors disabled:bg-stone-100 disabled:text-stone-500";
    ...
    <div className="space-y-4">
      ...
      <div>
        ...
        <div className="relative">
          ...
          {loadingProvinsi && (
            <Loader2 className="absolute right-10 top-1/2 -translate-y-1/2 w-4 h-4 animate-spin text-maroon-600" />
          )}
        </div>
      </div>
