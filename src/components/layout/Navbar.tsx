                ...
                <div
                  className={`w-10 h-10 sm:w-11 sm:h-11 rounded-[14px] flex items-center justify-center border overflow-hidden transition-all duration-500 group-hover:scale-105 group-hover:-rotate-3 ${
                    isScrolled
                      ...
                      : "bg-white/90 border-white/70 shadow-[0_2px_12px_rgba(139,32,32,0.12)]"
                  }`}
                >
                  <Image
            ...
            <nav
              className={`hidden lg:flex items-center gap-0.5 p-1.5 rounded-full border transition-all duration-300 ${
                isScrolled
                  ...
                  : "bg-white/70 backdrop-blur-md border-white/65 shadow-[0_2px_16px_rgba(139,32,32,0.10)]"
              }`}
            >
              {navLinks.map((link) => (
                <Link
            ...
            <button
              ...
              className={`lg:hidden p-3 rounded-2xl transition-all duration-300 min-h-[48px] min-w-[48px] flex items-center justify-center border ${
                isScrolled
                  ...
                  : "bg-white/85 backdrop-blur-sm border-white/70 text-[var(--color-ink-800)] hover:bg-white/95 shadow-[0_2px_12px_rgba(139,32,32,0.10)]"
              }`}
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow: "0 -8px 40px rgba(139,32,32,0.10)",
              }}
            >
              {/* Drag Handle */}
              <div
