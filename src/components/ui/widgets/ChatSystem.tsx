              ...
              <div className="space-y-1">
                ...
                >
                  ...
                  <div className="flex-1">
                    <h4 className="font-bold text-ink-900 group-hover:text-maroon-800 text-sm mb-0.5">
                      💬 Tanya AI Assistant
                    </h4>
          ...
          <AnimatePresence>
            {!isAiOpen && (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                className="w-[60px] h-[60px] md:w-16 md:h-16 bg-maroon-700 text-white rounded-[1.2rem] md:rounded-[1.3rem] flex items-center justify-center shadow-[0_10px_30px_rgba(128,0,0,0.4)] relative transition-all duration-300"
              >
                {/* Pulse Effect */}
                <span
                  className="absolute inset-0 rounded-[1.2rem] md:rounded-[1.3rem] bg-maroon-700/40 animate-ping"
