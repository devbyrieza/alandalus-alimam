        ...
        <div className="relative w-full bg-maroon-900 text-white px-2 sm:px-4 py-1.5 sm:py-2 flex items-center justify-center gap-2 sm:gap-4 overflow-hidden">
            <div className="flex items-center justify-center gap-2 sm:gap-3 shrink min-w-0 sm:px-8">
                ...
                <div className="flex items-center gap-1 sm:gap-1.5">
                    <Clock className="hidden xs:block w-3 h-3 sm:w-3.5 sm:h-3.5 text-cream-400 shrink-0" />
                ...
                <Link
                    href="/ppdb"
                    className="inline-flex items-center gap-1 sm:gap-1.5 px-2 xs:px-3 py-1 rounded-full bg-cream-100 text-maroon-900 text-[9px] sm:text-[11px] font-black uppercase tracking-widest hover:bg-white transition-colors whitespace-nowrap shrink-0 shadow-sm"
                >
