      ...
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="max-w-md w-full mx-auto text-center px-4">
          ...
          <div className="w-20 h-20 bg-maroon-100 rounded-full flex items-center justify-center mx-auto mb-6">
            <Lock className="w-10 h-10 text-maroon-600" />
          </div>
          ...
          {/* Current Status */}
          <div className="bg-white rounded-xl p-4 border-2 border-maroon-200 mb-6">
          ...
          {/* Next Step */}
          {nextStep && (
            <div className="bg-cream-50 rounded-xl p-4 border-2 border-cream-200 mb-6">
              <div className="flex items-start gap-3">
                ...
                <div className="text-left">
                  ...
                  <p className="text-sm text-maroon-700">{nextStep.action}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <Link
            href={redirectOnFail}
            className="inline-flex items-center gap-2 px-6 py-3 bg-maroon-600 hover:bg-maroon-700 text-white font-bold rounded-xl transition-colors"
          >
