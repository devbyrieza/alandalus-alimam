    ...
    return (
      <div className="flex items-center justify-center min-h-[400px]">
        <div className="max-w-md w-full mx-auto text-center px-4">
          ...
          {/* Current Status */}
          <div className="bg-white rounded-2xl p-4 border-2 border-primary-200 mb-6">
          ...
          {/* Next Step */}
          {nextStep && (
            <div className="bg-secondary-50 rounded-2xl p-4 border-2 border-secondary-200 mb-6">
