...
function MemberCard({
  ...
  return (
    ...
    >
      {/* Avatar */}
      <div className="relative w-[72px] h-[72px] md:w-20 md:h-20 rounded-2xl overflow-hidden shrink-0 bg-secondary-50 border border-secondary-200 shadow-xs transition-transform duration-500 group-hover:scale-[1.04]">
        {image ? (
          <Image
            src={image}
            alt={name}
