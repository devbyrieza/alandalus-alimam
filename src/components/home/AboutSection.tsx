...
export default function AboutSection() {
  ...
  return (
    <section id="about" className="section-alt relative overflow-hidden">
      ...
      >
        <div className="absolute -top-32 -left-32 w-[480px] h-[480px] rounded-full bg-maroon-100/30 blur-3xl" />
        <div className="absolute -bottom-24 -right-24 w-[360px] h-[360px] rounded-full bg-cream-200/40 blur-3xl" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full bg-cream-100/20 blur-3xl" />
      </div>
      ...
      <Container className="relative z-10">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid gap-5 lg:gap-6 mb-16 lg:mb-20">
            ...
            >
              <div className="relative overflow-hidden rounded-2xl border border-maroon-100 bg-white shadow-premium-sm group">
                {/* Card top accent bar */}
                <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-maroon-600 via-maroon-400 to-cream-400 rounded-t-2xl" />
                ...
                <div className="flex flex-col items-center text-center px-8 py-12 md:px-16 md:py-16">
                  ...
                  <blockquote className="max-w-2xl mx-auto">
                    <p className="font-display font-black text-2xl md:text-[2.15rem] leading-[1.2] tracking-tight text-maroon-900 italic">
                  ...
                  <div className="mt-8 flex items-center gap-3">
                    <div className="h-px w-10 bg-gradient-to-r from-transparent to-cream-300" />
                    <div className="w-1.5 h-1.5 rounded-full bg-cream-400" />
                    <div className="h-px w-10 bg-gradient-to-l from-transparent to-cream-300" />
                  </div>
                </div>
              </div>
            </motion.div>
              ...
              <div className="rounded-2xl border border-maroon-100 bg-white shadow-premium-sm overflow-hidden">
                ...
                <div className="flex items-center gap-4 px-8 py-7 md:px-10 border-b border-maroon-50">
                  ...
                  <div className="ml-auto hidden sm:block">
                    <span className="badge badge-cream text-[11px] tracking-wider uppercase">
                      Langkah Strategis
                    </span>
                  </div>
                </div>
                ...
                {/* Misi list */}
                <motion.ul
                  className="grid md:grid-cols-2 divide-y divide-maroon-50 md:divide-y-0 md:divide-x"
                  initial="hidden"
                  whileInView="visible"
                  viewport={{ once: true, margin: "-40px" }}
                  variants={containerVariants}
                >
                  {misi.map((item, i) => (
                    <motion.li
                      key={i}
                      variants={itemVariants}
                      className="flex gap-4 items-start p-6 md:p-8 group/item hover:bg-cream-50/60 transition-colors duration-200"
                    >
                      <div className="mt-0.5 shrink-0">
                        <div className="w-7 h-7 rounded-full bg-maroon-50 border border-maroon-100 flex items-center justify-center group-hover/item:bg-maroon-100 transition-colors duration-200">
                          <CheckCircle
                            className="w-3.5 h-3.5 text-maroon-600"
                            strokeWidth={2.25}
                          />
                        </div>
                      </div>
                      <div>
                        <span className="block text-[11px] font-bold uppercase tracking-[0.1em] text-maroon-500 mb-1.5">
                          {item.label}
                        </span>
