  ...
  return (
    <section id="gallery" className="section-std !pb-0">
      <Container>
        ...
        <div className="bg-gradient-to-br from-gold-100 to-white p-8 md:p-12 relative overflow-hidden rounded-t-[3rem] border border-cream-200 border-b-0 shadow-[0_-15px_40px_-15px_rgba(0,0,0,0.05)]">
