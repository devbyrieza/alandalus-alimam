...
function GalleryCard({
  ...
  return (
    <motion.div
      ...
      className="group relative rounded-2xl overflow-hidden cursor-pointer shadow-premium-sm border border-cream-200"
    >
      ...
      <div className="absolute bottom-0 left-0 right-0 p-5">
        ...
        <p className="text-cream-50/90 text-[0.65rem] mt-1 font-semibold uppercase tracking-[0.1em] opacity-0 translate-y-3 group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-300 delay-75">
          {description}
        </p>
      </div>
...
function ScheduleCard({
  ...
  return (
    <motion.div
      ...
      className="flex items-center gap-3.5 p-3.5 rounded-[1.25rem] bg-white border border-cream-100 transition-all duration-300 hover:border-maroon-200 shadow-premium-sm hover:shadow-premium-md"
    >
      <div
    ...
    >
      ...
      <Container className="relative z-10">
        ...
        >
          <div className="max-w-xl">
            <motion.div variants={fadeUpVariants}>
              <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-gold-200 text-maroon-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-4 shadow-xs">
          ...
          <motion.div variants={fadeUpVariants} className="shrink-0">
            <Link href="/kegiatan">
              <button className="btn-secondary group inline-flex items-center gap-2 px-6 py-2.5 bg-white border border-cream-200">
        ...
        <motion.div
          ...
          className="relative rounded-t-[2.5rem] overflow-hidden border border-b-0 border-cream-200 bg-gradient-to-br from-cream-50/50 to-white shadow-[0_-12px_40px_-12px_rgba(0,0,0,0.05)]"
        >
          <div className="absolute top-0 left-0 right-0 h-[3px] bg-gradient-to-r from-maroon-300 via-gold-300 to-transparent" />
          ...
          <div className="relative z-10 grid lg:grid-cols-[1fr_1.1fr] gap-10 lg:gap-14 items-center p-8 md:p-12 lg:p-14 max-w-6xl mx-auto">
            ...
            >
              <motion.div variants={fadeUpVariants}>
                <div className="inline-flex items-center gap-1.5 px-3.5 py-1.5 rounded-full bg-gold-50 border border-gold-200 text-maroon-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-5 shadow-xs">
