...
export default function CtaSection() {
    return (
        <section className="py-16 md:py-24 lg:py-28 bg-white relative overflow-hidden border-t border-cream-200">
            <Container>
                <motion.div
                    ...
                    className="bg-maroon-900 rounded-[2rem] md:rounded-[2.5rem] lg:rounded-[3rem] p-8 sm:p-12 md:p-16 lg:p-20 relative overflow-hidden text-center shadow-premium-lg border border-maroon-800"
                >
                    <div className="absolute inset-0 bg-gradient-to-br from-maroon-800 to-maroon-950 opacity-90" />
                    <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-[0.05] mix-blend-overlay pointer-events-none" />
                    <div className="hidden sm:block absolute -top-32 -right-32 w-[400px] h-[400px] bg-gold-400/10 rounded-full blur-[80px] pointer-events-none" />
                    <div className="hidden sm:block absolute -bottom-32 -left-32 w-[400px] h-[400px] bg-maroon-500/30 rounded-full blur-[80px] pointer-events-none" />
                    ...
                    <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
                        <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 backdrop-blur-md border border-white/10 text-white text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-6 shadow-xs">
                            <span className="text-gold-400">✦</span> Pendaftaran Dibuka 🎉
                        </div>
                        ...
                        <p className="text-[0.9375rem] md:text-[1.0625rem] text-cream-100/90 mb-10 leading-relaxed font-[450] text-center max-w-2xl mx-auto">
                        ...
                        <div className="flex flex-col sm:flex-row gap-3.5 justify-center px-4 max-w-xl mx-auto w-full">
                            <Link href="/ppdb" className="w-full sm:w-auto flex-1">
                                <button className="w-full px-8 py-3.5 rounded-full bg-white text-maroon-900 font-bold hover:bg-cream-50 transition-all duration-300 shadow-md hover:shadow-lg hover:-translate-y-0.5 text-[0.9375rem] flex items-center justify-center gap-2">
                                    Daftar Sekarang 🚀
                                </button>
                            </Link>
                        ...
                        <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 w-full max-w-2xl">
                            ...
                            <div className="flex items-center gap-2 text-cream-100/70">
                                <Award className="w-4 h-4 text-maroon-300" />
