    ...
    <section className="py-16 md:py-24 lg:py-28 bg-white relative overflow-hidden border-t border-cream-200">
      <Container>
        <motion.div
          ...
          style={{ background: "linear-gradient(135deg, var(--color-maroon-800) 0%, var(--color-maroon-950) 100%)" }}
        >
          <div className="absolute inset-0 bg-[url('/grid-pattern.svg')] opacity-[0.08] mix-blend-overlay pointer-events-none" />
          <div className="hidden sm:block glow-blob glow-blob-maroon w-[600px] h-[600px] -top-32 -right-32 opacity-30" />
          <div className="hidden sm:block glow-blob glow-blob-cream w-[500px] h-[500px] -bottom-32 -left-32 opacity-20" />

          <div className="relative z-10 max-w-3xl mx-auto flex flex-col items-center">
            <div className="section-label section-label-white mb-6">
              <span className="text-cream-300">✦</span> Pendaftaran Dibuka
            </div>
            ...
            <p className="text-[0.9375rem] md:text-[1.0625rem] text-cream-50/90 mb-10 leading-relaxed font-[450] text-center max-w-2xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center px-4 max-w-xl mx-auto w-full">
              <Link href="/ppdb" className="w-full sm:w-auto flex-1 hover-lift">
                <button className="w-full px-8 py-4 rounded-full bg-cream-300 text-maroon-950 font-bold hover:bg-cream-400 transition-all duration-300 text-[0.9375rem] flex items-center justify-center gap-2 glow-ring-maroon">
                  Daftar Sekarang
                </button>
              </Link>
            ...
            <div className="mt-12 pt-8 border-t border-white/10 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 w-full max-w-2xl">
              <div className="flex items-center gap-2 text-cream-50/70">
