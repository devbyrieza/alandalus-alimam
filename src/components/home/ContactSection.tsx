        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white rounded-3xl p-7 border border-slate-200 shadow-xs hover:shadow-md hover:border-[#ddc192] transition-all flex flex-col justify-between">
            ...
            <div className="pt-6 mt-6 border-t border-slate-100">
              <Link
                href="/kontak"
                className="h-10 px-4 rounded-xl bg-slate-50 hover:bg-slate-100 text-slate-800 font-extrabold text-xs border border-slate-200 transition-all inline-flex items-center justify-center gap-2 w-full whitespace-nowrap shrink-0"
              >
