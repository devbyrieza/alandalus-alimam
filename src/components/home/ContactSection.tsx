        ...
        <section id="kontak" className="py-20 md:py-24 bg-white relative overflow-hidden">
            <Container>
                <motion.div
                    ...
                    className="bg-cream-50 rounded-[2rem] lg:rounded-[2.5rem] p-8 md:p-12 lg:p-14 border border-cream-200 relative overflow-hidden shadow-sm"
                >
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row gap-12 lg:gap-16 items-center">
                        ...
                        <div className="lg:w-[45%] text-center lg:text-left">
                            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white border border-cream-200 text-maroon-700 text-[0.65rem] font-bold uppercase tracking-[0.12em] mb-5 shadow-xs">
                        ...
                        <div className="lg:w-[55%] grid sm:grid-cols-2 gap-3 sm:gap-4 w-full">
                            {CONTACT_INFO.map((item, idx) => (
                                <div 
                                    key={idx} 
                                    className={`bg-white p-6 rounded-2xl border border-cream-100 shadow-premium-sm hover:shadow-premium-md flex flex-col items-start group transition-all duration-400 ${idx === 0 ? 'sm:col-span-2' : ''}`}
                                >
                                    ...
                                    <h3 className="text-ink-900 font-bold text-[0.9375rem] mb-1.5 tracking-tight group-hover:text-maroon-700 transition-colors">{item.title}</h3>
