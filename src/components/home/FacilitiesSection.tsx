...
export default function FacilitiesSection() {
  return (
    <section
      id="fasilitas"
      className="section-std relative overflow-hidden border-b border-cream-100"
    >
      {/* ── Decorative blobs ── */}
      <div
        aria-hidden
        className="pointer-events-none absolute -bottom-24 -right-24 w-[480px] h-[480px] rounded-full bg-cream-100 blur-[120px] opacity-60"
      />
      <div
        aria-hidden
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-16 auto-rows-[180px] md:auto-rows-[220px]">
          {FACILITY_IMAGES.map((img, idx) => (
            ...
            >
              ...
              <div className="absolute inset-0 bg-gradient-to-t from-maroon-950/70 via-maroon-950/15 to-transparent opacity-65 group-hover:opacity-85 transition-opacity duration-400" />
