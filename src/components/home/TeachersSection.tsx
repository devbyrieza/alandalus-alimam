        ...
        <section id="pengajar" className="section-alt">
            ...
            <Container className="relative z-10">
                <div className="flex flex-col lg:flex-row gap-16 lg:gap-24 items-start">
                    ...
                    >
                        <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-white border border-gold-400 text-maroon-700 text-xs font-bold uppercase tracking-widest mb-6 shadow-sm">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-5">
                            {[
                                ...
                                { icon: Users, label: "Native Speakers", sub: "Timur Tengah", color: "gold" },
                                { icon: BookOpen, label: "Lulusan Terbaik", sub: "Dalam Negeri & Pondok Unggulan", color: "cream" },
                                ...
                                <div key={i} className="app-card p-4 flex items-center gap-5">
                                    <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 shadow-sm transition-transform duration-300 hover:scale-110 ${
                                        ...
                                        feature.color === 'gold' ? 'bg-gold-50 text-gold-700' :
                    ...
                    <div className="lg:w-[60%] grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                        {TEACHER_BACKGROUNDS.map((item, idx) => (
                            ...
                            >
                                <div className="mt-1 w-6 h-6 rounded-full bg-gold-100 flex items-center justify-center shrink-0 shadow-sm transition-transform group-hover:scale-110">
