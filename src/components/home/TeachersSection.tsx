...
export default function TeachersSection() {
  return (
    <section
      id="pengajar"
      className="section-alt relative border-y border-cream-100 overflow-hidden"
    >
        ...
        <div className="flex flex-col lg:flex-row gap-14 lg:gap-24 items-start">
          ...
          >
            ...
            <h2 className="section-title mb-5">
              Dibimbing Oleh{" "}
              <span className="text-gradient-maroon">Asatidz Kompeten</span>
            </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-3 sm:gap-4">
              {[
                ...
                <div
                  key={i}
                  className="group flex items-center gap-4 bg-white p-3.5 rounded-2xl border border-cream-100 shadow-premium-sm hover:shadow-premium-md hover:border-maroon-100 transition-all duration-400"
                >
                  <div
