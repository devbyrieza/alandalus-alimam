        ...
        >
            ...
            <div className="relative z-10 flex flex-col h-full p-6 md:p-7">
                ...
                <div className="flex gap-1 mb-4">
                    {[...Array(5)].map((_, i) => (
                        <Star key={i} className="w-3.5 h-3.5 text-gold-500 fill-gold-500" aria-hidden />
                    ))}
                </div>
                ...
                <div className="border-t border-cream-100 pt-5">
                    <div className="flex items-center gap-3.5">
                        ...
                        <div className="min-w-0 flex-1">
                            ...
                            <p className="text-[0.6rem] font-bold text-maroon-600 uppercase tracking-[0.1em] truncate mt-0.5">{role}</p>
                        </div>
...
export default function TestimonialsSection() {
    return (
        <section id="testimonials" className="section-alt relative border-y border-cream-200 overflow-hidden">
            ...
            <div
                ...
                style={{ background: "radial-gradient(circle, rgba(253,242,242,0.6) 0%, transparent 65%)" }}
            />
