            ...
            >
              ...
              <div className="flex flex-col gap-6 pt-2">
                {FEATURES.map((feature, idx) => (
                  ...
                  >
                    <div className="w-16 h-16 rounded-[1.25rem] bg-linear-to-br from-cream-50 to-cream-100 flex items-center justify-center shrink-0 shadow-premium-xs group-hover:bg-maroon-700 group-hover:rotate-6 transition-all duration-500">
