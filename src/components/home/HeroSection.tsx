...
// ─── Animation variants — no functions, delay via transition prop ───
const fadeUp = {
  hidden: {
    opacity: 0,
    y: 28,
    ...
    >
      ...
      >
        ...
        <div
          ...
          style={{
            backgroundImage: `
              linear-gradient(var(--color-maroon-400) 1px, transparent 1px),
              linear-gradient(90deg, var(--color-maroon-400) 1px, transparent 1px)
            `,
            ...
            >
              ...
              <div className="flex items-center gap-3 mt-1">
                <div className="flex -space-x-2.5">
                  {[
                    { bg: "var(--color-maroon-200)" },
                    { bg: "var(--color-cream-300)" },
                    { bg: "var(--color-maroon-300)" },
