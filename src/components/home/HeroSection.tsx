...
export default function HeroSection() {
  ...
  return (
    <section
      id="beranda"
      className="relative w-full overflow-hidden bg-gradient-to-b from-[#F0F7FF] via-[#F8FAFC] to-white pt-28 pb-20 lg:pt-36 lg:pb-28"
    >
      ...
      <Container className="relative z-10 max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-12 items-center">
          ...
          {/* ═════════ LEFT COLUMN: OMI KEMENAG TYPOGRAPHY & ACTIONS ═════════ */}
          <div className="lg:col-span-7 space-y-6 text-center lg:text-left">
            
            {/* Eyebrow Pill (Exact OMI Style) */}
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-blue-50 border border-blue-200 shadow-xs">
            ...
            {/* Two-Tone Master Headline (Exact OMI Style) */}
            ...
            <div className="flex items-center gap-3 justify-center lg:justify-start max-w-xl mx-auto lg:mx-0 py-1">
              ...
              <p className="text-xs sm:text-sm font-semibold italic text-blue-700">
                &ldquo;{BRANDING.schoolTagline}&rdquo;
              </p>
              <div className="h-px w-8 bg-blue-200" />
            </div>

            {/* 3 OMI Action Buttons (Side by side) */}
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-3 pt-2">
              {session ? (
                <Link
                  href="/dashboard"
                  className="h-12 px-6 rounded-xl bg-blue-600 text-white font-extrabold text-sm shadow-md shadow-blue-600/20 hover:bg-blue-700 hover:-translate-y-0.5 transition-all inline-flex items-center justify-center gap-2"
                >
              ...
              <Link
                href="/program"
                className="h-12 px-6 rounded-xl bg-white text-slate-800 font-extrabold text-sm border border-slate-300 shadow-sm hover:bg-slate-50 hover:-translate-y-0.5 transition-all inline-flex items-center justify-center"
              >
              ...
              <a
                ...
                className="h-12 px-6 rounded-xl bg-amber-500 text-white font-extrabold text-sm shadow-md shadow-amber-500/20 hover:bg-amber-600 hover:-translate-y-0.5 transition-all inline-flex items-center justify-center gap-2"
              >
            ...
            {/* Live Countdown Card (Exact OMI Style) */}
              ...
              <div className="bg-white border border-slate-200 rounded-2xl p-5 shadow-sm">
                ...
                <div className="grid grid-cols-4 gap-2.5 sm:gap-3 text-center">
                  <div className="bg-slate-50 border border-slate-200 rounded-xl p-3">
                    <div className="text-2xl md:text-3xl font-extrabold text-blue-600 tabular-nums">
                      {pad(countdown.days)}
                    </div>
          ...
          {/* ═════════ RIGHT COLUMN: REAL PHOTOGRAPHIC ARTWORK FRAME (OMI EXACT) ═════════ */}
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden shadow-xl border-4 border-white group bg-white aspect-[4/5] sm:aspect-square lg:aspect-[4/5]">
              ...
              {/* Top-Left Floating Glass Badge (Trophy - OMI Style) */}
              ...
              {/* Bottom-Right Floating Glass Badge (Tahfidz - OMI Style) */}
        ...
        {/* ═════════ 3 EXECUTIVE FEATURE CARDS (OMI EXACT) ═════════ */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-16">
          
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-amber-300 transition-all">
            <div className="w-12 h-12 rounded-xl bg-amber-50 text-amber-600 flex items-center justify-center font-bold text-xl mb-4 border border-amber-200">
              <Award className="w-6 h-6" />
            </div>
            <span className="text-xs font-extrabold text-amber-600 uppercase tracking-wider">Apresiasi Prestasi</span>
          ...
          <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm hover:shadow-md hover:border-blue-300 transition-all">
            <div className="w-12 h-12 rounded-xl bg-blue-50 text-blue-600 flex items-center justify-center font-bold text-xl mb-4 border border-blue-200">
              <GraduationCap className="w-6 h-6" />
            </div>
            <span className="text-xs font-extrabold text-blue-600 uppercase tracking-wider">Kurikulum Terpadu</span>
