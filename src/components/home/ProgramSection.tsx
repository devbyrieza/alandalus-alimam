...
function getTokens(variant: ProgramVariant) {
    switch (variant) {
        case "maroon":
            return {
                accentBar: "bg-gradient-to-r from-maroon-700 via-maroon-500 to-maroon-300",
                corner: "bg-maroon-50",
                ...
                checkHover: "group-hover/item:bg-maroon-600 group-hover/item:border-maroon-600",
                checkIcon: "text-maroon-600 group-hover/item:text-white",
                ctaBtn: "bg-white border-maroon-200 text-maroon-800 hover:bg-maroon-700 hover:border-maroon-700 hover:text-white shadow-sm hover:shadow-md",
            };
        case "gold":
            return {
                ...
                checkHover: "group-hover/item:bg-gold-500 group-hover/item:border-gold-500",
                checkIcon: "text-gold-600 group-hover/item:text-white",
                ctaBtn: "bg-white border-gold-300 text-maroon-800 hover:bg-gold-400 hover:border-gold-400 hover:text-maroon-950 shadow-sm hover:shadow-md",
            };
        case "cream":
            return {
                ...
                checkHover: "group-hover/item:bg-maroon-800 group-hover/item:border-maroon-800",
                checkIcon: "text-maroon-600 group-hover/item:text-gold-300",
                ctaBtn: "bg-white border-cream-200 text-maroon-800 hover:bg-maroon-800 hover:border-maroon-800 hover:text-white shadow-sm hover:shadow-md",
            };
    }
}
...
export default function ProgramSection() {
    return (
        <section id="program" className="section-alt relative overflow-hidden border-y border-cream-100">
