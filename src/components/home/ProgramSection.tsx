...
const PROGRAMS: ProgramItem[] = [
  {
    ...
    desc: "Memadukan tahfizh Al-Qur'an, kurikulum pendidikan nasional, kurikulum khas Al Andalus berbasis Kitab Turots, Leadership, dan Entrepreneurship. Bahasa pengantar Bahasa Arab.",
    features: [
      ...
      "Leadership & Islamic Entrepreneurship",
    ],
