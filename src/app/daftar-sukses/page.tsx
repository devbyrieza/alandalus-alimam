      ...
      <div className="bg-secondary-50 border border-secondary-200 rounded-[1.5rem] p-6 mb-6 relative z-10">
        ...
        <div className="bg-white rounded-3xl border border-secondary-200 p-6 sm:p-8 mb-3 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 app-card">
          ...
          <div className="flex items-center justify-between gap-3 flex-wrap">
            <p className="text-2xl font-black text-primary-900 break-all bg-secondary-50/50 px-2 py-1 rounded-2xl">
              {nomor_pendaftaran}
            </p>
            <button
              onClick={() => handleCopy(nomor_pendaftaran, "nomor")}
              className="p-4.5 bg-secondary-50 hover:bg-secondary-200 border border-primary-200 rounded-3xl transition-colors shrink-0 app-card hover:scale-105 active:scale-95"
