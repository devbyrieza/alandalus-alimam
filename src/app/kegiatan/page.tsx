...
const FeatureCard = ({
  ...
  >
    ...
    <div className={`relative ${index % 2 === 1 ? "lg:col-start-2" : ""}`}>
      <div
        className={`aspect-4/3 rounded-[3.5rem] overflow-hidden shadow-lg relative group ${index % 2 === 0 ? "rotate-2" : "-rotate-2"} hover:rotate-0 transition-transform duration-700 border border-maroon-100 p-2 bg-white`}
      >
...
const WeeklyActivityCard = ({
  ...
  >
    <div
      className={`w-14 h-14 ${activity.bg} rounded-2xl flex items-center justify-center ${activity.color} mx-auto mb-6 group-hover:scale-110 transition-transform border border-maroon-100`}
    >
    ...
    <div className="bg-maroon-50 rounded-xl px-4 py-3 border border-maroon-100">
      <p className="text-xs font-black text-maroon-800 uppercase tracking-tight">
        {activity.benefit}
      </p>
    </div>
  </motion.div>
...
const EkskulCard = ({
  ...
  >
    ...
    <div className="pt-3 md:pt-4 border-t border-surface-50 mt-auto">
      <p className="text-[10px] md:text-xs font-black text-maroon-700 uppercase tracking-widest break-words">
        {ekskul.benefit}
      </p>
    </div>
  </motion.div>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-20">
            ...
            <p className="text-xl text-ink-600 font-medium leading-relaxed">
              ...
              mematangkan{" "}
              <span className="text-maroon-600 font-bold uppercase tracking-tight">
