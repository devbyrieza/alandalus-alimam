                ...
                <div className={idx % 2 === 1 ? "lg:col-start-1" : ""}>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-10">
                    {program.stats.map((stat, sIdx) => (
                      <div
                        key={sIdx}
                        className={`app-card bg-white p-5 rounded-[2rem] border border-maroon-50 shadow-sm hover:shadow-md transition-all text-center group`}
                      >
                        <div
                          className={`w-10 h-10 rounded-xl mx-auto mb-3 flex items-center justify-center transition-transform group-hover:scale-110 border border-maroon-100
                  ...
                  >
                    ...
                    <h3 className="text-2xl font-black text-ink-950 mb-8 flex items-center gap-3">
                      <div
                        className={`w-3 h-10 rounded-full ${program.theme === "maroon" ? "bg-maroon-600" : "bg-gold-500"}`}
                      />
                      Kurikulum & Fokus
                    </h3>
          ...
          >
            ...
            <div className="relative z-10">
              <h2 className="text-xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl font-display font-black mb-4 sm:mb-6 md:mb-8 text-white leading-tight">
                Mulai Perjalanan <br />{" "}
                <span className="text-cream-300">Terbaik</span> Mereka
              </h2>
