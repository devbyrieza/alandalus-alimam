...
export default function DaftarPage() {
  ...
  const validateForm = (): boolean => {
    ...
    if (!formData.jenis_kelamin) {
      ...
      errors.jenis_kelamin = "Mohon maaf, pendaftaran Santri Putri dilakukan melalui Pesantren Ulul Albaab.";
    }
            ...
            <form onSubmit={handleSubmit} className="space-y-12 relative z-10">
              ...
              >
                ...
                <div data-error={!!fieldErrors.jenjang} className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  {[
                    { value: "MTs", title: "MTs Putra", subtitle: "Lulusan SD/Sederajat" },
                    { value: "IL", title: "I'dad Lughowi Putra", subtitle: "Lulusan SMP/Sederajat" },
                  ].map((option) => {
