    ...
    <main className="min-h-screen bg-white py-12 md:py-24 relative overflow-hidden">
      ...
      <Container className="relative z-10">
            ...
            <AnimatePresence>
              {(formData.nik || formData.nama_lengkap || formData.no_hp) && (
                <motion.div
                  ...
                  className="bg-maroon-50 border border-maroon-100/50 rounded-3xl p-6 flex items-start gap-4 relative z-10 overflow-hidden"
                >
                  <div className="w-10 h-10 bg-maroon-500 rounded-full flex items-center justify-center text-white shrink-0 shadow-premium-xs">
                    <CheckCircle className="w-6 h-6" />
                  </div>
                  <div className="flex-1">
                    <p className="text-lg font-display font-black text-maroon-900 leading-none mb-1">
                      Melanjutkan Draft Pendaftaran
                    </p>
                    <p className="text-sm text-maroon-600 font-medium">
                    ...
                    <button
                      ...
                      className="mt-3 flex items-center gap-1.5 text-xs font-black uppercase tracking-widest text-maroon-800 hover:text-maroon-950 transition-colors"
                    >
            ...
            <form onSubmit={handleSubmit} className="space-y-12 relative z-10">
                          ...
                          >
                            {formData.jenjang === option.value && (
                              <motion.div
                                ...
                                className="w-3 h-3 rounded-full bg-maroon-600"
                              />
                            )}
                          </div>
                          <div>
              ...
              >
                ...
                <p className="text-center text-sm text-ink-600 font-bold uppercase tracking-widest mt-8">
                  ...
                  <Link
                    href="/login"
                    className="text-maroon-700 hover:text-maroon-800 hover:bg-cream-50 px-3 py-1 rounded-full transition-colors ml-1 border border-transparent hover:border-cream-200"
                  >
                    Masuk di sini
                  </Link>
                </p>
        ...
        >
          <Link
            href="/"
            className="inline-flex items-center gap-2 text-ink-600 hover:text-maroon-700 text-xs font-black uppercase tracking-widest transition-colors"
          >
