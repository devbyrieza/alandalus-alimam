...
const ContactInfoCard = ({
  ...
  <motion.div
    ...
    className="app-card bg-white p-6 sm:p-5 md:p-8 rounded-2xl sm:rounded-[2.5rem] border border-primary-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 hover:shadow-2xl shadow-primary/30  shadow-primary/20 transition-all group flex flex-col items-center text-center"
  >
    <div className="w-16 h-16 rounded-2xl bg-primary-50 flex items-center justify-center text-primary-600 mb-6 group-hover:scale-110 transition-transform shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-primary-100">
...
const SocialCard = ({ social, delay = 0 }: { social: any; delay?: number }) => (
  <motion.a
    ...
    className={`app-card group flex items-center gap-4 sm:gap-5 p-6 sm:p-8 sm:p-5 rounded-2xl sm:rounded-[2rem] bg-white border border-primary-50 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 hover:shadow-2xl shadow-primary/30  shadow-primary/20 transition-all`}
  >
    <div
      className={`w-14 h-14 rounded-2xl ${social.bgLight} flex items-center justify-center ${social.textColor} group-hover:scale-110 transition-transform shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-primary-50`}
    >
        ...
        <Container>
          <div className="grid lg:grid-cols-5 gap-10 lg:gap-24 items-start">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="lg:col-span-3 bg-white p-6 md:p-16 rounded-[2.5rem] md:rounded-[4rem] shadow-2xl shadow-primary/30  shadow-primary/20 border border-primary-50 relative overflow-hidden"
            >
              ...
              <div className="relative z-10">
                <div className="flex items-center gap-4 md:gap-5 mb-8 md:mb-12">
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-primary-900 rounded-2xl md:rounded-3xl flex items-center justify-center text-white shadow-2xl shadow-primary/30  shadow-primary/20 shrink-0">
                ...
                >
                  <div className="grid md:grid-cols-2 gap-6 md:gap-8">
                    <div className="space-y-2 md:space-y-3">
                      ...
                      <input
                        ...
                        required
                        className="w-full px-5 py-3 md:px-8 md:py-5 rounded-3xl md:rounded-2xl bg-primary-50 border border-transparent focus:bg-white focus:border-primary-200 focus:ring-4 focus:ring-primary-50 transition-all font-bold text-ink-900 placeholder:text-ink-300 text-sm md:text-base"
                  ...
                  <div className="space-y-2 md:space-y-3">
                    ...
                    <textarea
                      ...
                      required
                      rows={5}
                      className="w-full px-5 py-3 md:px-8 md:py-5 rounded-3xl md:rounded-2xl bg-primary-50 border border-transparent focus:bg-white focus:border-primary-200 focus:ring-4 focus:ring-primary-50 transition-all font-bold text-ink-900 placeholder:text-ink-300 text-sm md:text-base resize-none"
                  ...
                  <motion.button
                    ...
                    className="w-full py-4 md:py-6 rounded-pill bg-primary-900 text-white font-black text-lg md:text-xl hover:bg-gold-600 shadow-2xl shadow-primary/30  shadow-primary/20 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                  >
            ...
            <div className="lg:col-span-2 space-y-8 md:space-y-12">
              ...
              <motion.div
                ...
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
                className="bg-white p-3 md:p-6 sm:p-8 rounded-[2rem] md:rounded-[3rem] border border-surface-100 shadow-premium-lg"
              >
                <div className="rounded-[2rem] md:rounded-[2.5rem] overflow-hidden h-[300px] md:h-[400px] relative border border-surface-50">
                  ...
                  />
                  <div className="absolute bottom-3 left-3 md:bottom-6 md:left-6 bg-white/90 backdrop-blur-sm px-3 py-1.5 md:px-6 md:py-3 rounded-2xl md:rounded-2xl shadow-2xl shadow-primary/30  shadow-primary/20 border border-primary-100 flex items-center gap-1.5 md:gap-3 z-10">
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-6 justify-center px-4">
                <Link href="/ppdb">
                  <button className="w-full sm:w-auto px-6 sm:px-6 md:px-10 py-3.5 sm:py-4 md:py-5 rounded-pill bg-white text-primary-900 font-black text-sm sm:text-base md:text-lg hover:bg-secondary-100 shadow-2xl shadow-primary/30  shadow-primary/20 transition-all min-h-[48px] sm:min-h-[52px]">
                    Daftar PPDB Baru
                  </button>
                </Link>
                <a
