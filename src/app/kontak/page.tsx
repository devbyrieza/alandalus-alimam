...
const ContactInfoCard = ({
    ...
    >
        ...
        <h3 className="text-xl font-display font-black text-maroon-950 mb-3">{title}</h3>
        {href ? (
...
const SocialCard = ({ social, delay = 0 }: { social: any, delay?: number }) => (
    ...
    >
        <div className={`w-14 h-14 rounded-2xl ${social.bgLight} flex items-center justify-center ${social.textColor} group-hover:scale-110 transition-transform shadow-sm border border-maroon-50`}>
