...
function PilihVerifikasiContent() {
  ...
  return (
    <div className="max-w-lg w-full bg-white rounded-2xl shadow-2xl border-2 border-maroon-200 p-8">
      {/* Demo Mode Badge */}
      {DEMO_MODE && (
        <div className="mb-6 p-3 bg-maroon-50 border-2 border-maroon-100 rounded-xl app-card">
      ...
      <div className="text-center mb-8">
        <div className="w-20 h-20 bg-gradient-to-r from-maroon-500 to-gold-500 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <p className="text-xl font-black text-maroon-700">{no_hp}</p>
      </div>
