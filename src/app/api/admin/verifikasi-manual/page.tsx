...
export default function VerifikasiManualPage() {
  ...
  const openWhatsApp = (phone: string, kode: string) => {
    ...
    const message = encodeURIComponent(
      `Kode verifikasi SPMB Pesantren Al Imam Al Islami: ${kode}`,
    );
    ...
    <div className="min-h-screen bg-gray-50 p-6 sm:p-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-3xl shadow p-6 mb-6">
          <div className="flex justify-between items-center">
            ...
            <button
              ...
              className="px-4 py-2 bg-primary-600 text-white rounded-2xl hover:bg-primary-700 flex items-center gap-2"
            >
              <RefreshCw
        ...
        <div className="space-y-4">
          {pending.length === 0 ? (
            <div className="bg-white rounded-3xl shadow p-5 md:p-8 text-center">
            ...
            pending.map((item) => (
              <div key={item.id} className="bg-white rounded-3xl shadow p-6">
                <div className="flex flex-col md:flex-row justify-between gap-4">
                  ...
                  {/* Kode OTP */}
                  <div className="bg-primary-50 rounded-2xl p-6 sm:p-8 min-w-[200px]">
                  ...
                  {item.verifikasi_channel === "whatsapp_manual" ? (
                    <>
                      <button
                        ...
                        className="px-4 py-2 bg-[#550000] text-white rounded-2xl hover:bg-[#550000] flex items-center gap-2"
                      >
                    ...
                    <button
                      ...
                      className="px-4 py-2 bg-purple-600 text-white rounded-2xl hover:bg-purple-700 flex items-center gap-2"
                    >
                      <Phone className="w-4 h-4" />
                      Kirim via Wablas
                    </button>
