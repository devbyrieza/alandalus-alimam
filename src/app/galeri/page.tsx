...
const ALBUMS: Album[] = [
  {
    ...
    items: [
      { src: "/images/masjid.webp", label: "Tampak Depan Masjid Jami' Al Imam" },
  ...
  },
  {
    ...
    desc: "Pusat kegiatan administrasi, penerimaan tamu, dan lanskap lingkungan Pesantren Al Imam.",
    cover: "/images/tentang.webp",
    items: [
      { src: "/images/tentang.webp", label: "Gedung Utama Pesantren Al Imam" },
