...
const HeroStat = ({
  ...
  >
    ...
    <p className="text-2xl font-black text-maroon-950 leading-none mb-1">
      {value}
    </p>
    <p className="text-[10px] text-maroon-500/70 font-extrabold uppercase tracking-widest">
      {label}
    </p>
  </motion.div>
);
...
export default function FasilitasPage() {
  ...
  return (
    <main className="bg-white min-h-screen">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded-[2rem] shadow-xl border border-maroon-100 flex flex-col items-center gap-1 z-20">
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-maroon-500">
                  Sneak Peek
                </span>
                <span className="text-sm font-black text-maroon-900">
                  Campus Tour
                </span>
              </div>
            </motion.div>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              >
                <div className="app-card bg-white p-8 sm:p-12 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black text-maroon-950 mb-6 leading-[1.1]">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                    <div className="flex items-start gap-4 group/item">
                      ...
                      <div>
                        <h4 className="font-black text-maroon-950 text-[15px] sm:text-lg uppercase tracking-tight">
                          Kapasitas Luas
                        </h4>
                        <p className="text-xs sm:text-sm text-maroon-500 font-medium">
                          2 Lantai utama luas
                        </p>
                      </div>
                    </div>
        ...
        <Container>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 max-w-5xl mx-auto">
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">
                Perpustakaan
              </h3>
              <p className="text-sm text-maroon-950/60 font-medium">
                Ribuan koleksi kitab & buku
              </p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">
                  📚 Akademik
                </span>
              </div>
            </motion.div>
      ...
      <section
        id="visit"
        className="py-24 md:py-32 section-alt border-y border-maroon-100 relative overflow-hidden"
      >
        {/* Background decoration */}
        <div className="absolute top-0 left-0 w-64 h-64 bg-maroon-50 rounded-full blur-[100px] -translate-x-1/2 -translate-y-1/2 opacity-60" />
            ...
            <div className="grid lg:grid-cols-12 gap-12 items-center">
              ...
              <div className="lg:col-span-5">
                <motion.div
                  ...
                  viewport={{ once: true }}
                >
                  <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-white border border-maroon-100 text-maroon-700 text-xs font-bold uppercase tracking-widest mb-6 shadow-sm">
                  ...
                  <h2 className="text-4xl md:text-5xl font-display font-black text-ink-950 mb-6 leading-tight">
                    Kunjungi <span className="text-gradient-maroon">Kami</span>
                  </h2>
                  <p className="text-lg text-ink-600 mb-8 leading-relaxed font-medium">
                    Masih banyak fasilitas pendukung lainnya di dalam Pesantren Al Imam.
                    Ingin melihat langsung? Jadwalkan kunjungan Anda melalui formulir ini.
                  </p>
                  
                  <div className="space-y-6">
                    <div className="flex gap-4">
                      <div className="w-12 h-12 rounded-2xl bg-maroon-50 flex items-center justify-center text-maroon-600 shrink-0 border border-maroon-100">
                  ...
                  <motion.div
                    ...
                    viewport={{ once: true }}
                    transition={{ delay: 0.2 }}
                    className="mt-10 bg-white p-2.5 rounded-[2rem] border border-maroon-100 shadow-lg shadow-maroon-900/5 overflow-hidden relative group"
                  >
                    <div className="rounded-[1.5rem] overflow-hidden h-[200px] relative bg-maroon-50">
                      <iframe
                        ...
                        title="Lokasi Pesantren Al Imam"
                        className="grayscale group-hover:grayscale-0 transition-all duration-700 opacity-80 group-hover:opacity-100"
                      />
                      <div className="absolute bottom-3 left-3 bg-white/90 backdrop-blur-sm px-4 py-2 rounded-xl shadow-sm border border-maroon-100 flex items-center gap-2 z-10 pointer-events-none">
              ...
              <div className="lg:col-span-7">
                <motion.div
                  ...
                  whileInView={{ opacity: 1, x: 0 }}
                  viewport={{ once: true }}
                  className="app-card bg-white p-6 sm:p-10 border border-maroon-50 shadow-2xl relative overflow-hidden"
                >
                  {formStatus === 'success' ? (
                    <motion.div 
                    ...
                    >
                      ...
                      <button 
                        ...
                        className="px-6 py-3 rounded-xl bg-maroon-50 text-maroon-700 font-bold hover:bg-maroon-100 transition-colors"
                      >
                        Isi Form Kembali
                      </button>
                    </motion.div>
                    ...
                    <form onSubmit={(e) => { e.preventDefault(); setFormStatus('success'); }} className="space-y-6">
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <User className="w-4 h-4 text-maroon-600" /> Nama Lengkap
                          </label>
                          <input required type="text" placeholder="Contoh: Bapak Ahmad" className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" />
                        </div>
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Smartphone className="w-4 h-4 text-maroon-600" /> Nomor WhatsApp
                          </label>
                          <input required type="tel" placeholder="Contoh: 0812..." className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" />
                        </div>
                      </div>
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Calendar className="w-4 h-4 text-maroon-600" /> Rencana Tanggal
                          </label>
                          <input required type="date" className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900" />
                        </div>
                        <div className="space-y-2">
                          <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                            <Clock className="w-4 h-4 text-maroon-600" /> Rencana Jam
                          </label>
                          <select required className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900 cursor-pointer">
                      ...
                      <div className="space-y-2">
                        <label className="text-sm font-black text-ink-950 flex items-center gap-2">
                          <Users className="w-4 h-4 text-maroon-600" /> Jumlah Orang yang Datang
                        </label>
                        <input required type="number" min="1" placeholder="Contoh: 3" className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" />
                      </div>

                      <button type="submit" className="w-full py-4 rounded-xl bg-maroon-600 text-white font-black text-lg shadow-lg shadow-maroon-600/20 hover:bg-maroon-700 hover:-translate-y-0.5 hover:shadow-xl transition-all flex items-center justify-center gap-2 mt-2">
