...
export default function FasilitasPage() {
  return (
    <main className="bg-white min-h-screen">
      ...
      <section
        id="gallery"
        className="py-24 md:py-32 section-alt border-y border-maroon-100"
      >
        <Container>
          <div className="text-center md:text-left max-w-3xl mb-12 sm:mb-16">
            ...
            >
              Lihat langsung suasana dan lingkungan Pesantren Al Andalus Al Imam
              dari berbagai sudut.
            </motion.p>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mb-4 lg:mb-6">
              ...
              >
                ...
                <div className="absolute bottom-6 md:bottom-8 left-6 md:left-8 right-6 md:right-8">
                  ...
                  <p className="text-maroon-50/90 text-sm md:text-lg mt-1 md:mt-2 font-medium">
                    Pusat peribadatan
                  </p>
                </div>
              </motion.div>
              ...
              >
                ...
                <div className="absolute bottom-6 md:bottom-8 left-6 md:left-8 right-6 md:right-8">
                  ...
                  <p className="text-maroon-50/90 text-xs md:text-sm mt-1 md:mt-2 font-medium">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-4 lg:mb-6">
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                  ...
                  <p className="text-maroon-50/90 text-xs sm:text-sm mt-1 font-medium hidden sm:block">
            ...
            >
              ...
              <p className="text-sm font-medium text-ink-700">
                ...
                Andalus Al Imam. Silakan jadwalkan kunjungan untuk melihat
                langsung.
              </p>
            </motion.div>
          </div>
