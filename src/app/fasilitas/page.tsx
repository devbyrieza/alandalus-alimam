...
Saya ingin mengajukan Jadwal Kunjungan ke Pesantren Al Imam.
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input 
                            ...
                            className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900 placeholder:text-ink-300" 
                      ...
                      <div className="grid sm:grid-cols-2 gap-6">
                        <div className="space-y-2">
                          ...
                          <input 
                            required 
                            type="date" 
                            className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900" 
                        ...
                        <div className="space-y-2">
                          ...
                          <select 
                            required 
                            className="w-full px-4 py-3.5 rounded-xl border border-ink-100 bg-surface-50 focus:bg-white focus:border-maroon-500 focus:ring-4 focus:ring-maroon-500/10 outline-hidden transition-all font-medium text-ink-900 cursor-pointer"
                            value={visitForm.jam}
