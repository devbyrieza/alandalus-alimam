...
const HeroStat = ({ icon: Icon, value, label, delay = 0 }: { icon: any, value: string, label: string, delay?: number }) => (
  ...
  >
    <div className="w-12 h-12 rounded-xl bg-maroon-50 flex items-center justify-center text-maroon-600 mb-3 border border-maroon-100 shadow-sm">
      <Icon className="w-6 h-6" />
    </div>
    <p className="text-2xl font-black text-maroon-950 leading-none mb-1">{value}</p>
    <p className="text-[10px] text-maroon-500/70 font-extrabold uppercase tracking-widest">{label}</p>
  </motion.div>
);
  ...
  return (
    <main className="bg-white min-h-screen">
      ...
      <section className="relative py-24 md:py-32 overflow-hidden section-std">
        <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-maroon-50/60 rounded-full blur-[120px] -translate-y-1/2 translate-x-1/2 pointer-events-none" />
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              <div className="space-y-6 pt-12">
                <div className="aspect-4/5 rounded-[3rem] overflow-hidden shadow-lg relative group border border-maroon-100">
                  ...
                  <div className="absolute inset-0 bg-linear-to-t from-maroon-950/70 to-transparent flex items-end p-8">
                    <span className="text-white font-bold text-xl drop-shadow-md">Masjid Jami'</span>
                  </div>
                </div>
                <div className="aspect-square rounded-[3rem] overflow-hidden shadow-lg relative group border border-maroon-100">
              ...
              {/* Floating Badge */}
              <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-white p-5 rounded-[2rem] shadow-xl border border-maroon-100 flex flex-col items-center gap-1 z-20">
                <Camera className="w-8 h-8 text-maroon-600 mb-1" />
                <span className="text-[10px] font-black uppercase tracking-[0.2em] text-maroon-500">Sneak Peek</span>
      ...
      <section className="py-24 md:py-32 relative section-alt border-y border-maroon-100">
        <Container>
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              >
                <div className="app-card bg-white p-8 sm:p-12 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <div className="w-16 h-16 sm:w-20 sm:h-20 bg-maroon-50 rounded-2xl flex items-center justify-center text-maroon-700 mb-8 sm:mb-10 shadow-sm transition-transform group-hover:scale-110 border border-maroon-100">
                    <Home className="w-8 h-8 sm:w-10 sm:h-10" />
                  </div>

                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black text-maroon-950 mb-6 leading-[1.1]">Masjid Jami' <br className="hidden sm:block" /> Al-Imam</h3>
                  <p className="text-base sm:text-lg lg:text-xl text-maroon-950/70 mb-8 sm:mb-10 leading-relaxed font-medium">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                    <div className="flex items-start gap-4 group/item">
                      ...
                      <div>
                        <h4 className="font-black text-maroon-950 text-[15px] sm:text-lg uppercase tracking-tight">Kapasitas Luas</h4>
                        <p className="text-xs sm:text-sm text-maroon-500 font-medium">2 Lantai utama luas</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 group/item">
                      <div className="w-8 h-8 rounded-full bg-maroon-600 text-white flex items-center justify-center shrink-0 shadow-sm mt-0.5">
                      ...
                      <div>
                        <h4 className="font-black text-maroon-950 text-[15px] sm:text-lg uppercase tracking-tight">Kenyamanan</h4>
                        <p className="text-xs sm:text-sm text-maroon-500 font-medium">Full AC & Karpet Empuk</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              >
                <div className="aspect-square rounded-[3rem] sm:rounded-[4rem] bg-white p-3 sm:p-4 shadow-xl relative rotate-2 hover:rotate-0 transition-transform duration-700 border border-maroon-100">
            ...
            <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
              ...
              >
                <div className="app-card bg-white p-8 sm:p-12 lg:p-16 relative overflow-hidden group hover:-translate-y-1 transition-transform duration-500">
                  ...
                  <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black text-maroon-950 mb-6 leading-[1.1]">Asrama <br className="hidden sm:block" /> Berkualitas</h3>
                  <p className="text-base sm:text-lg lg:text-xl text-maroon-950/70 mb-8 sm:mb-10 leading-relaxed font-medium">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 sm:gap-8">
                    <div className="flex items-start gap-4 group/item">
                      ...
                      <div>
                        <h4 className="font-black text-maroon-950 text-[15px] sm:text-lg uppercase tracking-tight">Kekeluargaan</h4>
                        <p className="text-xs sm:text-sm text-maroon-500 font-medium">Musyrif Pembimbing 24 jam</p>
                      </div>
                    </div>
                    <div className="flex items-start gap-4 group/item">
                      <div className="w-8 h-8 rounded-full bg-maroon-600 text-white flex items-center justify-center shrink-0 shadow-sm mt-0.5">
                      ...
                      <div>
                        <h4 className="font-black text-maroon-950 text-[15px] sm:text-lg uppercase tracking-tight">Higienitas</h4>
                        <p className="text-xs sm:text-sm text-maroon-500 font-medium">Standar kebersihan tinggi</p>
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <Container>
          <div className="text-center max-w-3xl mx-auto mb-16">
            <motion.h2
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-3xl md:text-5xl font-black text-maroon-950 mb-4"
            >
              Fasilitas <span className="text-maroon-600">Penunjang</span>
            </motion.h2>
            <motion.p
              initial={{ opacity: 0, y: 10 }}
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="text-base md:text-lg text-maroon-950/70 font-medium leading-relaxed"
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 md:gap-6 max-w-5xl mx-auto">
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              transition={{ delay: 0.1 }}
              className="app-card bg-white p-6 md:p-8 flex flex-col items-start group hover:-translate-y-1 transition-transform border border-maroon-50 shadow-sm"
            >
              <div className="w-12 h-12 bg-maroon-50 rounded-xl flex items-center justify-center text-maroon-700 mb-5 group-hover:scale-110 transition-transform border border-maroon-100 shadow-sm">
                <BookOpen className="w-6 h-6" />
              </div>
              <h3 className="font-black text-lg text-maroon-950 mb-2">Perpustakaan</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Ribuan koleksi kitab & buku</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">📚 Akademik</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Laboratorium</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Sains & Komputer</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">🔬 Praktikum</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Dapur Sehat</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Menu bergizi 3x sehari</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">🍽️ Nutrisi</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Depot Air</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Air minum higienis gratis</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">💧 Minuman</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Klinik Santri</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Layanan medis internal</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">🏥 Kesehatan</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Security</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Keamanan CCTV 24 Jam</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">🛡️ Keamanan</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Aula Besar</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Kapasitas 500 orang</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">🏛️ Event</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Internet</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Akses WiFi Terfilter</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">📶 Teknologi</span>
              </div>
            </motion.div>
            ...
            >
              ...
              <h3 className="font-black text-lg text-maroon-950 mb-2">Lapangan Basket</h3>
              <p className="text-sm text-maroon-950/60 font-medium">Lapangan olahraga standar</p>
              <div className="mt-4 pt-4 border-t border-maroon-50 w-full">
                <span className="text-xs text-maroon-600 font-bold uppercase tracking-widest">🏀 Olahraga</span>
              </div>
            </motion.div>
          </div>
        </Container>
      ...
      <section id="gallery" className="py-24 md:py-32 section-alt border-y border-maroon-100">
        <Container>
          <div className="text-center md:text-left max-w-3xl mb-12 sm:mb-16">
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="inline-flex items-center gap-2 px-4 py-1.5 rounded-pill bg-white border border-maroon-100 text-maroon-700 text-xs font-bold uppercase tracking-widest mb-6 shadow-sm"
            >
          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6 mb-4 lg:mb-6">
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.1 }}
                className="lg:col-span-2 row-span-2 relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden group aspect-4/3 shadow-md hover:shadow-xl transition-all duration-500 border border-maroon-100"
              >
                <Image
                  src="/images/masjid.webp"
                  alt="Masjid Jami' Al-Imam"
                ...
                <div className="absolute bottom-6 md:bottom-8 left-6 md:left-8 right-6 md:right-8">
                  ...
                  <p className="text-maroon-50/90 text-sm md:text-lg mt-1 md:mt-2 font-medium">Pusat peribadatan</p>
                </div>
              </motion.div>
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.2 }}
                className="lg:col-span-1 row-span-2 relative rounded-[2rem] md:rounded-[2.5rem] overflow-hidden group aspect-4/3 lg:aspect-2/3 shadow-md hover:shadow-xl transition-all duration-500 border border-maroon-100"
              >
                <Image
                  src="/images/kelas-dari-dalam.webp"
                ...
                <div className="absolute bottom-6 md:bottom-8 left-6 md:left-8 right-6 md:right-8">
                  ...
                  <p className="text-maroon-50/90 text-xs md:text-sm mt-1 md:mt-2 font-medium">Fasilitas pembelajaran modern</p>
                </div>
              </motion.div>
            </div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 lg:gap-6 mb-4 lg:mb-6">
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.3 }}
                className="relative rounded-2xl sm:rounded-[2rem] overflow-hidden group aspect-square shadow-sm hover:shadow-md transition-all duration-500 border border-maroon-100"
              >
                <Image
              ...
              <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.5 }}
                className="lg:col-span-2 col-span-2 relative rounded-2xl sm:rounded-[2rem] overflow-hidden group aspect-2/1 shadow-sm hover:shadow-md transition-all duration-500 border border-maroon-100"
              >
                <Image
                  src="/images/lapangan-minisoccer.webp"
                ...
                <div className="absolute bottom-4 left-4 right-4 md:bottom-6 md:left-6 md:right-6">
                  ...
                  <p className="text-maroon-50/90 text-xs sm:text-sm mt-1 font-medium hidden sm:block">Sarana olahraga berkualitas</p>
                </div>
              </motion.div>
            </div>
             ...
             <motion.div
                ...
                viewport={{ once: true }}
                transition={{ delay: 0.6 }}
                 className="mt-8 app-card bg-maroon-50 p-6 flex items-start gap-4 border border-maroon-100 max-w-2xl mx-auto"
            >
                <div className="w-10 h-10 rounded-full bg-maroon-100 text-maroon-700 flex items-center justify-center shrink-0">
