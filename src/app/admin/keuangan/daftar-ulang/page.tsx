    ...
    <div className="p-6 sm:p-8 md:p-8 max-w-[1200px] mx-auto h-full flex flex-col">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-green-100 flex items-center justify-center text-[#550000]">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 flex items-center gap-4">
          <div className="w-12 h-12 rounded-full bg-blue-100 flex items-center justify-center text-[#550000] whitespace-nowrap shrink-0">
        ...
        <div className="w-full overflow-x-auto rounded-xl border border-slate-200 shadow-sm custom-scrollbar"><table className="w-full min-w-[800px] text-left">
          <thead className="bg-slate-50 border-b border-slate-200">
            <tr className="text-xs font-bold text-slate-500 uppercase tracking-wider">
              ...
              <th className="p-6 sm:p-8 text-center">Status Daftar Ulang</th>
              <th className="p-6 sm:p-8 text-right">Sisa Tagihan</th>
              <th className="p-6 sm:p-8 text-center">Aksi</th>
            </tr>
          </thead>
