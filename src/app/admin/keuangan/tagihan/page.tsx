        ...
        <div className="flex gap-3">
          <div className="relative w-full md:w-64">
            ...
            <input 
              ...
              className="w-full bg-white border border-slate-200 rounded-3xl py-2 pl-10 pr-4 focus:outline-none focus:border-maroon-500"
            />
          </div>
          <button 
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50 border-b border-slate-200 text-slate-500 text-xs uppercase tracking-wider">
                <th className="p-6 sm:p-8 font-bold">Santri</th>
                <th className="p-6 sm:p-8 font-bold">Jenis Tagihan</th>
                <th className="p-6 sm:p-8 font-bold">Tanggal</th>
                <th className="p-6 sm:p-8 font-bold text-right">Nominal</th>
                <th className="p-6 sm:p-8 font-bold text-center">Status</th>
                <th className="p-6 sm:p-8 font-bold text-center">Aksi</th>
              </tr>
            </thead>
            <tbody className="divide-y divide-slate-100">
              {loading ? (
                ...
                <tr key={t.id} className="hover:bg-slate-50/50 transition-colors">
                  <td className="p-6 sm:p-8 font-bold text-slate-800">{t.nama}</td>
                  ...
                  <td className="p-6 sm:p-8 text-sm text-slate-500">{t.tanggal}</td>
                  <td className="p-6 sm:p-8 font-black text-slate-700 text-right">
                    Rp {t.nominal.toLocaleString('id-ID')}
                  </td>
                  <td className="p-6 sm:p-8 text-center">
                    {t.status === 'lunas' ? (
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-xs font-bold bg-green-100 text-[#550000]">
