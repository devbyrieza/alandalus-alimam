...
export default function DashboardEksekutifPage() {
  ...
  return (
    <div className="p-6 sm:p-8 md:p-8 max-w-[1200px] mx-auto h-full space-y-8">
      <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-green-100 flex items-center justify-center text-[#550000] shrink-0">
        ...
        <div className="bg-white rounded-3xl p-6 border border-slate-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 flex items-center gap-4">
          <div className="w-14 h-14 rounded-2xl bg-blue-100 flex items-center justify-center text-[#550000] shrink-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        {/* CHART: Revenue Trend */}
        <div className="lg:col-span-2 bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
        ...
        {/* CHART: SPP Status */}
        <div className="lg:col-span-1 bg-white p-6 md:p-8 rounded-3xl border border-slate-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 flex flex-col">
