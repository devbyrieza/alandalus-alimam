        ...
        <div className="grid lg:grid-cols-12 gap-12 items-start">
          ...
          <aside className="lg:col-span-4 space-y-10">
            ...
            <motion.div
              ...
              className="bg-white p-6 sm:p-8 rounded-[2rem] sm:rounded-[3rem] shadow-2xl shadow-primary-900/5 border border-ink-50 flex flex-col items-center text-center relative overflow-hidden group"
            >
            ...
            <motion.div
              ...
              className="bg-primary-950 p-6 sm:p-8 md:p-10 rounded-[2.5rem] sm:rounded-[3rem] shadow-2xl relative overflow-hidden group"
            >
