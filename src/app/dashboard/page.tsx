  ...
  const CardContent = (
    ...
    >
      <div className="flex items-start justify-between mb-8">
        <div
          className={`w-14 h-14 rounded-2xl flex items-center justify-center shadow-premium-xs transition-transform group-hover:scale-110 ${disabled ? "bg-ink-100 text-ink-500" : `bg-maroon-50 text-maroon-600`}`}
        >
          <Icon className="w-7 h-7" />
        </div>
        <span
          className={`px-4 py-1.5 rounded-xl text-[10px] font-black uppercase tracking-widest ${disabled ? "bg-ink-100 text-ink-600" : "bg-gold-400 text-maroon-950 shadow-sm"}`}
        >
      ...
      <h3
        className={`text-xl font-display font-black mb-3 transition-colors ${disabled ? "text-ink-500" : "text-maroon-950 group-hover:text-maroon-700"}`}
      >
        {title}
      </h3>
      <p
    ...
    return (
      <div className="min-h-screen bg-white flex items-center justify-center">
        <div className="text-center">
          ...
          />
          <p className="text-xl font-display font-black text-maroon-950 uppercase tracking-tighter">
          ...
          <div className="flex flex-col lg:flex-row lg:items-end justify-between gap-12">
            <div className="max-w-3xl">
              ...
              >
                ...
                <span className="text-[10px] font-black uppercase tracking-[0.3em] text-maroon-600">
                  Portal Santri
                </span>
              </motion.div>
              ...
              >
                Ahlan wa Sahlan, <br />
                <span className="text-maroon-700 bg-maroon-50 px-4 py-1 rounded-3xl inline-block mt-2">
          ...
          <div className="lg:col-span-8 space-y-16">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <p
                  className={`text-base sm:text-lg md:text-xl xl:text-2xl font-bold leading-relaxed max-w-2xl text-maroon-950`}
                >
                  {statusInfo.message}
                </p>
            ...
            <div>
              <div className="flex items-center justify-between mb-10 px-4">
                <h3 className="text-3xl font-display font-black text-maroon-950 tracking-tight">
                  Alur Pendaftaran
                </h3>
              ...
              <div className="relative z-10">
                ...
                >
                  ...
                  <div className="text-left leading-none">
                    ...
                    <p className="font-black text-lg text-maroon-950">
                      0851-1152-4441
                    </p>
                  </div>
                </a>
