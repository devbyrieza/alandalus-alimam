                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className={`text-xs font-medium mt-0.5 ${formData.statusKehadiran === "HADIR" ? "text-white/70" : "text-ink-400"}`}>
                  ...
                  >
                    ...
                    <div>
                      ...
                      <p className={`text-xs font-medium mt-0.5 ${formData.statusKehadiran === "TIDAK_HADIR" ? "text-white/70" : "text-ink-400"}`}>
