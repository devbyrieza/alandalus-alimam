    ...
    <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="flex flex-col sm:flex-row gap-4 sm:items-start">
          ...
          <div>
            <h3 className="text-lg font-black text-blue-950 flex items-center gap-2">
              ...
              <span className="px-2.5 py-0.5 bg-blue-200 text-[#550000] text-[10px] uppercase tracking-widest rounded-2xl">Rekomendasi</span>
            </h3>
            <p className="text-sm text-[#550000] mt-2 leading-relaxed">
            ...
            <p className="text-xs text-[#550000]/80 mt-3 font-bold italic">
      ...
      <div className="grid grid-cols-1 gap-4">
        ...
        >
          ...
          <div>
            <p className="font-black text-ink-900 text-sm group-hover:text-[#550000] transition-colors">Surat Pemberitahuan</p>
      ...
      {/* ─── PESAN SUKSES/ERROR ─── */}
      {message.text && (
        <div className={`p-6 sm:p-8 rounded-2xl border flex items-start gap-3 text-sm font-bold ${
          message.type === "success"
            ? "bg-green-50 border-green-200 text-[#550000]"
      ...
      {seragamStatus.sudahIsi && (
        <div className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-2xl px-4 py-3">
          ...
          <Link
            href="/dashboard/pendaftar/seragam"
            className="text-xs text-[#550000] font-black hover:underline flex-shrink-0"
          >
            Ubah
          </Link>
        </div>
      ...
      <div className="bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-ink-100/50 overflow-hidden relative">
        ...
        {isEditing ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  ...
                  >
                    <div className={`w-12 h-12 rounded-full flex items-center justify-center transition-colors ${formData.statusKehadiran === "HADIR" ? "bg-white/20" : "bg-emerald-100 group-hover:bg-emerald-200"}`}>
                      <CheckCircle2 className={`w-6 h-6 ${formData.statusKehadiran === "HADIR" ? "text-white" : "text-[#550000]"}`} />
                    </div>
                    <div>
              ...
              {formData.statusKehadiran === "HADIR" && (
                <>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-start gap-2 mt-2 bg-blue-50/50 rounded-3xl px-4 py-2.5 border border-blue-100">
                  ...
                  <div className="space-y-3 pt-3">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                      ...
                      <div className="bg-white border-2 border-ink-200 rounded-2xl p-5 relative flex items-center justify-between shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 hover:border-primary-300 transition-colors">
                        ...
                        <div className="flex items-center gap-2 bg-ink-50 rounded-3xl p-1 border border-ink-100">
                          <button
                            type="button"
          ...
          <div className="p-6 space-y-5">
            <div className="flex items-start gap-4 p-6 sm:p-8 bg-green-50 border border-green-200 rounded-2xl">
              <div className="w-12 h-12 bg-green-100 rounded-2xl flex items-center justify-center flex-shrink-0">
                <CheckCircle2 className="w-7 h-7 text-[#550000]" />
              </div>
              <div>
                <p className="font-black text-[#550000] text-base">Konfirmasi Berhasil Terkirim!</p>
                <p className="text-xs text-[#550000] font-medium mt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-6 sm:p-8 bg-ink-50 rounded-2xl border border-ink-100">
                <p className="text-[10px] uppercase tracking-widest font-black text-ink-400 mb-2">Status Kehadiran</p>
                <div className={`flex items-center gap-2 ${formData.statusKehadiran === "HADIR" ? "text-[#550000]" : "text-red-700"}`}>
              ...
              {formData.catatanTambahan && (
                <div className="p-6 sm:p-8 bg-ink-50 rounded-2xl border border-ink-100 sm:col-span-2">
      ...
      <div className="bg-amber-50 border border-amber-200 p-5 rounded-2xl space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div className="bg-white rounded-3xl p-6 sm:p-8 border border-amber-100 flex gap-3">
            <div className="w-10 h-10 bg-amber-100 rounded-3xl flex items-center justify-center flex-shrink-0">
      ...
      <div className="bg-white rounded-3xl border border-ink-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 overflow-hidden mb-6">
        <div className="px-6 py-4 border-b border-emerald-100 bg-emerald-50 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#550000] font-bold">Panduan lengkap pelaksanaan Welcome Day</p>
          </div>
        </div>
          ...
          <div>
            ...
            <div className="mt-4 flex justify-center">
              <a 
                ...
                rel="noopener noreferrer" 
                download
                className="flex items-center gap-2 text-xs font-bold text-[#550000] hover:text-[#550000] hover:underline transition-colors"
              >
              ...
              <div key={idx} className="flex gap-4 items-start group">
                ...
                <div className="flex flex-col items-center flex-shrink-0">
                  <div className="w-16 text-center">
                    <span className="text-xs font-black text-primary-700 bg-primary-50 border border-primary-200 px-2 py-1 rounded-2xl block">
                      {item.jam}
                    </span>
                  </div>
      ...
      <div className="bg-white rounded-3xl border border-ink-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 overflow-hidden mt-6">
        <div className="px-6 py-4 border-b border-ink-100 bg-blue-50 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#550000] font-bold">Dimasukkan dalam 1 map saat registrasi</p>
          </div>
        </div>
        <div className="p-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {BERKAS_PERSYARATAN.map((item, idx) => (
              <div key={idx} className="flex items-start gap-3 p-3 rounded-3xl bg-ink-50 border border-ink-100">
        ...
        <div className="px-6 py-5 border-b border-ink-100 bg-emerald-50 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-[#550000] font-bold">Ketuk kategori untuk melihat rincian</p>
            </div>
          </div>
          <a
                ...
                <div className="px-6 pb-5">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                    {kategori.items.map((item, i) => (
                      <div key={i} className="bg-ink-50 rounded-3xl p-3 border border-ink-100">
              ...
              <div className="px-6 pb-5 pt-2 bg-red-50/50">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {BARANG_DILARANG.map((item, i) => (
                    <div key={i} className="flex items-start gap-2 bg-white rounded-3xl p-3 border border-red-100">
      ...
      <div className="bg-white rounded-3xl border border-ink-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 overflow-hidden">
        <div className="px-6 py-4 border-b border-ink-100 bg-blue-50 flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-[#550000] font-bold">Ketuk pertanyaan untuk melihat jawaban</p>
          </div>
        </div>
        <div className="divide-y divide-ink-100">
          {FAQ.map((faq, idx) => (
            <div key={idx}>
              ...
              >
                <div className="w-7 h-7 rounded-2xl bg-blue-50 text-[#550000] flex items-center justify-center flex-shrink-0 font-black text-xs mt-0.5">
                  {idx + 1}
                </div>
              ...
              {openFaq === idx && (
                <div className="px-5 pb-4 pl-14">
                  <p className="text-sm text-ink-600 font-medium leading-relaxed bg-blue-50 rounded-3xl px-4 py-3 border border-blue-100">
                    {faq.a}
                  </p>
                </div>
              )}
      ...
      <div className="bg-gradient-to-r from-primary-50 to-primary-100 border border-primary-200 rounded-2xl p-5">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
          ...
          <div className="flex items-center gap-3 bg-white rounded-3xl p-3 border border-primary-200">
            <div className="w-9 h-9 bg-primary-600 rounded-3xl flex items-center justify-center flex-shrink-0">
      ...
      {lightbox && (
        <div 
          className="fixed inset-0 z-[100] bg-ink-950/95 flex flex-col items-center justify-center p-6 sm:p-8 md:p-8 backdrop-blur-sm overscroll-contain"
          onClick={() => setLightbox(null)}
        >
          <button className="absolute top-4 right-4 md:top-6 md:right-6 text-white p-4 hover:bg-white/10 rounded-full transition-colors">
            <X className="w-8 h-8" />
          </button>
