    ...
    <div className="space-y-8 max-w-5xl mx-auto animate-in fade-in duration-500">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="glass-panel p-6 md:p-8 rounded-[2rem] shadow-clay-md">
            <div className="flex items-center gap-4 mb-6">
              <div className="w-12 h-12 rounded-2xl bg-primary-100 flex items-center justify-center text-primary-600 shadow-2xl shadow-primary/30 shadow-primary/20 shadow-primary/10 whitespace-nowrap shrink-0">
