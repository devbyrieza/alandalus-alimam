  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-stone-50 border border-stone-200 rounded-2xl p-6 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a href="https://wa.me/6285888871997" target="_blank" className="px-6 py-3 bg-white border border-stone-200 text-stone-700 font-bold rounded-xl hover:bg-stone-50 transition-colors shadow-sm">
          Hubungi Panitia
        </a>
      </div>
    </div>
