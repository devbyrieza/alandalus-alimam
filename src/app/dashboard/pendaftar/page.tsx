  ...
  return (
    <div className="space-y-6">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-linear-to-br from-brand-blue-700 to-brand-blue-900 text-white shadow-lg border border-brand-blue-600 app-card">
        ...
        <div className="absolute -top-32 -right-32 w-64 h-64 bg-brand-yellow-50/20 rounded-full blur-3xl pointer-events-none" />
        ...
        <div className="relative z-10 px-8 py-10 md:px-12 md:py-14">
          <div className="max-w-2xl">
            <div className="flex flex-wrap items-center gap-3 mb-6">
              ...
              <span className="flex items-center gap-1.5 text-xs font-bold text-brand-yellow-100/90 ml-1">
            ...
            <h1 className="text-3xl md:text-5xl font-black mb-3 leading-tight text-white drop-shadow-sm font-display">
              Ahlan Wa Sahlan, <br />
              <span className="text-brand-yellow-300">{data.nama}</span>
            </h1>
            <p className="text-brand-yellow-50/80 text-base md:text-lg mb-8 max-w-lg font-medium">
            ...
            <div className="flex flex-col sm:flex-row gap-4 lg:gap-6">
              <div className="bg-white/10 backdrop-blur-md px-6 py-4 rounded-[1.5rem] shadow-sm border border-white/20 app-card flex-shrink-0">
                <p className="text-[10px] text-brand-yellow-100/80 font-black mb-1.5 uppercase tracking-widest pl-1">No. Pendaftar</p>
              ...
              {nextStep && (
                <Link
                  href={nextStep.href}
                  className="bg-brand-yellow-400 px-6 py-4 rounded-[1.5rem] shadow-lg border border-brand-yellow-500 flex items-center gap-4 hover:bg-brand-yellow-300 hover:scale-[1.02] transition-all cursor-pointer group app-card flex-1"
                >
                  <div className="w-10 h-10 rounded-full bg-brand-blue-900/10 flex items-center justify-center border border-brand-blue-900/20 group-hover:bg-brand-blue-900 transition-colors flex-shrink-0">
                     <ArrowRight className="w-5 h-5 text-brand-blue-900 group-hover:text-white transition-colors" />
                  </div>
                  <div>
                    <p className="text-[10px] font-black tracking-widest uppercase text-brand-blue-900/70 mb-0.5">Tugas Anda Selanjutnya</p>
                    <p className="font-black text-base md:text-lg text-brand-blue-950 group-hover:text-brand-blue-900 line-clamp-1">{nextStep.action}</p>
                  </div>
                </Link>
              )}
            </div>
      ...
      <div className="pt-6">
        <h2 className="text-lg md:text-xl font-black text-ink-950 flex items-center gap-3 mb-6 uppercase tracking-widest">
          <div className="w-8 h-8 rounded-full bg-brand-yellow-100 flex items-center justify-center border border-brand-yellow-200">
            <TrendingUp className="w-4 h-4 text-brand-blue-700" />
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {/* Card 1: Status Utama */}
          <div className="app-card bg-white p-6 rounded-[1.5rem] shadow-sm border border-brand-yellow-200 hover:shadow-md hover:border-brand-blue-200 transition-all flex flex-col">
          ...
          {/* Card 2: Pembayaran */}
          <div className="app-card bg-white p-6 rounded-[1.5rem] shadow-sm border border-brand-yellow-200 hover:shadow-md hover:border-brand-blue-200 transition-all flex flex-col">
            <div className="w-12 h-12 rounded-2xl bg-brand-yellow-100 border border-brand-yellow-200 text-brand-blue-600 flex items-center justify-center mb-5 shadow-sm">
            ...
            <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-5 shadow-sm ${data.pengumuman?.status_kelulusan === "Lulus" ? "bg-green-100 text-green-700" :
                data.pengumuman?.status_kelulusan === "Cadangan" ? "bg-yellow-100 text-yellow-700" :
                  data.pengumuman?.status_kelulusan === "Tidak Lulus" ? "bg-red-100 text-red-700" :
                    "bg-brand-yellow-100 text-brand-blue-600 border border-brand-yellow-200"
              }`}>
            ...
            <div className="flex flex-col">
              ...
              {data.pengumuman?.surat_keputusan_url && (
                <a
                  ...
                  className="mt-3 text-[10px] font-black uppercase text-brand-blue-700 hover:text-brand-blue-900 bg-brand-yellow-50 hover:bg-brand-yellow-100 py-1.5 px-3 rounded-md transition-colors inline-flex items-center gap-1.5 max-w-max border border-brand-yellow-200"
                >
      ...
      {/* Next Action Callout */}
      <div className="mt-8 bg-brand-yellow-50 border border-brand-yellow-200 rounded-[2rem] p-6 lg:p-8 flex flex-col md:flex-row items-center justify-between gap-6 app-card relative overflow-hidden">
        {/* Background accent */}
        <div className="absolute top-0 right-0 w-32 h-full bg-linear-to-l from-brand-yellow-100/50 to-transparent pointer-events-none" />
        
        <div className="flex items-start md:items-center gap-4 relative z-10 w-full md:w-auto">
          <div className="w-12 h-12 rounded-full bg-white flex items-center justify-center flex-shrink-0 border border-brand-yellow-200 shadow-sm">
        ...
        <a href="https://wa.me/6281285300800" target="_blank" className="w-full md:w-auto px-6 md:px-8 py-3.5 md:py-4 bg-brand-yellow-400 text-brand-blue-950 font-black text-sm uppercase tracking-widest rounded-pill hover:bg-brand-yellow-300 hover:text-brand-blue-900 transition-colors shadow-md text-center border border-brand-yellow-500 active:scale-95 whitespace-nowrap z-10">
          Chat Panitia
        </a>
      </div>
    </div>
