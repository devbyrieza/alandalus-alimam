...
export default function PengajuanKeringananPage() {
    ...
    return (
      <div className="max-w-4xl mx-auto py-8">
        <div className="bg-white rounded-[2rem] p-8 shadow-2xl shadow-primary/30 border border-primary-100 flex flex-col items-center text-center">
          <div
            className={`w-24 h-24 rounded-[2rem] flex items-center justify-center mb-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border ${
            ...
            {pengajuan.nominal_disetujui > 0 &&
              pengajuan.status === "approved" && (
                <div className="flex justify-between items-center">
                  <span className="text-sm font-bold text-[#550000] uppercase tracking-wider">
                    Nilai Potongan Disetujui
                  </span>
                  <span className="font-black text-[#550000] text-lg">
                    Rp{" "}
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      {/* Header */}
      <div className="bg-linear-to-br from-primary-700 to-primary-900 rounded-2xl p-6 md:p-8 text-white shadow-2xl shadow-primary/30  shadow-primary/20 relative overflow-hidden">
      ...
      <form
        ...
        className="bg-white rounded-2xl shadow-2xl shadow-primary/30 border border-slate-100 overflow-hidden"
      >
        <div className="p-6 md:p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <textarea
                ...
                className="w-full p-6 sm:p-8 border border-slate-300 rounded-3xl focus:ring-2 focus:ring-primary-500 min-h-[120px] bg-slate-50 text-sm"
          ...
          <div className="space-y-4">
            ...
            {/* Info syarat */}
            <div className="bg-blue-50 border border-blue-100 rounded-3xl p-3 text-xs text-[#550000] font-medium flex items-start gap-2">
              <ClipboardList className="w-4 h-4 text-[#550000] shrink-0 mt-0.5" />
              <span>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              {/* SKTM */}
              <div className="border border-slate-200 rounded-3xl p-6 sm:p-8 bg-slate-50">
                ...
                {fileSktm && (
                  <div className="flex items-center gap-2 mb-2 text-xs text-primary-700 bg-primary-50 rounded-2xl px-3 py-2">
          ...
          {/* Submit Info */}
          <div className="bg-amber-50 p-6 sm:p-8 rounded-3xl border border-amber-200 flex items-start gap-3">
          ...
          <button
            type="submit"
            disabled={submitting}
            className="w-full py-4 bg-primary-600 hover:bg-primary-700 text-white font-black rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {submitting ? (
