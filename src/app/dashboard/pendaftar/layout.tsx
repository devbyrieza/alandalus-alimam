    ...
    return (
      <div className="min-h-screen bg-surface-50 flex items-center justify-center">
        <div className="bg-white p-8 rounded-3xl shadow-clay-lg text-center max-w-sm w-full mx-4">
          ...
          <h1 className="text-3xl font-serif font-black uppercase text-brand-blue-950 mb-2">Pondok Pesantren Al-Andalus Al-Imam</h1>
        ...
        <div className="lg:hidden bg-white/90 backdrop-blur-xl sticky top-0 z-40 px-4 sm:px-5 py-3 sm:py-4 flex items-center justify-between border-b border-brand-yellow-200 shadow-sm">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-[9px] sm:text-[10px] uppercase font-black tracking-widest text-ink-400 mb-0.5" style={{ display: 'none' }}>PPDB Al-Andalus Al-Imam</span>
            ...
            <div className="flex flex-col h-full bg-white/70 backdrop-blur-xl border-r border-white/50 shadow-clay-lg">
              ...
              <div className="px-6 pt-8 pb-6 border-b border-brand-yellow-100/50 mb-2">
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    <h1 className="font-black text-xl text-brand-blue-950 leading-none tracking-tight">PPDB <span className="text-brand-blue-700">Al-Andalus Al-Imam</span></h1>
              ...
              <div className="flex flex-col h-full overflow-hidden">
                <div className="p-6 border-b border-surface-100 flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="font-black text-lg text-brand-blue-950 tracking-tight">PPDB Al-Andalus Al-Imam</span>
                  </div>
