        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 bg-primary-50 rounded-2xl flex items-center justify-center group-hover:bg-primary-100 transition-colors whitespace-nowrap shrink-0">
          ...
          {data.current_status === "enrolled" ? (
            <div className="bg-emerald-50 rounded-2xl border-2 border-emerald-200 p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center whitespace-nowrap shrink-0">
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-primary-100 rounded-2xl flex items-center justify-center whitespace-nowrap shrink-0">
