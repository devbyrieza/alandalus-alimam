...
export default function UndanganSeleksiTab() {
  ...
  if (data.locked && !isTestingAccount) {
    return (
      <div className="space-y-6">
        <div className="bg-linear-to-r from-stone-600 to-stone-800 rounded-2xl p-6 md:p-8 text-white shadow-2xl shadow-primary/30  shadow-primary/20 relative overflow-hidden">
        ...
        <div className={`border-2 rounded-3xl p-5 md:p-8 md:p-12 text-center shadow-sm ${data.current_status?.includes('reject') || data.current_status?.includes('incomplete') ? 'border-red-200 bg-red-50' : 'bg-secondary-50 border-secondary-200'}`}>
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-4">
            <Link
              ...
              className="px-5 md:px-8 py-3 bg-primary-700 text-white font-black rounded-2xl hover:bg-primary-800 transition-all shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 uppercase tracking-widest text-sm"
            >
              Cek Status Berkas
            </Link>
          </div>
        ...
        <div className="opacity-40 pointer-events-none select-none filter blur-[1px]">
          <div className="bg-white rounded-2xl border border-stone-100 p-5 md:p-8 text-center">
  ...
  if (data.condition === "seleksi_selesai") {
    return (
      <div className="space-y-6">
        {/* Header */}
        <div className="bg-linear-to-r from-emerald-700 to-emerald-900 rounded-2xl p-6 md:p-8 text-white shadow-2xl shadow-primary/30  shadow-primary/20 relative overflow-hidden">
        ...
        <div className="bg-white rounded-2xl border border-stone-200 p-5 shadow-sm">
          ...
          <div className="w-full h-3 bg-surface-100 rounded-full overflow-hidden">
            <div className="h-full bg-linear-to-r from-emerald-500 to-emerald-700 rounded-full w-full shadow-2xl shadow-primary/30  shadow-primary/20 shadow-emerald-500/20" />
          </div>
        ...
        <div className="grid md:grid-cols-2 gap-4">
          ...
          <Link
            ...
            className="bg-white rounded-2xl border-2 border-primary-100 hover:border-primary-300 p-6 shadow-sm hover:shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 transition-all group"
          >
            <div className="flex items-center gap-3 mb-3">
              <div className="w-12 h-12 bg-primary-50 rounded-2xl flex items-center justify-center group-hover:bg-primary-100 transition-colors whitespace-nowrap inline-block shrink-0">
          ...
          {data.current_status === "enrolled" ? (
            <div className="bg-emerald-50 rounded-2xl border-2 border-emerald-200 p-6 shadow-sm">
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center whitespace-nowrap inline-block shrink-0">
            ...
            <Link
              ...
              className="bg-white rounded-2xl border-2 border-gold-200 hover:border-gold-400 p-6 shadow-sm hover:shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 transition-all group"
            >
              <div className="flex items-center gap-3 mb-3">
                <div className="w-12 h-12 bg-gold-50 rounded-2xl flex items-center justify-center group-hover:bg-gold-100 transition-colors">
                  <CheckCircle className="w-6 h-6 text-primary-600" />
                </div>
                <div>
  ...
  return (
    <div className="space-y-6">
      {/* ========== HEADER ========== */}
      <div className="bg-linear-to-r from-primary-700 to-primary-900 rounded-2xl p-6 md:p-8 text-white shadow-2xl shadow-primary/30  shadow-primary/20 relative overflow-hidden">
        <div className="relative z-10">
        ...
        <div className="flex gap-3 mt-4 relative z-10">
          <a
            ...
            target="_blank"
            className="bg-white/20 hover:bg-white/30 text-white border border-white/50 px-4 py-2 rounded-2xl flex items-center gap-2 transition-all font-black backdrop-blur-sm text-sm"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="18"
      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-5 shadow-sm">
        ...
        <div className="w-full h-3 bg-surface-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-linear-to-r from-primary-500 to-primary-700 rounded-full transition-all duration-700 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary-500/20"
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-primary-100 rounded-2xl flex items-center justify-center whitespace-nowrap inline-block shrink-0">
              ...
              <div
                ...
                className={`bg-white rounded-2xl border-2 p-5 transition-all ${
                  item.completed
                    ...
                    : "border-stone-100 hover:border-primary-200 hover:shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10"
                }`}
              >
                ...
                {item.completed ? (
                  ...
                  <Link
                    ...
                    className="inline-flex items-center gap-2 mt-2 px-4 py-2 bg-gold-400 hover:bg-gold-300 text-primary-950 text-xs font-black rounded-2xl transition-colors shadow-sm border border-gold-500"
                  >
                    Mulai Tes
                  </Link>
                )}
      ...
      <div className="space-y-4">
        <div className="flex items-center gap-3">
          <div className="w-8 h-8 bg-gold-100 rounded-2xl flex items-center justify-center">
            ...
            <div className="grid gap-3 md:grid-cols-2 lg:grid-cols-3">
              {data.grupB.booked.map((item) => {
                ...
                return (
                  <div
                    key={item.id}
                    className={`rounded-2xl shadow-sm p-5 border-2 relative overflow-hidden ${
                      ...
                      <div
                        ...
                        className={`bg-white rounded-2xl shadow-sm p-5 border-2 transition-all ${
                          slot.isFull
                            ...
                            : "border-surface-100 hover:border-primary-300 hover:shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10"
                        }`}
                      >
                        ...
                        <button
                          ...
                          className="w-full py-2.5 bg-gold-400 hover:bg-gold-300 text-primary-950 font-black rounded-2xl disabled:bg-surface-200 disabled:text-ink-400 disabled:cursor-not-allowed transition-all shadow-sm flex justify-center items-center gap-2 text-sm border border-gold-500"
                        >
                          {bookingId === slot.id && (
