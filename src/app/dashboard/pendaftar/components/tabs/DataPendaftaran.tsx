  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-2xl p-4 border-2 border-stone-200 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-primary-100 rounded-2xl flex items-center justify-center whitespace-nowrap inline-block shrink-0">
        ...
        <div className="bg-white rounded-2xl p-4 border-2 border-stone-200 shadow-sm">
          <div className="flex items-center gap-3">
            <div className="w-12 h-12 bg-purple-100 rounded-2xl flex items-center justify-center whitespace-nowrap inline-block shrink-0">
      ...
      <div className="bg-white rounded-2xl p-6 border-2 border-stone-200 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-xl font-bold text-stone-900"><ClipboardList className="w-4 h-4 inline-block mr-1" /> Data Pribadi</h2>
      ...
      {/* Action Cards - Flow SPMB: Pembayaran → Data Pribadi → Upload Dokumen */}
      ...
      <div className="bg-white rounded-2xl p-6 border-2 border-stone-200 shadow-sm">
        <h2 className="text-xl font-bold text-stone-900 mb-4">
          <BarChart2 className="w-4 h-4 inline-block mr-1" /> Progress Pendaftaran
        </h2>
        <div className="space-y-4">
          {[
