          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center gap-3">
                <div className="p-3 bg-primary-50 rounded-2xl group-hover:bg-primary-100 transition-colors whitespace-nowrap inline-block shrink-0">
            ...
            {doc.status === "available" ? (
              ...
              <button
                disabled
                className="flex items-center justify-center gap-2 w-full px-4 py-3 bg-stone-100 text-stone-400 rounded-2xl font-medium cursor-not-allowed text-xs lg:text-sm border border-stone-200 whitespace-nowrap inline-block shrink-0"
              >
