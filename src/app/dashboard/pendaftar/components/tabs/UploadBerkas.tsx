          ...
          <div className="flex items-center gap-2">
            ...
            {dokumen.key === "surat_kesehatan" && (
              <button
                ...
                className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-100 hover:bg-primary-600 text-primary-800 hover:text-white rounded-2xl text-[10px] font-black border border-primary-300 transition-colors shadow-sm whitespace-nowrap inline-block shrink-0"
            ...
            dokumenList.some((d) => d.status === "rejected") ? (
              ...
              <>
                ...
                <div className="mt-4 p-4 bg-emerald-50 border border-emerald-200 rounded-2xl flex flex-col sm:flex-row items-center sm:items-start gap-3 text-left">
                  <div className="w-10 h-10 bg-emerald-100 rounded-2xl flex items-center justify-center shrink-0 mt-0.5 whitespace-nowrap inline-block shrink-0">
