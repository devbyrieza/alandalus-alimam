...
export default function DaftarUlangTab() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (amount < 4250000 && !keringananReason.trim() && !hasExistingVerifiedPayment) {
      setMessage({
        type: "error",
            ...
            <div className="pt-2 border-t border-slate-100 animate-in fade-in slide-in-from-top-1">
              ...
              <div className="relative w-32">
                <input
                  ...
                  readOnly
                  value={cicilanKe}
                  className="w-full px-4 py-3 text-lg font-black text-maroon-700 border border-maroon-200 bg-maroon-50 rounded-xl focus:outline-none transition-all shadow-inner text-center"
                />
