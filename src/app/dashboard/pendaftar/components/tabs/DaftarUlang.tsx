      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="bg-brand-blue-50 p-6 rounded-xl border border-brand-blue-100 flex flex-col justify-between">
          ...
          <div className="pt-4 border-t border-brand-blue-200">
            ...
            <a href="https://wa.me/6281220636945" target="_blank" rel="noreferrer" className="inline-flex items-center gap-1.5 font-bold text-brand-blue-800 hover:text-brand-blue-600 transition-colors">
