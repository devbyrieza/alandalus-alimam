...
export default function DaftarUlangTab() {
  ...
  const expectedUangPangkal = 7650000 - potonganUP;
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto pb-12">
      ...
      <div className="bg-white rounded-2xl p-4 shadow-sm border border-slate-100">
        ...
        <div className="flex bg-slate-100/50 p-1 rounded-2xl mb-6 whitespace-nowrap shrink-0">
          <button
        ...
        <div className="bg-white p-6 rounded-2xl border border-primary-100 shadow-sm space-y-4">
          ...
          <div className="space-y-1 text-sm">
            <div className="flex justify-between">
              ...
              <span className="font-bold text-ink-800">Rp 7.650.000</span>
            </div>
            {potonganUP > 0 && (
      ...
      {message && message.type === "success" && (
        <div className="p-5 bg-emerald-50 border border-emerald-200 rounded-2xl flex flex-col sm:flex-row items-center sm:items-start gap-4 shadow-sm">
          <div className="w-12 h-12 bg-emerald-100 rounded-2xl flex items-center justify-center shrink-0 mt-0.5 whitespace-nowrap shrink-0">
      ...
      {isTabLunas ? (
        ...
        <div className="bg-white rounded-2xl shadow-2xl shadow-primary/30 border border-slate-100 overflow-hidden">
          ...
          <form onSubmit={handleSubmit} className="p-6 space-y-6">
            ...
            {/* Pernyataan */}
            <label className="flex items-start gap-4 p-4 rounded-2xl border border-slate-200 bg-slate-50 cursor-pointer hover:bg-slate-100 transition-colors whitespace-nowrap shrink-0">
              <input
                type="checkbox"
                checked={pernyataan}
