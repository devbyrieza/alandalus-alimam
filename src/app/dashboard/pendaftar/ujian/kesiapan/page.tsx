...
export default function KesiapanTestPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 sm:p-8 md:p-6 pb-24">
      {pendaftarId && (
      ...
      <div className="bg-gradient-to-r from-primary-600 to-primary-800 rounded-3xl p-6 mb-6">
      ...
      {/* Pesan Mudir */}
      <div className="bg-primary-50 border border-primary-200 rounded-3xl p-6 sm:p-8 mb-6">
