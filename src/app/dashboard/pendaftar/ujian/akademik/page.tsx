      ...
      <div className="max-w-lg mx-auto p-8 text-center mt-10">
        <div className="bg-white rounded-2xl shadow-lg border p-10">
          ...
          <button
            ...
            className="px-6 py-3 bg-maroon-600 hover:bg-maroon-700 text-white font-bold rounded-xl transition-colors"
          >
      ...
      <div className="max-w-lg mx-auto p-8 text-center mt-10">
        <div className="bg-white rounded-[2rem] shadow-xl border p-10">
          ...
          <button
            ...
            className="w-full px-6 py-4 bg-maroon-700 hover:bg-maroon-800 text-white font-black rounded-xl transition-all shadow-md uppercase tracking-widest text-sm"
          >
  ...
  if (!started) {
    return (
      <div className="max-w-3xl mx-auto p-4 md:p-6">
        ...
        <div className="bg-gradient-to-r from-maroon-600 to-maroon-800 rounded-[2rem] p-8 mb-8 text-white relative overflow-hidden shadow-lg border border-maroon-500">
          ...
          <div className="relative z-10 text-center md:text-left">
            ...
            <p className="text-maroon-100 font-medium text-sm md:text-base opacity-90 max-w-lg">
        ...
        <div className="bg-white rounded-2xl shadow-sm border p-8">
          <div className="space-y-4 text-stone-700">
            ...
            <div className="bg-maroon-50 border border-maroon-200 rounded-xl p-6">
              <div className="flex gap-5">
                <div className="w-14 h-14 rounded-full bg-white flex items-center justify-center border border-maroon-100 flex-shrink-0 shadow-sm">
                  <AlertCircle className="w-7 h-7 text-maroon-600" />
                </div>
                <div>
                  <h4 className="font-black text-maroon-900 mb-1.5 text-base">
                    Pesan dari Mudir
                  </h4>
                  <p className="text-sm text-maroon-800 leading-relaxed italic font-medium">
                    "Bismillah, kerjakan dengan jujur dan penuh optimisme. Hasil
                    terbaik adalah buah dari kejujuran dan usaha yang ikhlas."
                  </p>
                  <p className="text-xs text-maroon-600 leading-relaxed mt-2 font-bold uppercase tracking-widest">
