                    ...
                    results.map((p) => (
                      ...
                      >
                        <div className="flex items-center justify-between mb-1">
                          ...
                          <span className="text-xs font-black text-primary-600 bg-primary-100 px-2 py-0.5 rounded-2xl whitespace-nowrap inline-block shrink-0">
                            {p.jenjang}
                          </span>
                        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-1.5">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-4 py-2.5 bg-stone-100 hover:bg-stone-200 text-stone-700 rounded-2xl font-bold transition-colors flex items-center gap-2 border border-stone-200 whitespace-nowrap inline-block shrink-0"
                    >
              ...
              <div className="pt-4 flex justify-end gap-3 border-t border-stone-100">
                <button
                  type="button"
                  onClick={onClose}
                  className="px-6 py-2.5 rounded-2xl font-bold text-stone-600 hover:bg-stone-100 transition-colors whitespace-nowrap inline-block shrink-0"
