              ...
              >
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                  <div className="flex-1">
                    ...
                    {/* Details Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-0 sm:ml-16 mt-3 sm:mt-0 bg-stone-50/50 p-6 sm:p-8 rounded-3xl border border-stone-100">
                      <div>
                  ...
                  <div className="flex sm:flex-col gap-3 sm:w-48 shrink-0">
                    ...
                    {statusFilter === "verified" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-emerald-50 hover:bg-emerald-100 text-[#550000] rounded-3xl font-bold text-sm border border-emerald-100 transition-all whitespace-nowrap shrink-0"
                      >
                        <CheckCircle className="w-4 h-4" />
                        Terverifikasi
                      </button>
              ...
              {selectedPembayaran.bukti_transfer_url ? (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-2xl text-xs font-bold transition-colors disabled:opacity-50 whitespace-nowrap shrink-0"
                    >
                ...
                <div className="p-5 md:p-8 border-2 border-dashed border-stone-200 rounded-2xl text-center space-y-4">
                  ...
                  <button
                    onClick={handleUploadClick}
                    disabled={uploadingProof === selectedPembayaran.id}
                    className="mx-auto flex items-center justify-center gap-2 px-4 py-2 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-3xl text-sm font-bold transition-colors disabled:opacity-50 whitespace-nowrap shrink-0"
                  >
                    {uploadingProof === selectedPembayaran.id ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
                    ) : (
