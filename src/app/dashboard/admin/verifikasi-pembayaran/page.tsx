                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-16 bg-stone-50/50 p-6 sm:p-8 rounded-3xl border border-stone-100">
                      ...
                      {pay.tipe_cicilan === "CICILAN" && (
                        <div>
                          ...
                          <span className="px-2.5 py-1 bg-violet-100 text-violet-700 rounded-2xl text-[10px] font-black uppercase tracking-widest border border-violet-200">
                  ...
                  <div className="flex sm:flex-col gap-3 sm:w-48 shrink-0">
                    ...
                    {statusFilter === "verified" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-emerald-50 hover:bg-emerald-100 text-[#550000] rounded-3xl font-bold text-sm border border-emerald-100 transition-all"
                      >
                        <CheckCircle className="w-4 h-4" />
                        Terverifikasi
                      </button>
              ...
              {selectedPembayaran.bukti_transfer_url ? (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-2xl text-xs font-bold transition-colors disabled:opacity-50"
                    >
                ...
                <div className="p-5 md:p-8 border-2 border-dashed border-stone-200 rounded-2xl text-center space-y-4">
                  ...
                  <button
                    onClick={handleUploadClick}
                    disabled={uploadingProof === selectedPembayaran.id}
                    className="mx-auto flex items-center justify-center gap-2 px-4 py-2 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-3xl text-sm font-bold transition-colors disabled:opacity-50"
                  >
                    {uploadingProof === selectedPembayaran.id ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
                    ) : (
            ...
            <div className="p-6 border-t border-stone-100 bg-stone-50/50 flex flex-col sm:flex-row gap-3">
              ...
              {selectedPembayaran.status_pembayaran !== "pending" && (
                <button
                  ...
                  disabled={processing}
                  className="px-6 py-4 bg-stone-100 hover:bg-stone-200 text-stone-600 rounded-3xl font-bold transition-all disabled:opacity-50 border border-stone-200"
                >
                  {processing ? (
