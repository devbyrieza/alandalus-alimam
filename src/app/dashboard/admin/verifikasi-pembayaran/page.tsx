...
function VerifikasiPembayaranContent() {
  ...
  return (
    <div className="space-y-6">
      {/* Refreshing Overlay */}
      {isRefreshing && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 bg-white/40 backdrop-blur-[1px] z-[100] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center pointer-events-none overflow-y-auto overflow-x-hidden p-6 sm:p-8 overscroll-contain custom-scrollbar">
        ...
        <div className="flex flex-col xl:flex-row xl:items-center gap-4 xl:justify-between flex-wrap">
          ...
          <div className="flex flex-wrap bg-stone-100 p-1.5 rounded-[1.25rem] w-full sm:w-fit shadow-inner ring-1 ring-stone-200/50 justify-center whitespace-nowrap inline-block shrink-0">
            <button
              ...
              className={`flex items-center gap-2 px-6 py-2.5 rounded-3xl text-xs font-black uppercase tracking-widest transition-all duration-300 ${
      ...
      <div className="flex flex-wrap items-center gap-3 bg-white p-6 sm:p-8 rounded-2xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-stone-100">
        <div className="px-4 py-2 bg-stone-100 rounded-2xl text-sm font-bold text-stone-600 whitespace-nowrap inline-block shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className={`px-3 md:px-4 py-2 rounded-2xl text-sm font-bold transition-all ${
            ...
            <button
              ...
              className={`px-3 md:px-4 py-2 rounded-2xl text-sm font-bold transition-all ${
                statusFilter === "verified"
                  ? "bg-emerald-100 text-[#550000] ring-2 ring-emerald-500/20"
                  : "hover:bg-stone-50 text-stone-500"
              }`}
            >
              Terverifikasi
                ...
                <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-6">
                  <div className="flex-1">
                    ...
                    <div className="flex items-start gap-4 mb-3">
                      <div className="w-12 h-12 rounded-3xl bg-primary-50 flex items-center justify-center text-primary-800 font-black text-lg shrink-0 border border-primary-100">
                    ...
                    {/* Details Grid */}
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 ml-16 bg-stone-50/50 p-6 sm:p-8 rounded-3xl border border-stone-100">
                      <div>
                        <p className="text-xs font-bold text-stone-400 uppercase tracking-widest mb-1">
                          Nominal Transfer
                        </p>
                        <p className="text-xl font-black text-[#550000]">
                      ...
                      {pay.tipe_cicilan === "CICILAN" && (
                        <div>
                          ...
                          <span className="px-2.5 py-1 bg-violet-100 text-violet-700 rounded-2xl text-[10px] font-black uppercase tracking-widest border border-violet-200 whitespace-nowrap inline-block shrink-0">
                      ...
                      {pay.keringanan_reason && (
                        <div className="col-span-1 sm:col-span-2 pt-2 border-t border-secondary-200/50 mt-1">
                          <p className="text-xs text-secondary-700 bg-secondary-50 p-4 rounded-2xl border border-secondary-100 font-medium">
                  ...
                  <div className="flex sm:flex-col gap-3 sm:w-48 shrink-0">
                    <button
                      ...
                      className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-2.5 bg-white border-2 border-dashed border-stone-300 hover:border-primary-500 hover:bg-primary-50 text-stone-600 hover:text-primary-800 rounded-3xl text-sm font-bold transition-all"
                    >
                    ...
                    {statusFilter === "verified" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-emerald-50 hover:bg-emerald-100 text-[#550000] rounded-3xl font-bold text-sm border border-emerald-100 transition-all whitespace-nowrap inline-block shrink-0"
                      >
                        <CheckCircle className="w-4 h-4" />
                        Terverifikasi
                      </button>
                    ...
                    {statusFilter === "rejected" && (
                      <button
                        onClick={() => openModal(pay)}
                        className="flex-1 sm:flex-none flex items-center justify-center gap-2 px-4 py-3 bg-red-50 hover:bg-red-100 text-red-700 rounded-3xl font-bold text-sm border border-red-100 transition-all"
                      >
      ...
      {showModal && selectedPembayaran && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center z-50 p-6 sm:p-8 animate-in fade-in duration-200 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-[2rem] shadow-2xl max-w-2xl w-full max-h-[90vh] flex flex-col overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6 overscroll-contain custom-scrollbar">
              ...
              {activeTab === "DAFTAR_ULANG" && (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 p-6 sm:p-8 bg-violet-50 rounded-2xl border border-violet-100">
                  <div>
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-2">
                        <input
                          ...
                          className="w-full px-4 py-2 bg-white border border-violet-200 rounded-3xl focus:outline-none focus:ring-2 focus:ring-violet-500 font-black text-violet-900"
                        />
                      </div>
              ...
              {selectedPembayaran.keringanan_reason && (
                <div className="p-5 bg-secondary-50 border-2 border-secondary-100 rounded-2xl space-y-3 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
                  ...
                  <p className="text-sm text-secondary-900 leading-relaxed font-bold italic bg-white/50 p-6 sm:p-8 rounded-3xl border border-secondary-200/50">
                    "{selectedPembayaran.keringanan_reason}"
                  </p>
              ...
              {selectedPembayaran.bukti_transfer_url ? (
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className="flex items-center gap-1.5 px-3 py-1.5 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-2xl text-xs font-bold transition-colors disabled:opacity-50 whitespace-nowrap inline-block shrink-0"
                    >
                  ...
                  <div className="border-2 border-stone-100 rounded-2xl overflow-hidden bg-stone-50 relative group">
                    {selectedPembayaran.bukti_transfer_url
                      ...
                      <iframe
                        ...
                        className="w-full h-[500px] rounded-3xl border-none"
                        title="PDF Preview"
                      />
                    ) : (
                      <img
                ...
                <div className="p-5 md:p-8 border-2 border-dashed border-stone-200 rounded-2xl text-center space-y-4">
                  ...
                  <button
                    onClick={handleUploadClick}
                    disabled={uploadingProof === selectedPembayaran.id}
                    className="mx-auto flex items-center justify-center gap-2 px-4 py-2 bg-primary-50 text-primary-600 hover:bg-primary-100 rounded-3xl text-sm font-bold transition-colors disabled:opacity-50 whitespace-nowrap inline-block shrink-0"
                  >
                    {uploadingProof === selectedPembayaran.id ? (
                      <Loader2 className="w-4 h-4 animate-spin" />
                    ) : (
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 border border-stone-200 rounded-3xl focus:border-primary-600 focus:ring-2 focus:ring-primary-600/20 focus:outline-none resize-none transition-all font-bold text-stone-800"
                  rows={3}
                />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-stone-100 bg-stone-50/50 flex flex-col sm:flex-row gap-3">
              ...
              {selectedPembayaran.status_pembayaran !== "pending" && (
                <button
                  ...
                  disabled={processing}
                  className="px-6 py-4 bg-stone-100 hover:bg-stone-200 text-stone-600 rounded-3xl font-bold transition-all disabled:opacity-50 border border-stone-200 whitespace-nowrap inline-block shrink-0"
                >
                  {processing ? (
