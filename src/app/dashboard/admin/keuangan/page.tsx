          ...
          <div className="flex items-center gap-3 mb-1">
            ...
            {tahunAjaranList.length > 0 && (
              <select
                ...
                className="bg-slate-100 text-slate-700 text-xs font-bold rounded-2xl px-3 py-1.5 focus:outline-none focus:ring-2 focus:ring-emerald-500 cursor-pointer hover:bg-slate-200 transition-all border-none"
              >
