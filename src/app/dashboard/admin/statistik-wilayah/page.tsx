...
export default async function StatistikWilayahPage(props: {
  ...
  return (
    <div className="space-y-8">
      {/* Header */}
      <div className="bg-linear-to-br from-primary-600 to-primary-900 rounded-3xl p-5 md:p-8 text-white relative overflow-hidden shadow-2xl shadow-primary/30  shadow-primary-900/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        {/* Provinsi */}
        <div className="bg-white rounded-3xl p-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-ink-100">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-3xl bg-blue-50 text-[#550000] flex items-center justify-center">
        ...
        <div className="bg-white rounded-3xl p-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-ink-100">
          <div className="flex items-center gap-3 mb-6">
            <div className="w-10 h-10 rounded-3xl bg-orange-50 text-orange-600 flex items-center justify-center">
