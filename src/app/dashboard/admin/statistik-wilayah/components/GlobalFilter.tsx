    ...
    <div className="bg-white rounded-3xl p-6 shadow-sm border border-ink-100 mb-8">
      <div className="flex flex-col md:flex-row gap-4 items-end">
        ...
        <div className="flex gap-2 w-full md:w-auto">
          <button
            onClick={handleApply}
            className="flex-1 md:flex-none p-3 px-6 bg-primary-600 text-white rounded-2xl font-bold hover:bg-primary-700 transition-colors flex items-center justify-center gap-2"
          >
          ...
          {(currentTahun || currentJenjang) && (
            <button
              onClick={handleReset}
              className="p-3 px-4 bg-ink-100 text-ink-600 rounded-2xl font-bold hover:bg-ink-200 transition-colors flex items-center justify-center"
            >
              Reset
            </button>
          )}
