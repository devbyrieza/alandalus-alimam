...
export default function UserManagementPage() {
  ...
  return (
    <div className="space-y-10 pb-16 animate-in fade-in duration-700">
      ...
      {/* User List Dashboard */}
      <div className="bg-white rounded-4xl border border-secondary-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 overflow-hidden app-card">
        <div className="p-5 md:p-8 border-b border-stone-50 flex flex-col md:flex-row justify-between items-center gap-6 bg-secondary-50/10">
          <div className="relative w-full md:w-[28rem]">
            ...
            <input
              ...
              className="w-full pl-16 pr-8 py-5 bg-white border-2 border-secondary-100 rounded-[2.5rem] focus:outline-none focus:border-primary-500 font-bold shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 placeholder:text-stone-300"
            />
          </div>
                  ...
                  >
                    <td className="p-5 md:p-8">
                      <div className="flex items-center gap-5">
                        <div className="w-12 h-12 rounded-2xl bg-primary-100 flex items-center justify-center text-primary-700 font-black text-xs border-2 border-white shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 whitespace-nowrap inline-block shrink-0">
                    ...
                    <td className="p-5 md:p-8 text-center">
                      <div className="flex flex-wrap justify-center gap-2">
                        <span className="px-4 py-1.5 bg-primary-50 text-primary-700 text-[10px] font-black rounded-3xl border border-primary-100 uppercase tracking-widest shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
                        ...
                        {user.secondary_roles &&
                          user.secondary_roles
                            ...
                            .map((r, i) => (
                              <span
                                key={i}
                                className="px-4 py-1.5 bg-stone-100 text-stone-600 text-[10px] font-black rounded-3xl border border-stone-200 uppercase tracking-widest shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 whitespace-nowrap inline-block shrink-0"
                              >
          ...
          <div className="bg-white rounded-[3rem] shadow-2xl w-full max-w-3xl flex flex-col max-h-[90vh] animate-in zoom-in duration-300 border border-white/20">
            <div className="p-6 md:p-12 border-b flex justify-between items-center bg-stone-50/50 shrink-0">
              ...
              <button
                ...
                className="text-stone-300 hover:text-rose-600 transition-colors p-4 bg-stone-100 rounded-full hover:bg-rose-50 whitespace-nowrap inline-block shrink-0"
              >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8">
                <div className="col-span-1 md:col-span-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-2xl transition-all whitespace-nowrap inline-block shrink-0"
                  />
                </div>
                <div className="col-span-1 md:col-span-2">
                  <label className="block text-[10px] font-black uppercase text-stone-500 mb-3 tracking-widest">
                  ...
                  <input
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-3xl transition-all whitespace-nowrap inline-block shrink-0"
                  />
                </div>
                <div className="col-span-1 md:col-span-2">
                  <label className="block text-[10px] font-black uppercase text-stone-500 mb-3 tracking-widest">
                ...
                <div>
                  ...
                  <div className="relative group/pass">
                    <input
                      ...
                      className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-2xl transition-all pr-16 whitespace-nowrap inline-block shrink-0"
                      placeholder={
                ...
                <div className="col-span-1 md:col-span-2">
                  ...
                  <select
                    ...
                    className="w-full px-4 md:px-5 py-4 bg-stone-100/50 border-2 border-transparent focus:border-primary-600 focus:bg-white focus:outline-none font-bold rounded-2xl transition-all cursor-pointer whitespace-nowrap inline-block shrink-0"
                  >
