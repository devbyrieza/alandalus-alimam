                  ...
                  >
                    <td className="p-5 md:p-8">
                      <div className="flex items-center gap-5">
                        <div className="w-12 h-12 rounded-2xl bg-primary-100 flex items-center justify-center text-primary-700 font-black text-xs border-2 border-white shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
                        ...
                        {user.secondary_roles &&
                          user.secondary_roles
                            ...
                            .map((r, i) => (
                              <span
                                key={i}
                                className="px-4 py-1.5 bg-stone-100 text-stone-600 text-[10px] font-black rounded-3xl border border-stone-200 uppercase tracking-widest shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10"
                              >
