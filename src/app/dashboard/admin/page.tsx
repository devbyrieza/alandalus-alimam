...
const StatWidget = ({ label, value, icon: Icon, color, trend, breakdown }: any) => {
  ...
  return (
    <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
      className="bg-white p-5 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] border border-cream-200 shadow-premium-sm hover:shadow-premium-lg transition-all group relative overflow-hidden">
      ...
      <div className="relative z-10">
        ...
        <div className="mb-6 lg:mb-8">
          <p className="text-[10px] sm:text-[11px] font-black text-maroon-400 uppercase tracking-[0.25em] mb-2">{label}</p>
          <div className="flex items-baseline gap-2">
            <h3 className="text-3xl sm:text-4xl lg:text-5xl font-black text-maroon-900 tracking-tighter italic">{value}</h3>
  ...
  return (
    <div className="max-w-[1400px] mx-auto space-y-6 sm:space-y-8 pb-20 px-1">
      ...
      <div className="bg-maroon-900 rounded-[2rem] sm:rounded-[2.5rem] lg:rounded-[3rem] p-6 sm:p-8 lg:p-12 text-white relative overflow-hidden shadow-2xl border border-white/5">
        ...
        <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12">
          <div className="max-w-xl w-full">
            ...
            <div className="flex items-center gap-8 sm:gap-12 mt-8 lg:mt-12">
              <div>
                ...
                <p className="text-[10px] sm:text-[11px] font-black text-cream-300 uppercase tracking-widest mt-2">Pendaftar</p>
              </div>
          ...
          <div className="grid grid-cols-2 gap-4 sm:gap-6 w-full lg:w-auto">
            ...
            <div className="bg-white/5 backdrop-blur-md p-4 sm:p-6 lg:p-8 rounded-[1.5rem] sm:rounded-[2rem] border border-white/10 flex flex-col items-center">
              <p className="text-[9px] sm:text-[10px] font-black text-cream-300 uppercase tracking-widest mb-2 sm:mb-4 text-center">Daftar Ulang</p>
              <p className="text-2xl sm:text-4xl font-black text-gold-400 italic">{stats.daftar_ulang}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      {!isAdminSuper && (
        ...
        <div className="bg-maroon-800 rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] p-5 sm:p-8 lg:p-10 text-white relative overflow-hidden group">
            ...
            <div className="grid grid-cols-2 gap-4 sm:gap-8">
              <div className="space-y-6 sm:space-y-8">
                ...
                <div>
                  ...
                  <p className="text-2xl sm:text-4xl font-black text-cream-400 italic">{stats.sudah_isi_data}</p>
                </div>
              </div>
        ...
        <div className="bg-white rounded-[1.5rem] sm:rounded-[2rem] lg:rounded-[2.5rem] border border-cream-200 p-5 sm:p-8 lg:p-10 shadow-premium-sm relative overflow-hidden group">
          <div className="relative z-10">
            <h3 className="text-xl sm:text-2xl font-black text-maroon-900 mb-6 sm:mb-8 tracking-tight flex items-center gap-3 italic">
              <div className="w-2 h-8 bg-maroon-600 rounded-full" />
              Aksi Cepat
            </h3>
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 bg-cream-50 rounded-2xl sm:rounded-3xl border border-cream-200 hover:border-maroon-200 transition-all cursor-default group/item gap-4">
                <div className="flex items-center gap-4 sm:gap-5">
                  <div className="w-12 h-12 rounded-2xl bg-white shadow-sm flex items-center justify-center text-maroon-600 transition-transform group-hover/item:scale-110 shrink-0">
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto border-t sm:border-0 pt-3 sm:pt-0 border-cream-200">
                  <span className="text-xl sm:text-2xl font-black text-maroon-900 italic">{stats.waiting_docs}</span>
                  <ChevronRight className="w-5 h-5 text-maroon-300 hidden sm:block" />
                </div>
              </div>
              <div className="flex flex-col sm:flex-row sm:items-center justify-between p-4 sm:p-6 bg-cream-50 rounded-2xl sm:rounded-3xl border border-cream-200 hover:border-emerald-200 transition-all cursor-default group/item gap-4">
                <div className="flex items-center gap-4 sm:gap-5">
                ...
                <div className="flex items-center justify-between sm:justify-end gap-3 w-full sm:w-auto border-t sm:border-0 pt-3 sm:pt-0 border-cream-200">
                  <span className="text-xl sm:text-2xl font-black text-maroon-900 italic">{stats.waiting_payment}</span>
                  <ChevronRight className="w-5 h-5 text-maroon-300 hidden sm:block" />
                </div>
              </div>
            </div>
