...
export default function RekapFeePengujiPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto pb-10">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 bg-white p-6 rounded-3xl border border-ink-100 shadow-sm  shadow-primary/20  shadow-primary/10">
