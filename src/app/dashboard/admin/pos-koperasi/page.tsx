  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        {/* Kolom Scan */}
        <div className="bg-white p-6 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 border border-gray-100">
          ...
          <form onSubmit={handleScan}>
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-4 py-3 border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#ddc192] focus:border-transparent outline-none transition"
            ...
            {!santriData && (
              <button 
                type="submit" 
                className="w-full bg-[#550000] text-white py-3 rounded-2xl font-medium hover:bg-red-900 transition disabled:opacity-50"
        ...
        {/* Kolom Pembayaran */}
        <div className="bg-white p-6 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 border border-gray-100 opacity-100 transition-opacity">
          <h2 className="text-xl font-semibold mb-4">Informasi Transaksi</h2>
          
          {santriData ? (
            <div className="space-y-4">
              <div className="bg-[#fdfbf7] p-6 sm:p-8 rounded-2xl border border-[#ddc192]">
              ...
              <form onSubmit={handleBayar}>
                <div className="mb-4">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 text-2xl font-bold border border-gray-300 rounded-2xl focus:ring-2 focus:ring-[#550000] focus:border-transparent outline-none transition"
                    placeholder="0"
                    required
                    min="1"
                  />
                ...
                <div className="flex space-x-3">
                  <button 
                    ...
                    className="flex-1 bg-gray-100 text-gray-700 py-3 rounded-2xl font-medium hover:bg-gray-200 transition"
                  >
                    Batal
                  </button>
                  <button 
                    type="submit" 
                    className="flex-[2] bg-[#ddc192] text-[#550000] py-3 rounded-2xl font-bold hover:brightness-95 transition disabled:opacity-50"
            ...
            <div className="h-48 flex items-center justify-center text-gray-400 border-2 border-dashed border-gray-200 rounded-2xl">
