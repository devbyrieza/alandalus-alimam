...
export default function PengaturanPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Edit Modal Overlay */}
      {editingTa && (
        <div className="fixed inset-0 z-[9999] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center bg-stone-900/50 backdrop-blur-sm p-6 sm:p-8 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
