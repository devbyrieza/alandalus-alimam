    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-6">
                <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-6 border border-slate-100 shadow-clay-sm relative overflow-hidden group">
                ...
                <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-6 border border-slate-100 shadow-clay-sm relative overflow-hidden group">
                    ...
                    <p className="text-2xl md:text-3xl font-black text-[#550000] relative z-10">{selesaiQuran}</p>
                </div>
                <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-6 border border-slate-100 shadow-clay-sm relative overflow-hidden group">
                    ...
                    <p className="text-2xl md:text-3xl font-black text-[#550000] relative z-10">{selesaiWSantri}</p>
                </div>
                <div className="bg-white rounded-2xl p-6 sm:p-8 md:p-6 border border-slate-100 shadow-clay-sm relative overflow-hidden group">
            ...
            {conflicts.length > 0 && (
                ...
                >
                    <div className="w-10 h-10 bg-rose-100 rounded-3xl flex items-center justify-center text-rose-600 shrink-0 whitespace-nowrap shrink-0">
                    ...
                    <div className="flex-1">
                        ...
                        <div className="mt-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
                            {conflicts.map((c, i) => (
                                <div key={i} className="bg-white/60 border border-rose-100 rounded-3xl p-3 text-[11px]">
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col md:flex-row gap-3">
                    ...
                    <div className="flex items-center gap-2">
                        <div className="flex-1 md:flex-none flex bg-slate-100 p-1.5 rounded-2xl h-12 min-w-fit whitespace-nowrap shrink-0">
                            {[
                                { id: "flat", label: "List" },
                        ...
                        <div className="grid grid-cols-1 gap-4 md:hidden">
                            {filteredSchedules.map((s) => (
                                <div key={s.id} className="bg-white rounded-[2.5rem] border border-slate-100 shadow-clay-m p-6 space-y-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1.5">
                                                ...
                                                <span className={`text-[10px] font-bold px-2 py-0.5 rounded uppercase ${
                                                    s.pendaftar.jenjang === 'MTs' ? 'bg-purple-100 text-purple-600' : 'bg-emerald-100 text-[#550000]'
                                                }`}>
                                                    {s.pendaftar.jenjang}
                                                </span>
                                            </div>
                                        ...
                                        {[
                                            ...
                                            <div key={i} className="flex items-center justify-between px-2">
                                                ...
                                                <span className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-full ${
                                                    stat.status === 'completed' ? 'bg-emerald-100 text-[#550000]' :
                                    ...
                                    <div className="flex items-center gap-2 text-[11px] text-slate-500 font-bold px-3 py-2 bg-slate-50 rounded-3xl">
                                                    ...
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className={`text-[10px] font-bold uppercase tracking-tight ${
                                                                s.status.quran === 'completed' ? 'text-[#550000]' : 'text-slate-400'
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className={`text-[10px] font-bold uppercase tracking-tight ${
                                                                s.status.santri === 'completed' ? 'text-[#550000]' : 'text-slate-400'
                                                ...
                                                <td className="px-6 py-6">
                                                    <div className="flex items-center gap-3">
                                                        ...
                                                        <div className="flex flex-col">
                                                            ...
                                                            <span className={`text-[10px] font-bold uppercase tracking-tight ${
                                                                s.status.ortu === 'completed' ? 'text-[#550000]' : 'text-slate-400'
                                                ...
                                                <tr key={`${item.schedule.id}-${idx}`} className="hover:bg-primary-50/10 transition-colors">
                                                    ...
                                                    <td className="px-7 py-4">
                                                        <span className={`px-2.5 py-0.5 rounded-md font-bold text-[10px] uppercase tracking-wide ${
                                                            ...
                                                            item.role === 'W. Santri' ? 'bg-indigo-100 text-[#550000]' :
                            ...
                            <div key={group.name} className="bg-white rounded-[2rem] shadow-clay-m border border-slate-100 overflow-hidden flex flex-col transition-all hover:translate-y-[-4px] group">
                                ...
                                <div className="p-5 flex-1 space-y-4">
                                    {group.items.map((s, idx) => (
                                        <div key={`${s.id}-${idx}`} className="bg-slate-50/30 rounded-2xl p-6 sm:p-8 border border-slate-100/50">
