  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex space-x-4 mb-8">
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-3xl font-bold text-lg transition-all ${
            mode === "KELUAR" 
              ? "bg-[#550000] text-white shadow-2xl shadow-primary/30  shadow-primary/20 scale-105" 
        ...
        <button
          ...
          className={`flex-1 flex items-center justify-center gap-2 py-4 rounded-3xl font-bold text-lg transition-all ${
            mode === "KEMBALI" 
              ? "bg-[#ddc192] text-[#550000] shadow-2xl shadow-primary/30  shadow-primary/20 scale-105" 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <form onSubmit={handleScan}>
            <div className="mb-4">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-2xl focus:ring-2 focus:border-transparent outline-none transition ${
            ...
            {mode === "KELUAR" && !santriData && (
              <button 
                type="submit" 
                className="w-full bg-gray-800 text-white py-3 rounded-2xl font-medium hover:bg-gray-900 transition disabled:opacity-50"
        ...
        {mode === "KELUAR" && (
          <div className={`bg-white p-6 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 border border-gray-100 transition-opacity ${santriData ? 'opacity-100' : 'opacity-50 pointer-events-none'}`}>
            ...
            <form onSubmit={handleProsesKeluar}>
              ...
              <div className="flex space-x-3 mt-6">
                ...
                <button 
                  type="submit" 
                  className="flex-[2] bg-[#550000] text-white py-3 rounded-2xl font-bold hover:bg-red-900 transition disabled:opacity-50"
