    ...
    <div className="space-y-6 max-w-7xl mx-auto pb-20">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          <h1 className="text-3xl font-black text-ink-900 tracking-tight flex items-center gap-3">
            <div className="p-2.5 bg-maroon-600 rounded-2xl shadow-lg shadow-maroon-600/20">
              <Activity className="w-6 h-6 text-white" />
            </div>
            Audit <span className="text-maroon-700">Hasil Seleksi</span>
          </h1>
        ...
        <div className="flex flex-wrap items-center gap-3 w-full lg:w-auto">
          <div className="relative flex-1 lg:flex-none lg:w-64">
            ...
            <input
              ...
              className="w-full bg-ink-50 border border-ink-100 rounded-xl pl-10 pr-4 py-2.5 text-sm font-medium outline-none focus:ring-4 focus:ring-maroon-500/5 transition-all"
            />
          </div>
            ...
            <thead>
              <tr className="bg-ink-50/50 border-b border-ink-100">
                <th className="px-6 py-5 text-center w-12">
                  <input
                    type="checkbox"
                    className="w-5 h-5 rounded-lg border-ink-200 text-maroon-600 focus:ring-maroon-500"
                ...
                <th className="px-6 py-5 text-center text-[10px] font-black text-maroon-700 uppercase tracking-widest bg-maroon-50/30">
                  Total Skor
                </th>
              ...
              {loading ? (
                <tr>
                  <td colSpan={10} className="px-6 py-20 text-center">
                    <Loader2 className="w-10 h-10 animate-spin mx-auto text-maroon-600 mb-4" />
                ...
                filteredCandidates.map((c) => {
                  ...
                  return (
                    <tr
                      key={c.id}
                      className={`hover:bg-maroon-50/20 transition-colors group ${selectedIds.includes(c.id) ? "bg-maroon-50/40" : ""}`}
                    >
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex flex-col">
                          <span className="text-[14px] font-black text-ink-900 uppercase leading-none mb-1 group-hover:text-maroon-700 transition-colors">
                            {c.nama_lengkap}
                          </span>
                      ...
                      <td className="px-6 py-4 text-center bg-maroon-50/20">
                        <div className="flex flex-col items-center">
                          <span className="text-lg font-black text-maroon-700 leading-none">
                            {(nu?.nilai_total != null ? Number(nu.nilai_total).toFixed(2) : undefined) || "-"}
                          </span>
                          <span className="text-[8px] font-black text-maroon-400 uppercase tracking-widest mt-1">
                            Final Score
                          </span>
                        </div>
                      </td>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
        ...
        <div className="bg-white rounded-3xl p-8 border border-ink-100 shadow-premium-sm flex flex-col justify-between">
          ...
          <div className="mt-8 flex items-center gap-4 p-4 bg-maroon-50 rounded-2xl border border-maroon-100">
             <div className="p-3 bg-white rounded-xl shadow-sm">
                <RefreshCcw className="w-5 h-5 text-maroon-600" />
             </div>
             <p className="text-[11px] font-bold text-maroon-800 leading-snug">
