          ...
          <div className="flex items-center gap-4 md:gap-6">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-black text-ink-900 tracking-tight">
                Rekap{" "}
                <span className="text-maroon-700">Honor Penguji Al-Qur'an</span>
              </h1>
            ...
            <tbody className="divide-y divide-ink-50">
              {loading ? (
                ...
                filteredRecap.map((item) => (
                  <tr
                    key={item.id}
                    className="group hover:bg-maroon-50/20 transition-all"
                  >
                    <td className="px-6 py-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <p className="text-sm font-black text-ink-900 group-hover:text-maroon-700 transition-colors uppercase">
                            {item.name}
                          </p>
                    ...
                    <td className="px-6 py-6 text-right">
                      <div className="flex flex-col items-end">
                        <span className="text-lg font-black text-maroon-700 leading-none">
                          {formatCurrency(calculateTotalFee(item))}
                        </span>
        ...
        <div className="md:hidden divide-y divide-ink-50">
          {loading ? (
            ...
            filteredRecap.map((item) => (
              <div
                key={item.id}
                className="p-5 bg-white hover:bg-maroon-50/10 transition-colors"
              >
                {/* Name + Honor Row */}
