    ...
    if (!pendaftar && !loading) {
        return (
            <div className="bg-white rounded-3xl shadow-sm p-10 border border-gold-200 text-center">
                ...
                <h2 className="text-2xl font-black text-maroon-950 mb-2">Data Tidak Ditemukan</h2>
        ...
        <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <div className="flex items-center gap-3 text-ink-300">
                                <span className="font-mono bg-maroon-50 px-2.5 py-1 rounded-lg text-sm font-black text-maroon-600 border border-maroon-100">{pendaftar?.nomor_pendaftaran}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {dokumenList.map((dok) => (
                    <div
                        key={dok.id}
                        className={`bg-white border rounded-3xl overflow-hidden transition-all shadow-xs hover:shadow-xl hover:shadow-maroon-900/5 ${dok.status_verifikasi === "verified"
                            ? "border-emerald-200"
                    ...
                    >
                        ...
                        <div className="p-5">
                            <div className="flex items-start justify-between mb-2">
                                <h3 className="font-black text-maroon-950 capitalize tracking-tight leading-tight">{dok.jenis_dokumen.replace(/_/g, " ")}</h3>
                            ...
                            <button
                                onClick={async () => {
                                    if (!rejectReason.trim()) {
                                        Swal.fire("Perhatian", "Mohon isi alasan penolakan", "warning");
                                        return;
                                    }
