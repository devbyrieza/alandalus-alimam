...
export default function VerifikasiDokumenDetailPage() {
  ...
  if (!pendaftar && !loading) {
    return (
      <div className="bg-white rounded-3xl shadow-md p-6 md:p-10 border border-gold-200 text-center">
        ...
        <button
          onClick={() => router.back()}
          className="px-6 py-3 bg-primary-700 hover:bg-primary-800 text-white rounded-3xl font-bold transition-all shadow-lg shadow-primary-700/20 active:scale-95"
        >
          Kembali ke Daftar
        </button>
      </div>
      ...
      <div className="bg-white rounded-3xl shadow-md p-6 border border-gold-100">
        <div className="flex items-center justify-between flex-wrap gap-4">
          <div className="flex items-center gap-4">
            ...
            <div className="p-6 sm:p-8 bg-linear-to-br from-primary-600 to-primary-900 rounded-2xl shadow-xl shadow-primary-900/20">
            ...
            <div className="relative aspect-[4/3] bg-stone-100">
              ...
              {dok.file_url && isImageFile(dok) && (
                <a
                  ...
                  className="absolute top-3 right-3 p-4 bg-white/90 hover:bg-white rounded-3xl text-stone-700 shadow-md transition-all"
                >
                ...
                <button
                  ...
                  className={`flex-1 flex items-center justify-center gap-2 py-2.5 rounded-3xl text-xs font-bold transition-all ${
                    dok.status_verifikasi === "verified"
                      ...
                      : "bg-[#550000] hover:bg-[#550000] text-white shadow-lg shadow-emerald-600/20 active:scale-95 disabled:opacity-50"
                  }`}
                >
                  {processingDocs.has(dok.id) ? (
          ...
          >
            ...
            <div className="p-6 sm:p-8 bg-stone-50 flex items-center justify-end gap-3 border-t border-stone-100">
              ...
              <button
                ...
                className="px-5 py-2.5 bg-rose-600 hover:bg-rose-700 text-white rounded-3xl text-sm font-bold shadow-lg shadow-rose-600/20 hover:shadow-rose-600/40 transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed transform active:scale-95"
              >
