  ...
  return (
    <div className="space-y-6">
      ...
      {isEditModalOpen && editFormData && (
        <div className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center z-50 p-6 sm:p-8 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
      ...
      {isNilaiModalOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-8 sm:p-6 overscroll-contain">
          <div
      ...
      {isWdModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-6 sm:p-8 bg-primary-950/40 backdrop-blur-sm overflow-y-auto overscroll-contain custom-scrollbar">
