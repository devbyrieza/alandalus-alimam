        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-6 relative z-10">
          ...
          <div className="flex flex-wrap gap-4">
            <div className="bg-white/10 backdrop-blur-md rounded-2xl px-5 py-4 min-w-[120px] border border-white/10">
              <p className="text-[10px] text-maroon-100 font-black uppercase tracking-widest mb-1">
                Pembayaran
              </p>
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-2xl px-5 py-4 min-w-[120px] border border-white/10">
              ...
              <p className="font-black text-xl text-white">
                ...
                <span className="text-xs font-medium text-maroon-200">
                  Verified
                </span>
              </p>
            </div>
          ...
          {isBerkas && (
            <div className="bg-white rounded-3xl shadow-sm p-6 border border-gold-100">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h3 className="text-xl font-black text-maroon-950 tracking-tight">
          ...
          {(isPenguji ||
            ...
            <div className="bg-white rounded-3xl shadow-sm p-6 border border-gold-100">
              <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                  <h3 className="text-xl font-black text-maroon-950 tracking-tight leading-tight">
                    Hasil Seleksi & Ujian
                  </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-maroon-50/50 p-4 rounded-2xl border border-maroon-100 relative">
                  <span className="block text-[10px] text-maroon-600 font-black uppercase tracking-widest mb-1 leading-none">
                    CBT: Akademik
                  </span>
                  {!pendaftar.nilai_ujian ? (
                    ...
                    <div className="flex items-baseline gap-1">
                      ...
                      <span className="text-xs text-maroon-300 font-black uppercase">
                        pts
                      </span>
                    </div>
                  )}
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-4 pt-2 border-t border-gold-200/50">
                        <div>
                          ...
                          <span className="font-bold text-maroon-950 text-sm">
  ...
  return (
    <div>
      ...
      <div className="flex items-center gap-2">
        ...
        <p className="font-bold text-maroon-950 leading-tight">
          {value || "-"}
        </p>
      </div>
    </div>
