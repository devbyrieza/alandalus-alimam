...
export default function PendaftarDetailPage() {
  ...
  const handleUbahJenjang = async () => {
    ...
    const { value: newJenjang } = await Swal.fire({
      ...
      html: "<div class='text-left text-sm mb-4 text-stone-600 bg-amber-50 p-3 rounded-2xl border border-amber-200'>" +
    ...
    if (selectedKeringanan) {
      ...
      if (selectedKeringanan === "none") {
        ...
        const { value: formValues } = await Swal.fire({
          ...
          html: `
            <div class="text-left text-sm mb-4 text-stone-600 bg-amber-50 p-3 rounded-2xl border border-amber-200">
              Masukkan nominal <b>POTONGAN (Diskon)</b> (bukan sisa tagihan).<br/><br/>
              Contoh: Jika Uang Pangkal normal Rp 7.650.000, dan wali santri hanya sanggup bayar Rp 6.000.000, berarti <b>potongannya adalah Rp 1.650.000</b>. <br/>Ketik: <b>1650000</b>.
            </div>
  ...
  const formatStatus = (status: string, dataLengkap?: any) => {
    ...
    const statusMap: Record<string, { label: string; color: string }> = {
      ...
      docs_verified: {
        ...
        color: "bg-emerald-50 text-[#550000] border border-emerald-100" },
      scheduled: {
      ...
      tested: {
        label: "Proses Seleksi",
        color: "bg-primary-600 text-white shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10" },
      exam_completed: {
        label: "Proses Seleksi",
        color: "bg-primary-600 text-white shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10" },
      announced: {
      ...
      cadangan: {
        label: "Cadangan",
        color: "bg-gold-100 text-gold-800 border border-gold-200" },
      accepted: { label: "Diterima", color: "bg-[#550000] text-white" },
      ...
      enrolled: {
        ...
        color: "bg-emerald-100 text-[#550000]" },
      enrolled_full: {
    ...
    return (
      <div className="text-center py-20">
        ...
        <Link
          ...
          className="mt-4 inline-flex items-center gap-2 px-4 py-2 bg-primary-600 text-white rounded-2xl"
        >
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Summary Card */}
      <div className="bg-linear-to-br from-primary-600 to-primary-900 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary-900/20 p-5 md:p-8 text-white relative overflow-hidden">
          ...
          <div className="flex items-center gap-5">
            ...
            <div>
              ...
              <div className="flex flex-wrap items-center gap-3 mt-2">
                <span className="font-mono bg-white/20 px-2.5 py-1 rounded-2xl text-sm font-black text-white border border-white/20">
                  {pendaftar.nomor_pendaftaran}
                </span>
                <span className="px-2.5 py-1 bg-gold-400 text-primary-900 rounded-2xl text-xs font-black uppercase shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
                  {pendaftar.jenjang}
                </span>
        ...
        <div className="mt-6 pt-6 border-t border-white/20 flex flex-wrap items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            ...
            <span
              className={`px-3 py-1 rounded-2xl text-sm font-bold ${statusInfo.color}`}
            >
              {statusInfo.label}
            </span>
          </div>
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1 disabled:opacity-50 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 active:scale-95"
            >
            ...
            {pendaftar.no_hp && (
              <a
                ...
                className="px-4 py-2 bg-[#550000] hover:bg-[#550000] text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 active:scale-95"
              >
            ...
            {userRole === "admin_super" && (
              <>
                <button
                  ...
                  className="px-4 py-2 bg-purple-600 hover:bg-purple-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 active:scale-95 border border-purple-500 mr-2"
                >
                ...
                <button
                  ...
                  className="px-4 py-2 bg-gold-400 hover:bg-yellow-500 text-primary-900 rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 active:scale-95 border border-gold-300 mr-2"
                >
                ...
                <button
                  ...
                  disabled={exporting}
                  className="px-4 py-2 bg-[#550000] hover:bg-[#550000] text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 active:scale-95 mr-2"
                >
                ...
                <button
                  ...
                  disabled={exporting}
                  className="px-4 py-2 bg-rose-600 hover:bg-rose-700 text-white rounded-3xl text-xs font-black transition-all flex items-center gap-1.5 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 active:scale-95 mr-2"
                >
            ...
            {pendaftar.email && (
              <a
                ...
                className="px-4 py-2 bg-white/20 hover:bg-white/30 rounded-3xl text-xs font-black transition-all flex items-center gap-1 backdrop-blur-md active:scale-95"
              >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {isBerkas && (
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 p-6 border border-gold-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-primary-50 rounded-3xl">
              ...
              <div className="mb-4 grid grid-cols-1 md:grid-cols-2 sm:grid-cols-1 lg:grid-cols-3 gap-2">
                {[
                  ...
                  <button
                    ...
                    className="px-3 py-2 bg-primary-50 hover:bg-primary-100 text-primary-700 rounded-3xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center justify-center gap-1.5 border border-primary-100 disabled:opacity-50 whitespace-nowrap inline-block shrink-0"
                  >
                ...
                <div className="space-y-4">
                  {pendaftar.dokumen.map((doc) => {
                    ...
                    return (
                      <div
                        key={doc.id}
                        className="flex items-center justify-between p-6 sm:p-8 bg-stone-50 rounded-2xl border border-stone-200"
                      >
                        <div className="flex items-center gap-3">
          ...
          {(isPenguji ||
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 p-6 border border-gold-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-gold-50 rounded-3xl">
              ...
              {userRole === "admin_super" && (
                <div className="mb-6 p-6 sm:p-8 bg-blue-50 border border-blue-100 rounded-2xl flex flex-col sm:flex-row sm:items-center gap-3">
                  <span className="text-xs font-black uppercase tracking-widest text-[#550000]">
                    Aksi Admin (Bypass):
                  </span>
                  <div className="flex flex-wrap gap-2">
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-[#550000] hover:bg-[#550000] text-white rounded-3xl text-[11px] font-bold transition-colors shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10"
                    >
                      Buka CBT Akademik
                    </a>
                    <a
                      ...
                      target="_blank"
                      className="px-3 py-1.5 bg-purple-600 hover:bg-purple-700 text-white rounded-3xl text-[11px] font-bold transition-colors shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10"
                    >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <div className="bg-primary-50/50 p-6 sm:p-8 rounded-2xl border border-primary-100 relative">
                ...
                <div className="bg-indigo-50/50 p-6 sm:p-8 rounded-3xl border border-indigo-100">
                  <span className="block text-xs text-[#550000] font-bold uppercase tracking-wide mb-1">
                    CBT: Kepribadian
                  </span>
                  {!pendaftar.nilai_ujian ? (
                    ...
                    <div className="flex items-baseline gap-2">
                      <span className="text-3xl font-black text-[#550000]">
                ...
                <div className="bg-violet-50/50 p-6 sm:p-8 rounded-3xl border border-violet-100">
                ...
                <div className="bg-emerald-50/50 p-6 sm:p-8 rounded-3xl border border-emerald-100 flex flex-col justify-between">
                  <div>
                    <span className="block text-xs text-[#550000] font-bold uppercase tracking-wide mb-1">
                      Tes Al-Qur&apos;an
                    </span>
                ...
                {(pendaftar?.jenjang?.toLowerCase() || "").includes("ma") && (
                  <div className="bg-teal-50/50 p-6 sm:p-8 rounded-3xl border border-teal-100 flex flex-col justify-between">
                    <div>
                ...
                {(pendaftar?.jenjang?.toLowerCase() || "").includes("ma") && (
                  <div className="bg-sky-50/50 p-6 sm:p-8 rounded-3xl border border-sky-100 flex flex-col justify-between">
                    <div>
                ...
                <div className="bg-secondary-50/50 p-6 sm:p-8 rounded-3xl border border-secondary-100 flex flex-col justify-between">
                  <div>
                ...
                <div className="bg-rose-50/50 p-6 sm:p-8 rounded-3xl border border-rose-100 flex flex-col justify-between">
                  <div>
              ...
              {(pendaftar.nilai_ujian?.catatan_umum || pendaftar.nilai_ujian?.catatan) && (
                <div className="bg-stone-50 p-6 sm:p-8 rounded-2xl border border-stone-200 mt-4">
              ...
              {isPenguji && (
                <div className="mt-4 flex justify-end">
                  <Link
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-purple-600 text-white rounded-2xl hover:bg-purple-700 transition-colors shadow hover:shadow-2xl shadow-primary/30  shadow-primary/20 font-bold text-sm"
                  >
                ...
                <div className="mt-4 flex justify-end gap-2">
                  {userRole === "admin_super" && (
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-2 bg-amber-500 text-white rounded-2xl hover:bg-amber-600 transition-colors shadow hover:shadow-2xl shadow-primary/30  shadow-primary/20 font-bold text-sm"
                    >
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-4 py-2 bg-violet-600 text-white rounded-2xl hover:bg-violet-700 transition-colors shadow hover:shadow-2xl shadow-primary/30  shadow-primary/20 font-bold text-sm"
                  >
          ...
          {(userRole === "admin_super" || userRole === "admin") && 
            ...
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 p-6 border border-emerald-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-emerald-50 rounded-3xl">
                  <CheckCircle className="w-6 h-6 text-[#550000]" />
                </div>
                <div>
              ...
              {!pendaftar.reservasi || pendaftar.reservasi.length === 0 ? (
                <div className="p-6 sm:p-8 bg-stone-50 border border-stone-200 rounded-2xl flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-4 py-2 bg-[#550000] text-white rounded-3xl text-xs font-black"
                  >
                    Input Data
                  </button>
                </div>
                ...
                <div className="space-y-4">
                  {pendaftar.reservasi.map((res: any) => {
                    ...
                    return (
                      <div key={res.id} className="p-5 bg-emerald-50/50 rounded-2xl border border-emerald-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 relative">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4">
                          <div>
                            <span className="block text-[10px] text-[#550000] font-black uppercase tracking-widest mb-1">Status Kehadiran</span>
                            <span className={`px-2.5 py-1 rounded-2xl text-xs font-black ${data.statusKehadiran === 'HADIR' ? 'bg-emerald-100 text-[#550000]' : 'bg-red-100 text-red-700'}`}>
                          ...
                          {data.statusKehadiran === 'HADIR' && (
                            <>
                              <div>
                                <span className="block text-[10px] text-[#550000] font-black uppercase tracking-widest mb-1">Rombongan</span>
                                <span className="text-sm font-black text-emerald-950">{data.totalPengantar || 0} Orang</span>
                                <span className="block text-xs text-[#550000]">Ruang Utama: {(Number(data.jumlahPendamping) || 0) + 1} Org</span>
                              </div>
                              <div>
                                <span className="block text-[10px] text-[#550000] font-black uppercase tracking-widest mb-1">Kendaraan</span>
                          ...
                          {data.catatanTambahan && (
                            <div className="sm:col-span-2 md:col-span-3">
                              <span className="block text-[10px] text-[#550000] font-black uppercase tracking-widest mb-1">Catatan</span>
                        ...
                        <div className="mt-4 flex justify-end">
                          <button
                            ...
                            className="flex items-center gap-1.5 px-3 py-1.5 bg-white border border-emerald-200 text-[#550000] hover:bg-emerald-50 rounded-2xl text-xs font-black transition-colors"
                          >
                            <Edit className="w-3.5 h-3.5" />
                            Edit
                          </button>
          ...
          {isKeuangan && (
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 p-6 border border-gold-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-gold-100 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
              ...
              {pendaftar.pembayaran.length === 0 ? (
                ...
                <div className="space-y-4">
                  {pendaftar.pembayaran.map((payment) => (
                    <div
                      key={payment.id}
                      className="p-6 sm:p-8 bg-gold-50/50 rounded-2xl border border-gold-100 shadow-xs"
                    >
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <span
                          className={`px-3 py-1 rounded-2xl text-[10px] font-black uppercase tracking-widest ${
                            payment.status_pembayaran === "verified"
                              ? "bg-emerald-100 text-[#550000] border border-emerald-200"
                        ...
                        <div className="flex flex-col items-end gap-2">
                          ...
                          {(!payment.bukti_transfer_path || payment.status_pembayaran !== "verified") && (
                            <button
                              ...
                              className="px-3 py-1 bg-white hover:bg-gold-100 text-gold-700 rounded-2xl text-[10px] font-black uppercase tracking-wider transition-all flex items-center gap-1.5 border border-gold-200 disabled:opacity-50"
                            >
          ...
          <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 p-6 border border-gold-100">
            <div className="flex items-center gap-3 mb-6">
              <div className="p-3 bg-emerald-50 rounded-3xl">
                <MapPin className="w-6 h-6 text-[#550000]" />
              </div>
              <h3 className="text-xl font-black text-primary-950 tracking-tight">
                Kontak & Alamat
              </h3>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="flex-1 px-3 py-2 bg-stone-50 border border-stone-200 rounded-2xl text-sm font-bold text-primary-950 focus:outline-none focus:ring-2 focus:ring-primary-500"
                      ...
                      <button
                        ...
                        disabled={savingPhone}
                        className="p-4 bg-[#550000] text-white rounded-2xl hover:bg-[#550000] transition-colors disabled:opacity-50"
                        title="Simpan Nomor"
                      >
                        {savingPhone ? (
                      ...
                      <button
                        ...
                        disabled={savingPhone}
                        className="p-4 bg-stone-200 text-stone-600 rounded-2xl hover:bg-stone-300 transition-colors"
                        title="Batal"
                      >
                        <X className="w-4 h-4" />
                      </button>
                  ...
                  <div className="flex items-end justify-between">
                    ...
                    {userRole === "admin_super" && (
                      <button
                        ...
                        className="p-1.5 text-primary-500 hover:text-primary-700 bg-primary-50 hover:bg-primary-100 rounded-2xl transition-colors flex items-center gap-1 whitespace-nowrap inline-block shrink-0"
                        title="Edit Nomor HP"
                      >
                        <Edit className="w-3.5 h-3.5" />
          ...
          {pendaftar.orang_tua && (
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 p-6 border border-gold-100">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-3 bg-gold-100 rounded-3xl">
              ...
              <div className="space-y-8">
                {/* Data Ayah */}
                <div className="p-6 sm:p-8 bg-stone-50 rounded-3xl border border-stone-100">
          ...
          {!isKeuangan && (
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 p-6 border-2 border-red-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="md:col-span-2">
                  ...
                  <div className="p-3 bg-red-50 text-red-900 rounded-2xl border border-red-100 min-h-[60px]">
                    {pendaftar.hobi ||
        ...
        <div className="space-y-6">
          ...
          {/* Status Dokumen */}
          {!isKeuangan && (
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 p-6 border-2 border-primary-100">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-4 bg-primary-100 rounded-2xl whitespace-nowrap inline-block shrink-0">
                  <FileText className="w-6 h-6 text-primary-700" />
                </div>
          ...
          {!isKeuangan && !isBerkas && !isPenguji && (
            <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 p-6 border-2 border-primary-100">
              <div className="flex items-center gap-3 mb-4">
                <div className="p-4 bg-emerald-100 rounded-2xl whitespace-nowrap inline-block shrink-0">
                  <CreditCard className="w-6 h-6 text-[#550000]" />
                </div>
              ...
              {pendaftar.pembayaran.length === 0 ? (
                ...
                <div className="space-y-3">
                  {pendaftar.pembayaran.map((payment) => (
                    <div
                      key={payment.id}
                      className="p-3 bg-stone-50 rounded-2xl"
                    >
                      <div className="flex items-center justify-between mb-2">
          ...
          <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 p-6 border-2 border-primary-100">
            <div className="flex items-center gap-3 mb-4">
              <div className="p-4 bg-stone-100 rounded-2xl whitespace-nowrap inline-block shrink-0">
      ...
      {isEditModalOpen && editFormData && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 bg-black/60 backdrop-blur-md flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center z-50 p-6 sm:p-8 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-5xl max-h-[90vh] flex flex-col overflow-hidden border border-stone-200">
            ...
            <div className="bg-primary-950 p-6 text-white flex items-center justify-between border-b border-primary-900">
              ...
              <button
                ...
                className="p-4 hover:bg-white/10 rounded-full text-white/80 hover:text-white transition-all"
              >
                <X className="w-6 h-6" />
              </button>
            </div>
            ...
            <form onSubmit={handleSaveEdit} className="flex-1 overflow-y-auto p-5 md:p-8 space-y-6 overscroll-contain custom-scrollbar">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-1">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-3xl focus:outline-none focus:ring-2 focus:ring-primary-600 font-bold text-stone-850"
                    />
                  </div>
                  <div className="space-y-1">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-1">
                    ...
                    <textarea
                      ...
                      rows={3}
                      className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-3xl focus:outline-none focus:ring-2 focus:ring-primary-600 font-bold text-stone-850 resize-none"
                    />
                  </div>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="space-y-1">
              ...
              <div className="border-t border-stone-200 pt-6 flex items-center justify-end gap-3 sticky bottom-0 bg-white">
                <button
                  type="button"
                  onClick={() => setIsEditModalOpen(false)}
                  className="px-6 py-3 bg-stone-100 hover:bg-stone-200 text-stone-800 rounded-3xl font-black text-sm uppercase transition-all whitespace-nowrap inline-block shrink-0"
                >
                  Batal
                </button>
                <button
                  type="submit"
                  disabled={savingEdit}
                  className="px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white rounded-3xl font-black text-sm uppercase transition-all shadow-2xl shadow-primary/30  shadow-primary/20 flex items-center gap-2 disabled:opacity-50"
                >
      ...
      {isNilaiModalOpen && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[100] flex items-center justify-center p-6 sm:p-8 sm:p-6 overscroll-contain">
          <div
          ...
          <div className="relative w-full max-w-md bg-white rounded-[2rem] shadow-2xl flex flex-col max-h-[90vh] overflow-hidden animate-in fade-in zoom-in-95 duration-200">
            <div className="px-6 md:px-8 py-6 border-b border-surface-100 flex items-center justify-between shrink-0 bg-surface-50/50">
              ...
              <button
                onClick={() => setIsNilaiModalOpen(false)}
                className="p-4 hover:bg-surface-200 rounded-3xl transition-colors text-ink-500"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <form onSubmit={handleSaveNilaiManual} className="p-6 md:p-8 overflow-y-auto custom-scrollbar flex-1 overscroll-contain">
              <div className="space-y-4">
                <div className="bg-amber-50 text-amber-800 p-6 sm:p-8 rounded-3xl text-sm mb-4 border border-amber-200 font-medium">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-surface-50 border border-surface-200 rounded-3xl px-4 py-3 font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all mt-1"
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full bg-surface-50 border border-surface-200 rounded-3xl px-4 py-3 font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all text-sm resize-none"
                    rows={2}
                  />
                </div>
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <select
                        ...
                        className="w-full bg-surface-50 border border-surface-200 rounded-3xl px-4 py-3 font-medium focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 outline-none transition-all mt-1 text-xs truncate"
                      >
                        <option value="">(Kosong)</option>
              ...
              <div className="pt-6 mt-6 border-t border-surface-100 flex justify-end gap-3">
                <button
                  type="button"
                  onClick={() => setIsNilaiModalOpen(false)}
                  className="px-5 py-2.5 hover:bg-surface-100 text-ink-600 rounded-3xl font-bold text-sm transition-colors"
                >
                  Batal
                </button>
                <button
                  ...
                  className="px-6 py-2.5 bg-amber-600 hover:bg-amber-700 text-white rounded-3xl font-black text-sm uppercase transition-all shadow-2xl shadow-primary/30  shadow-primary/20 disabled:opacity-50"
                >
      ...
      {isWdModalOpen && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-center justify-center p-6 sm:p-8 bg-primary-950/40 backdrop-blur-sm overflow-y-auto overscroll-contain custom-scrollbar">
          <div className="bg-white w-full max-w-lg rounded-3xl shadow-2xl flex flex-col max-h-[90vh]">
            <div className="flex items-center justify-between p-6 border-b border-surface-100 bg-surface-50 rounded-t-3xl">
              ...
              <button
                ...
                className="p-4 text-ink-300 hover:text-ink-600 hover:bg-surface-200 rounded-3xl transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
            ...
            <div className="p-6 overflow-y-auto space-y-5 overscroll-contain custom-scrollbar">
              <div>
                ...
                <div className="flex gap-4">
                  <label className={`flex-1 flex items-center justify-center gap-2 p-3 rounded-3xl border-2 cursor-pointer transition-all ${
                    wdFormData.statusKehadiran === "HADIR"
                      ? "border-emerald-500 bg-emerald-50 text-[#550000]"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full p-3 rounded-3xl border border-surface-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 outline-none transition-all font-medium text-ink-600 bg-white"
                      />
                    </div>
                    <div>
                      <label className="text-xs font-black uppercase tracking-wider text-ink-300 mb-2 block">
              ...
              <div>
                ...
                <textarea
                  ...
                  rows={3}
                  className="w-full p-3 rounded-3xl border border-surface-200 focus:border-emerald-500 focus:ring-4 focus:ring-emerald-500/20 outline-none transition-all font-medium text-ink-600 bg-white resize-none"
                />
              </div>
            </div>
            ...
            <div className="p-6 border-t border-surface-100 bg-surface-50 rounded-b-3xl flex justify-end gap-3">
              <button
                type="button"
                onClick={() => setIsWdModalOpen(false)}
                className="px-5 py-2.5 rounded-3xl text-ink-600 font-bold hover:bg-surface-200 transition-colors"
              >
                Batal
              </button>
              <button
                ...
                className="px-6 py-2.5 rounded-3xl bg-[#550000] hover:bg-[#550000] text-white font-black shadow-2xl shadow-primary/30  shadow-primary/20 shadow-emerald-500/30 transition-all active:scale-95 disabled:opacity-50"
              >
