    ...
    try {
      ...
      Swal.fire({
        ...
        html: `
          ...
          <div class="bg-stone-100 p-6 sm:p-8 rounded-3xl text-left mt-4 border border-stone-200">
    ...
    <div className="space-y-6 pb-20">
      <div className="flex items-center gap-4">
        <Link
          ...
          className="p-4 hover:bg-stone-100 rounded-full transition-colors whitespace-nowrap inline-block shrink-0"
        >
      ...
      <div className="bg-blue-50 border-l-4 border-blue-500 p-6 sm:p-8 rounded-r-xl flex gap-3 text-[#550000] text-sm">
        <Info className="w-5 h-5 shrink-0 text-[#550000]" />
        <p>
        ...
        <form onSubmit={handleSubmit} className="p-6 md:p-8 space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <label className={`relative flex cursor-pointer rounded-3xl border-2 p-6 sm:p-8 transition-all ${formData.tipe_pendaftaran === 'BARU' ? 'border-primary-500 bg-primary-50' : 'border-stone-200 hover:border-stone-300'}`}>
              ...
              <label className={`relative flex cursor-pointer rounded-3xl border-2 p-6 sm:p-8 transition-all ${formData.tipe_pendaftaran === 'PINDAHAN' ? 'border-purple-500 bg-purple-50' : 'border-stone-200 hover:border-stone-300'}`}>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input required type="text" name="nik" value={formData.nik} onChange={handleChange} maxLength={16} placeholder="Contoh: 3201..." className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-stone-700">Nama Lengkap Sesuai KK <span className="text-red-500">*</span></label>
                <input required type="text" name="nama_lengkap" value={formData.nama_lengkap} onChange={handleChange} placeholder="Nama lengkap..." className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-stone-700">Jenis Kelamin <span className="text-red-500">*</span></label>
                <select required name="jenis_kelamin" value={formData.jenis_kelamin} onChange={handleChange} className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all appearance-none bg-white">
              ...
              <div className="space-y-2">
                ...
                <select required name="jenjang" value={formData.jenjang} onChange={handleChange} className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all appearance-none bg-white">
               ...
               <div className="space-y-2">
                ...
                <input type="date" name="tanggal_lahir" value={formData.tanggal_lahir} onChange={handleChange} className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all" />
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-2">
                ...
                <input required type="tel" name="no_hp" value={formData.no_hp} onChange={handleChange} placeholder="Contoh: 081234567890" className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all" />
              </div>
              <div className="space-y-2">
                <label className="text-sm font-bold text-stone-700">Email (Opsional)</label>
                <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="email@contoh.com" className="w-full px-4 py-2.5 rounded-3xl border-2 border-stone-200 focus:border-primary-500 focus:ring-4 focus:ring-primary-500/10 outline-none transition-all" />
              </div>
            </div>
          </div>
          ...
          {formData.tipe_pendaftaran === "PINDAHAN" && (
            <div className="space-y-4 bg-purple-50 p-6 rounded-3xl border border-purple-100">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div className="space-y-2">
                  ...
                  <select required name="kelas_masuk" value={formData.kelas_masuk} onChange={handleChange} className="w-full px-4 py-2.5 rounded-3xl border-2 border-purple-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 outline-none transition-all appearance-none bg-white">
                ...
                <div className="space-y-2">
                  ...
                  <input required type="text" name="asal_institusi" value={formData.asal_institusi} onChange={handleChange} placeholder="Nama sekolah asal..." className="w-full px-4 py-2.5 rounded-3xl border-2 border-purple-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 outline-none transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-purple-900">NISN (Nomor Induk Siswa Nasional) <span className="text-red-500">*</span></label>
                  <input required type="text" name="nisn" value={formData.nisn} onChange={handleChange} placeholder="NISN santri..." className="w-full px-4 py-2.5 rounded-3xl border-2 border-purple-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 outline-none transition-all" />
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-bold text-purple-900">NPSN Sekolah Asal <span className="text-red-500">*</span></label>
                  <input required type="text" name="npsn" value={formData.npsn} onChange={handleChange} placeholder="NPSN asal sekolah..." className="w-full px-4 py-2.5 rounded-3xl border-2 border-purple-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 outline-none transition-all" />
                </div>
                <div className="space-y-2 md:col-span-2">
                  <label className="text-sm font-bold text-purple-900">Alasan Pindah (Opsional)</label>
                  <textarea name="catatan_pindahan" value={formData.catatan_pindahan} onChange={handleChange} rows={2} className="w-full px-4 py-2.5 rounded-3xl border-2 border-purple-200 focus:border-purple-500 focus:ring-4 focus:ring-purple-500/20 outline-none transition-all resize-none"></textarea>
                </div>
              </div>
            </div>
          )}
