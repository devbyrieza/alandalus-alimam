...
export default function TrashPage() {
    ...
    const [restoringItem, setRestoringItem] = useState<DeletedPendaftar | null>(null);
    ...
    const handleRestore = async () => {
        ...
        try {
            setIsRestoring(true);
            const res = await fetch(`/api/admin/pendaftar/${restoringItem.id}/restore`, {
                method: "POST",
            });
                    ...
                    <div className="bg-white rounded-2xl shadow-xl w-full max-w-md border-2 border-green-100 animate-in fade-in zoom-in duration-200">
                        <div className="flex justify-between items-center p-6 border-b border-green-100">
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <h3 className="text-lg font-bold text-stone-900">Restore Data</h3>
                                    <p className="text-sm text-stone-500">Pulihkan data pendaftar</p>
                                </div>
                            </div>
                            <button
