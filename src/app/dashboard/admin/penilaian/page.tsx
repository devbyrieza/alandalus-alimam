              ...
              <table className="min-w-full divide-y divide-ink-100">
                <thead className="bg-ink-50/50">
                  <tr>
                    ...
                    <th className="px-3 py-4 text-center text-[10px] font-black text-maroon-700 uppercase tracking-widest bg-maroon-50/30">
                      Total
                    </th>
                ...
                <tbody className="bg-white divide-y divide-ink-50">
                  {loading ? (
                    ...
                    filteredStudents.map((s) => (
                      <tr
                        key={s.id}
                        className="hover:bg-maroon-50/30 transition-colors group"
                      >
                    ...
                    <div className="flex items-start justify-between gap-3">
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 mb-1">
                          ...
                          <span className="text-[9px] font-black text-maroon-700 bg-maroon-50 px-2 py-0.5 rounded-lg uppercase">
                            {s.jenjang}
                          </span>
                        </div>
            ...
            <div className="p-8 space-y-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pb-4">
                <div className="p-6 bg-maroon-50/30 rounded-3xl border border-maroon-100/50 hover:bg-maroon-50 transition-colors">
                  <h4 className="font-black text-maroon-900 mb-2">
                    Broadcast Jadwal Seleksi
                  </h4>
                  <p className="text-xs text-maroon-700/70 mb-6 font-medium leading-relaxed">
