            ...
            candidates.map((c) => (
              <div key={c.id} className="p-5 space-y-4">
                <div className="flex justify-between items-start gap-4 flex-wrap">
                  ...
                  <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[9px] font-black uppercase shrink-0 border border-stone-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
                    {c.jenjang}
                  </span>
                </div>
                ...
                candidates.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-1 bg-stone-100 text-stone-700 rounded-md text-xs font-bold border border-stone-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
                          {c.jenjang}
                        </span>
                      </td>
                      <td className="px-6 py-4">
