...
export default function HasilSeleksiPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto p-6 sm:p-8 md:p-8">
      ...
      {/* Filters & Actions */}
      <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-stone-200 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <button
          ...
          className="flex items-center justify-center gap-2 px-6 py-2.5 bg-[#550000] hover:bg-[#550000] text-white rounded-3xl font-bold transition-all shadow-2xl shadow-primary/30  shadow-primary/20 shadow-green-200 disabled:shadow-none disabled:bg-stone-300 w-full md:w-auto"
        >
      ...
      {/* Table & Mobile View */}
      <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-stone-200 overflow-hidden">
        {/* Mobile View: Cards */}
            ...
            candidates.map((c) => (
              <div key={c.id} className="p-5 space-y-4">
                <div className="flex justify-between items-start gap-4 flex-wrap">
                  ...
                  <span className="px-2 py-0.5 bg-stone-100 text-stone-600 rounded text-[9px] font-black uppercase shrink-0 border border-stone-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 whitespace-nowrap inline-block shrink-0">
                    {c.jenjang}
                  </span>
                </div>
                ...
                candidates.map((c) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <td className="px-6 py-4">
                        <span className="px-2 py-1 bg-stone-100 text-stone-700 rounded-md text-xs font-bold border border-stone-200 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 whitespace-nowrap inline-block shrink-0">
                          {c.jenjang}
                        </span>
                      </td>
                      <td className="px-6 py-4">
