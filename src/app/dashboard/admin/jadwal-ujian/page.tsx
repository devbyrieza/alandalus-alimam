    ...
    <div className="space-y-6 max-w-[1200px] mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-[#550000]/60 font-medium">
          ...
          <div className="flex flex-col md:flex-row gap-3">
            <button
              ...
              className="flex items-center gap-3 px-6 py-3 bg-indigo-50 hover:bg-indigo-100 text-[#550000] rounded-2xl font-black border border-indigo-200 transition-all whitespace-nowrap inline-block shrink-0"
            >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-2xl p-6 border border-indigo-100 shadow-clay-md flex items-center gap-6">
          <div className="p-6 sm:p-8 bg-emerald-50 rounded-2xl border border-emerald-100">
            <Calendar className="w-8 h-8 text-[#550000]" />
          </div>
          <div>
            ...
            <p className="text-xs mt-2 text-[#550000] font-bold flex items-center gap-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                    ...
                    {selectedPendaftarId ? (
                      ...
                      <div className="flex flex-col gap-3 w-full md:w-64 items-end">
                        <div className="w-full bg-secondary-100 h-2.5 rounded-full overflow-hidden border border-white">
                          <div
                            className="h-full bg-gradient-to-r from-purple-500 to-[#7a0000]"
                            style={{
                        ...
                        <button
                          ...
                          disabled={assigning}
                          className="text-xs font-bold text-purple-600 hover:text-purple-800 hover:bg-purple-50 px-3 py-1.5 rounded-2xl transition-all flex items-center gap-2"
                        >
        ...
        <div className="lg:col-span-4 space-y-4">
          <h2 className="font-black text-ink-900 text-lg flex items-center gap-2 px-2">
            <Users className="w-5 h-5 text-[#550000]" />
            Calon Peserta
          </h2>
          ...
          <div className="bg-white rounded-2xl shadow-clay-md border border-white/40 overflow-hidden flex flex-col h-[600px] sticky top-28">
            <div className="p-6 sm:p-8 border-b border-ink-100 bg-secondary-50/50">
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full bg-white border border-ink-100 rounded-3xl pl-9 pr-4 py-2 text-sm focus:ring-2 focus:ring-indigo-500/10 outline-none"
                />
              </div>
            </div>

            <div className="flex-1 overflow-y-auto p-6 sm:p-8 space-y-2 overscroll-contain custom-scrollbar">
              {filteredPendaftar.length === 0 ? (
                ...
                filteredPendaftar.map((p) => (
                  <div
                    ...
                    className={`p-6 sm:p-8 rounded-3xl border transition-all cursor-pointer flex items-center justify-between group ${
                  ...
                  >
                    ...
                    {selectedPendaftarId === p.id ? (
                      <CheckCircle2 className="w-5 h-5 text-[#550000]" />
                    ) : (
            ...
            <div className="p-6 sm:p-8 bg-[#550000] text-white">
              ...
              <div className="p-5 md:p-8 space-y-6">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="p-4 hover:bg-secondary-100 rounded-2xl transition-colors"
                  >
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-secondary-50 border-none rounded-3xl px-4 py-3 text-sm focus:ring-2 focus:ring-purple-500/10 outline-none font-bold"
                    />
                  </div>
                  ...
                  <div className="bg-purple-50 rounded-3xl p-6 sm:p-8 border border-purple-100 flex items-start gap-3">
      ...
      {sendingProgress.active && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-ink-900/80 backdrop-blur-sm overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-2xl border border-white p-5 md:p-8 text-center animate-pulse">
            ...
            <div className="w-full bg-secondary-100 h-4 rounded-full overflow-hidden mb-4 border border-ink-100">
              <div
                className="h-full bg-gradient-to-r from-purple-500 to-[#7a0000] transition-all duration-500 ease-out"
                style={{
            ...
            <div className="bg-secondary-50 rounded-3xl p-6 sm:p-8 text-left h-32 overflow-hidden flex flex-col-reverse gap-1 border border-ink-100">
        ...
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-ink-900/60 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-3xl w-full max-w-md shadow-clay-lg border border-white overflow-hidden animate-in zoom-in-95 duration-300">
            <div className="p-5 md:p-8 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-2xl font-black text-ink-900">
                  Pulse <span className="text-[#550000]">Notifikasi</span>
                </h2>
                <button
                  onClick={() => setShowBroadcastModal(false)}
                  className="p-4 hover:bg-secondary-100 rounded-2xl"
                >
                  <AlertCircle className="w-5 h-5 text-ink-400 rotate-45" />
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div className="p-6 sm:p-8 bg-indigo-50 rounded-2xl border border-indigo-100">
                  <p className="text-sm font-bold text-[#550000] mb-1">
                    Target Pengiriman
                  </p>
                  ...
                  <p className="text-[11px] text-[#550000]/70 mt-1">
                    {resetFlags
                ...
                <div
                  className="flex items-center gap-3 p-6 sm:p-8 bg-secondary-50 rounded-2xl cursor-pointer"
                  onClick={() => setResetFlags(!resetFlags)}
                >
                  <div
                    className={`w-6 h-6 rounded-2xl border-2 flex items-center justify-center transition-all ${resetFlags ? "bg-[#550000] border-[#550000]" : "bg-white border-ink-100"}`}
                  >
                    {resetFlags && (
                ...
                <div className="bg-secondary-50 rounded-3xl p-6 sm:p-8 border border-secondary-100 flex items-start gap-3">
