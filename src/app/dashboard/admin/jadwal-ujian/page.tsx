...
export default function JadwalUjianPage() {
  ...
  return (
    <div className="space-y-6 max-w-[1200px] mx-auto">
      ...
      {/* Add Session Modal */}
      {showAddSession && (
        <div className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-ink-900/60 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
      ...
      {sendingProgress.active && (
        <div className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-ink-900/80 backdrop-blur-sm overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
