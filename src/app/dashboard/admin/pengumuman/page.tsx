  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white p-6 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-stone-100">
        ...
        <div className="bg-primary-50 p-6 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-primary-100">
          <p className="text-primary-600 text-sm font-medium">
            Proses Seleksi (Belum Selesai)
          </p>
          <h3 className="text-2xl font-bold text-primary-700">{stats.ready}</h3>
        </div>
        <div className="bg-green-50 p-6 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-green-100">
      ...
      {/* Filters & Actions */}
      <div className="bg-white p-6 sm:p-8 rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 border border-stone-100 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <button
          ...
          className="flex items-center gap-2 px-6 py-2.5 bg-[#550000] hover:bg-[#550000] disabled:bg-stone-300 text-white rounded-3xl font-bold transition-all shadow-2xl shadow-primary/30  shadow-primary/20 shadow-green-200 disabled:shadow-none"
        >
          {isPublishing ? (
            "Memproses..."
          ) : (
      ...
      {/* Table & Mobile View */}
      <div className="bg-white rounded-3xl shadow-2xl shadow-primary/30  shadow-primary/20 border border-stone-200 overflow-hidden">
        {/* Mobile View: Cards */}
