                  ...
                  {filteredAssignments.map((item) => (
                    ...
                    >
                      ...
                      <div className="flex items-start gap-5 mb-6">
                        <div
                          className={`p-4 rounded-[1.5rem] font-bold text-center min-w-[85px] shrink-0 border flex flex-col justify-center shadow-sm ${isToday(item.tanggal_ujian) ? "bg-maroon-600 text-white border-maroon-500" : "bg-maroon-50 border-maroon-100 text-maroon-900"}`}
                        >
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2 mb-3">
                            <span className="px-3 py-1 bg-maroon-50 text-maroon-700 border border-maroon-100 rounded-lg text-[9px] font-black uppercase tracking-[0.15em]">
                              {item.pendaftar.jenjang}
                            </span>
                            <span className="px-3 py-1 bg-gold-400 text-maroon-950 rounded-lg text-[9px] font-black uppercase tracking-[0.15em] flex items-center gap-1.5">
                              <Hash className="w-3.5 h-3.5" />{" "}
                              {item.pendaftar.nomor_pendaftaran}
                            </span>
                          </div>
                          <h3 className="text-lg md:text-2xl font-black text-maroon-950 font-display leading-tight mb-2">
                          ...
                          <div className="flex items-center gap-2 text-xs text-ink-500 font-bold">
                            ...
                            <span className="text-maroon-700 uppercase tracking-widest font-black">
                              {item.jenis_tugas}
                            </span>
                          </div>
                        </div>
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-6 px-4 py-4 bg-maroon-50/30 rounded-2xl border border-maroon-100/50">
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-sm text-maroon-950 font-black">
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          <div className="flex flex-col">
                            ...
                            <span className="text-sm text-maroon-950 font-black truncate">
                              {item.lokasi || "Online"}
                            </span>
                          </div>
                        </div>
                            ...
                            {userId &&
                              ...
                              (item.status_santri === "completed" ? (
                                ...
                                <button
                                  ...
                                  className="w-full py-4 bg-maroon-600 hover:bg-maroon-700 text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl transition-all active:scale-95 shadow-lg shadow-maroon-600/20"
                                >
          ...
          <div className="bg-white p-6 md:p-8 rounded-[2rem] border border-gold-100 shadow-sm app-card relative overflow-hidden">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
              <div className="max-w-md">
                <h3 className="text-xl font-black text-maroon-950 font-display tracking-tight mb-2">
                ...
                {!isSelectMode ? (
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-3 bg-maroon-50 text-maroon-700 rounded-xl font-black text-xs border border-maroon-100 hover:bg-maroon-100 transition-all"
                    >
              ...
              {slots.map((slot) => (
                <div
                  ...
                  className={`bg-white rounded-[2rem] p-6 border shadow-sm transition-all group relative app-card ${
                    isSelectMode
                      ? "cursor-pointer hover:border-maroon-300"
                      : "hover:shadow-xl hover:shadow-maroon-600/5"
                  } ${
                    selectedSlotIds.has(slot.id)
                      ? "border-maroon-400 ring-2 ring-maroon-200 shadow-maroon-100"
                      : "border-gold-100"
                  }`}
                >
                  ...
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h4 className="font-black text-lg text-maroon-950 font-display leading-tight">
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-maroon-950/40 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md overflow-hidden border border-white/20 animate-in zoom-in-95 duration-300">
            <div className="p-6 border-b border-stone-100 flex justify-between items-center bg-stone-50/50">
              <div>
                <h3 className="text-xl font-black text-maroon-950 tracking-tight leading-none">
                  Edit Massal
                </h3>
            ...
            <form onSubmit={handleBulkEdit} className="p-8 space-y-5">
              {/* Waktu */}
              <div
                className={`p-4 rounded-2xl border-2 transition-all ${bulkEditForm.changeTime ? "border-maroon-300 bg-maroon-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                  ...
                  <div className="grid grid-cols-2 gap-3 mt-2">
                    <div>
                      ...
                      <input
                        type="time"
                        required
                        className="w-full px-3 py-2.5 bg-white border border-stone-200 rounded-xl font-bold text-maroon-950 text-sm focus:ring-2 focus:ring-maroon-400 outline-none"
              ...
              {/* Lokasi */}
              <div
                className={`p-4 rounded-2xl border-2 transition-all ${bulkEditForm.changeLocation ? "border-maroon-300 bg-maroon-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                <label className="flex items-center gap-3 cursor-pointer mb-3">
                  <input
                    type="checkbox"
                ...
                {bulkEditForm.changeLocation && (
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-white border border-stone-200 rounded-xl font-bold text-maroon-950 text-sm focus:ring-2 focus:ring-maroon-400 outline-none mt-2"
              ...
              {/* Catatan */}
              <div
                className={`p-4 rounded-2xl border-2 transition-all ${bulkEditForm.changeNotes ? "border-maroon-300 bg-maroon-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                <label className="flex items-center gap-3 cursor-pointer mb-3">
                  <input
                    type="checkbox"
                ...
                {bulkEditForm.changeNotes && (
                  <textarea
                    ...
                    className="w-full px-3 py-2.5 bg-white border border-stone-200 rounded-xl font-bold text-maroon-950 text-sm focus:ring-2 focus:ring-maroon-400 outline-none resize-none mt-2"
              ...
              <div className="flex gap-3 pt-2">
                ...
                <button
                  ...
                  className="flex-1 py-3.5 bg-maroon-600 hover:bg-maroon-700 disabled:opacity-40 text-white rounded-2xl font-black text-xs uppercase tracking-widest transition-all flex items-center justify-center gap-2 shadow-lg shadow-maroon-600/20"
                >
                  {submittingBulkEdit ? (
            ...
            <form onSubmit={handleCreateSlot} className="p-8 space-y-6">
              ...
              <div className="space-y-3">
                <div className="bg-maroon-600 rounded-2xl p-4 shadow-lg shadow-maroon-950/20 text-white flex items-start gap-3 relative overflow-hidden group">
                  ...
                  <div>
                    <p className="text-[10px] text-maroon-100 font-black uppercase tracking-widest mb-0.5">
                      Informasi Otomatis
                    </p>
        ...
        <div className="fixed inset-0 z-[60] flex items-center justify-center p-4 bg-maroon-950/40 backdrop-blur-md animate-in fade-in duration-300">
          <div className="bg-white rounded-[40px] shadow-2xl w-full max-w-lg max-h-[90vh] flex flex-col animate-in zoom-in-95 duration-300 border border-white/20">
            ...
            <div className="p-8 border-b border-stone-100 flex justify-between items-center bg-stone-50/50 rounded-t-[40px] shrink-0">
              <div>
                <h3 className="text-2xl font-black text-maroon-950 tracking-tight leading-tight">
                  Buat Jadwal Massal
                </h3>
            ...
            >
              ...
              <div className="bg-maroon-600 rounded-3xl p-6 shadow-xl shadow-maroon-950/20 text-white relative overflow-hidden">
                ...
                <p className="text-[10px] text-maroon-100 font-black uppercase tracking-widest mb-1.5 leading-none">
                  Mata Ujian Terpilih
                </p>
                <div className="flex items-center gap-3">
              ...
              <div className="bg-gold-50 rounded-3xl p-6 border border-gold-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-maroon-900 leading-relaxed font-bold">
                    ...
                    <span className="text-maroon-600">Online</span> dan memiliki{" "}
