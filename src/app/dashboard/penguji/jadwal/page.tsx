...
export default function JadwalPengujiPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {message && (
        <div
          className={`p-6 sm:p-8 rounded-3xl border-2 flex items-center justify-between ${message.type === "success" ? "bg-green-50 border-green-200 text-[#550000]" : "bg-red-50 border-red-200 text-red-800"}`}
        >
      ...
      {activeTab === "assigned" && (
        <>
          {loadingAssignments ? (
            ...
            <div className="bg-white rounded-3xl p-6 md:p-12 border-2 border-secondary-200 text-center">
                      ...
                      <div className="flex items-start gap-5 mb-6">
                        ...
                        <div className="flex-1 min-w-0">
                          <div className="flex flex-wrap items-center gap-2 mb-3">
                            <span className="px-3 py-1 bg-primary-50 text-primary-700 border border-primary-100 rounded-2xl text-[9px] font-black uppercase tracking-[0.15em]">
                              {item.pendaftar.jenjang}
                            </span>
                            <span className="px-3 py-1 bg-gold-400 text-primary-950 rounded-2xl text-[9px] font-black uppercase tracking-[0.15em] flex items-center gap-1.5">
                          ...
                          <div className="flex flex-col gap-2">
                            {userId &&
                              ...
                              (item.status_santri === "completed" ? (
                                <div className="flex items-center gap-2 px-4 py-3 bg-green-50 text-[#550000] rounded-2xl text-sm font-bold border border-green-100">
                ...
                {!isSelectMode ? (
                  <>
                    {slots.length > 0 && (
                      <>
                        <button
                          ...
                          className="w-full sm:w-auto flex items-center justify-center gap-2 px-5 py-4 bg-stone-50 hover:bg-stone-100 text-stone-600 rounded-2xl font-black border border-stone-200 transition-all text-xs uppercase tracking-widest active:scale-95 whitespace-nowrap inline-block shrink-0"
                        >
                    ...
                    <button
                      ...
                      className="w-full sm:w-auto flex items-center justify-center gap-3 px-6 py-4 bg-primary-50 hover:bg-primary-100 text-primary-700 rounded-2xl font-black border border-primary-100 transition-all text-xs uppercase tracking-widest active:scale-95 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 whitespace-nowrap inline-block shrink-0"
                    >
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-3 bg-primary-50 text-primary-700 rounded-3xl font-black text-xs border border-primary-100 hover:bg-primary-100 transition-all whitespace-nowrap inline-block shrink-0"
                    >
                    ...
                    <button
                      ...
                      className="px-4 py-3 border border-stone-200 text-stone-500 rounded-3xl font-black text-xs hover:bg-stone-50 transition-all"
                    >
                      Batal
                    </button>
                  </div>
                ...
                >
                  ...
                  >
                    <button
                      ...
                      className="p-4.5 text-ink-300 hover:text-primary-600 hover:bg-primary-50 rounded-full transition-all active:scale-90"
                      title="Edit Sesi"
                    >
                    ...
                    <button
                      ...
                      className="p-4.5 text-ink-300 hover:text-red-600 hover:bg-red-50 rounded-full transition-all active:scale-90"
                      title="Hapus Sesi"
                    >
          ...
          <div className="flex items-center gap-4 bg-primary-950 text-white px-6 py-4 rounded-[2rem] shadow-2xl shadow-primary-950/40">
            ...
            {bulkActionType === "edit" && (
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-gold-400 text-primary-950 rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-gold-300 transition-all active:scale-95"
              >
            ...
            {bulkActionType === "delete" && (
              <button
                ...
                className="flex items-center gap-2 px-5 py-2.5 bg-red-500 text-white rounded-3xl font-black text-xs uppercase tracking-widest hover:bg-red-600 transition-all active:scale-95"
              >
            ...
            <button
              onClick={exitSelectMode}
              className="px-4 py-2.5 border border-white/20 text-white/70 hover:text-white rounded-3xl font-black text-xs transition-all"
            >
              Batal
            </button>
          </div>
      ...
      {/* MODAL BULK EDIT */}
      {isBulkEditModalOpen && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-primary-950/40 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-[32px] shadow-2xl w-full max-w-md overflow-hidden border border-white/20 animate-in zoom-in-95 duration-300">
            <div className="p-5 md:p-6 border-b border-stone-100 flex justify-between items-center bg-white/95 backdrop-blur rounded-t-[32px] shrink-0 sticky top-0 z-30 shadow-xs">
              ...
              <button
                ...
                className="p-4 hover:bg-stone-200 rounded-full transition-colors text-stone-400"
              >
            ...
            <form onSubmit={handleBulkEdit} className="p-5 md:p-8 space-y-5 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              {/* Waktu */}
              <div
                className={`p-6 sm:p-8 rounded-2xl border-2 transition-all ${bulkEditForm.changeTime ? "border-primary-300 bg-primary-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
              ...
              {/* Lokasi */}
              <div
                className={`p-6 sm:p-8 rounded-2xl border-2 transition-all ${bulkEditForm.changeLocation ? "border-primary-300 bg-primary-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                <label className="flex items-center gap-3 cursor-pointer mb-3">
                  <input
                    type="checkbox"
                ...
                {bulkEditForm.changeLocation && (
                  <input
                    ...
                    className="w-full px-3 py-2.5 bg-white border border-stone-200 rounded-3xl font-bold text-primary-950 text-sm focus:ring-2 focus:ring-primary-400 outline-none mt-2"
              ...
              {/* Catatan */}
              <div
                className={`p-6 sm:p-8 rounded-2xl border-2 transition-all ${bulkEditForm.changeNotes ? "border-primary-300 bg-primary-50/30" : "border-stone-100 bg-stone-50/50"}`}
              >
                <label className="flex items-center gap-3 cursor-pointer mb-3">
                  <input
                    type="checkbox"
                ...
                {bulkEditForm.changeNotes && (
                  <textarea
                    ...
                    className="w-full px-3 py-2.5 bg-white border border-stone-200 rounded-3xl font-bold text-primary-950 text-sm focus:ring-2 focus:ring-primary-400 outline-none resize-none mt-2"
            ...
            <form onSubmit={handleEditSlot} className="p-5 md:p-8 space-y-5 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              ...
              <div>
                ...
                <input
                  type="date"
                  required
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-3xl focus:ring-2 focus:ring-primary-500 outline-none font-bold text-primary-950 transition-all"
                  value={editForm.date}
                  onChange={(e) =>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    type="time"
                    required
                    className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-3xl focus:ring-2 focus:ring-primary-500 outline-none font-bold text-primary-950"
              ...
              <div>
                ...
                <textarea
                  ...
                  className="w-full px-4 py-3 bg-stone-50 border border-stone-200 rounded-3xl focus:ring-2 focus:ring-primary-500 outline-none font-bold text-primary-950 resize-none"
            ...
            <form onSubmit={handleCreateSlot} className="p-5 md:p-8 space-y-6 overflow-y-auto overscroll-contain custom-scrollbar flex-1">
              ...
              {ADMIN_ROLES.includes(activeRole) ? (
                ...
                <div>
                  ...
                  <div className="w-full px-4 py-3 bg-primary-50/50 border border-primary-100 rounded-3xl text-primary-900 font-black flex items-center gap-2 shadow-inner">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-emerald-50 rounded-2xl p-6 sm:p-8 border border-emerald-100 flex items-start gap-3">
                  <div className="w-8 h-8 bg-emerald-100 rounded-3xl flex items-center justify-center shrink-0 text-[#550000] whitespace-nowrap inline-block shrink-0">
                    <Users className="w-4 h-4" />
                  </div>
                  <div>
                    <p className="text-[10px] text-[#550000] font-black uppercase tracking-widest mb-0.5">
                      Kapasitas
                    </p>
                    <p className="text-[11px] text-[#550000] leading-relaxed font-medium">
      ...
      {isDetailModalOpen && selectedPendaftar && (
        <div onWheel={(e) => e.stopPropagation()} data-modal="true" aria-modal="true" role="dialog" className="fixed inset-0 z-50 flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-black/50 backdrop-blur-sm overflow-hidden overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
          <div className="bg-white rounded-2xl shadow-2xl shadow-primary/30 w-full max-w-lg max-h-[90vh] flex flex-col">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="col-span-1 sm:col-span-2">
                    ...
                    <p className="font-mono font-bold text-[#550000]">
            ...
            <div className="p-6 sm:p-8 border-t border-secondary-100 bg-secondary-50 rounded-b-2xl shrink-0">
              <button
                onClick={() => setIsDetailModalOpen(false)}
                className="w-full py-2.5 bg-secondary-200 hover:bg-secondary-200 text-ink-900 font-bold rounded-3xl transition-colors"
              >
                Tutup
              </button>
            </div>
            ...
            >
              ...
              {["admin_super", "admin"].includes(activeRole) && (
                <div className="space-y-3">
                  ...
                  <select
                    className="w-full px-5 py-4 bg-stone-100/50 border border-stone-200 text-stone-900 font-bold rounded-2xl focus:ring-4 focus:ring-primary-500/20 focus:border-primary-500 transition-all appearance-none outline-none whitespace-nowrap inline-block shrink-0"
                    value={selectedCreatorId}
                    onChange={(e) => {
                      setSelectedCreatorId(e.target.value);
              ...
              <div className="bg-primary-600 rounded-3xl p-6 shadow-2xl shadow-primary/30  shadow-primary-950/20 text-white relative overflow-hidden">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 bg-white/20 backdrop-blur-md rounded-3xl flex items-center justify-center text-xl shadow-inner">
              ...
              <div className="bg-gold-50 rounded-3xl p-6 border border-gold-100 flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-primary-900 leading-relaxed font-bold">
                    ...
                    <span className="text-[#550000]">Kuota 1 Santri</span>.
                  </p>
                </div>
              </div>
