...
export default function JadwalPengujiPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* MODAL BULK EDIT */}
      {isBulkEditModalOpen && (
        <div className="fixed inset-0 z-[60] flex items-start md:items-center pt-10 md:pt-0 pb-20 md:pb-0 justify-center p-6 sm:p-8 bg-primary-950/40 backdrop-blur-md animate-in fade-in duration-300 overflow-y-auto overflow-x-hidden overscroll-contain custom-scrollbar">
