                ...
                {!isSelectMode ? (
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex items-center gap-2 px-4 py-3 bg-primary-50 text-primary-700 rounded-3xl font-black text-xs border border-primary-100 hover:bg-primary-100 transition-all"
                    >
            ...
            <form onSubmit={handleCreateSlot} className="p-5 md:p-8 space-y-6">
              ...
              <div className="space-y-3">
                ...
                <div className="bg-emerald-50 rounded-2xl p-6 sm:p-8 border border-emerald-100 flex items-start gap-3">
                  <div className="w-8 h-8 bg-emerald-100 rounded-3xl flex items-center justify-center shrink-0 text-[#550000]">
