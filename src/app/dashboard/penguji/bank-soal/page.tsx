    ...
    <div className="min-h-screen bg-[#faf8f5] p-3 sm:p-5 md:p-8 space-y-5 md:space-y-6 max-w-[1400px] mx-auto pb-16">
        ...
        <div className="relative z-10 space-y-3.5">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-[#ddc192] text-xs md:text-sm max-w-3xl leading-relaxed font-medium">
              Pusat peninjauan instrumen tes seleksi (Akademik, Kesiapan, Kepribadian) dan rubrik penilaian resmi penguji (Al-Qur'an, Wawancara Santri & Orang Tua) Pesantren Al-Andalus Al-Imam Sukabumi.
            </p>
          </div>
      ...
      {activeTab === "calsan" && (
        <div className="space-y-4">
          ...
          <div className="card-tactile p-5 md:p-7 space-y-6">
            <div className="space-y-4">
