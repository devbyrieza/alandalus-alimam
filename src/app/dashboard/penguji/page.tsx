...
export default function PengujiDashboardPage() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="relative overflow-hidden rounded-4xl bg-linear-to-br from-maroon-700 to-maroon-900 border border-maroon-600 p-8 md:p-14 text-white shadow-2xl shadow-maroon-900/30 app-card">
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="flex items-center gap-6">
            ...
            <div>
              ...
              <p className="text-maroon-100 font-bold max-w-xl text-sm md:text-lg leading-relaxed opacity-90">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
        {statCards.map((card, index) => (
          <div
            key={index}
            className="bg-white rounded-3xl p-5 md:p-8 border border-gold-100 shadow-xs hover:shadow-xl hover:shadow-maroon-900/5 transition-all duration-500 app-card group"
          >
            ...
            <div>
              ...
              <p className="text-2xl md:text-4xl font-black text-maroon-950 font-display tracking-tight leading-none">
                {card.value}
              </p>
            </div>
          </div>
      ...
      {/* Quick Actions */}
      <div className="bg-white rounded-4xl p-8 border border-gold-100 shadow-sm app-card">
        <div className="flex items-center justify-between mb-8">
          <h3 className="text-2xl font-black text-maroon-950 tracking-tight font-display">
            Aksi Cepat
          </h3>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            <div className="absolute top-0 right-0 p-4 opacity-5 group-hover:opacity-10 transition-opacity">
              <Calendar className="w-20 h-20 text-maroon-900" />
            </div>
            <div className="w-16 h-16 bg-gold-400 rounded-2xl flex items-center justify-center shadow-lg shadow-gold-400/20 group-hover:scale-110 group-hover:-rotate-3 transition-all shrink-0">
              <Calendar className="w-8 h-8 text-maroon-950" />
            </div>
            <div>
              <p className="text-xl font-black text-maroon-950 font-display">Lihat Jadwal</p>
          ...
          <Link
            ...
            className="flex items-center gap-6 p-7 bg-maroon-700 hover:bg-maroon-800 rounded-4xl transition-all duration-500 border border-maroon-800 shadow-xl shadow-maroon-900/20 hover:shadow-2xl hover:shadow-maroon-900/30 group relative overflow-hidden"
          >
            ...
            <div>
              ...
              <p className="text-xs font-black text-maroon-100 uppercase tracking-widest mt-1">
