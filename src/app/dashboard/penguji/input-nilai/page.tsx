          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gold-100 shadow-xs">
              <div>
                ...
                <input type="text" value={cawalsanForm.nama_orangtua || ""} onChange={(e) => setOrang TuaForm({ ...cawalsanForm, nama_orangtua: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all placeholder:text-ink-400" placeholder="Nama orangtua/wali" />
              </div>
              <div>
                ...
                <input type="text" value={cawalsanForm.asal || ""} onChange={(e) => setOrang TuaForm({ ...cawalsanForm, asal: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all placeholder:text-ink-400" placeholder="Contoh: Sukabumi, Jakarta" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gold-100 shadow-xs space-y-5 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3">
                  {KATEGORI_OPTIONS.map((opt) => (
                    <label key={opt} className={`flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-xl cursor-pointer border-2 transition-all text-xs sm:text-sm font-black ${cawalsanForm.kategori === opt ? "border-gold-400 bg-gold-50 text-maroon-950 shadow-sm" : "border-ink-50 hover:border-gold-200 bg-ink-50/30 text-ink-700"}`}>
                      <input type="radio" name={`kategori-${p.id}`} value={opt} checked={cawalsanForm.kategori === opt} onChange={() => setOrang TuaForm({ ...cawalsanForm, kategori: opt })} className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 accent-gold-500" />
                      <span>{opt}</span>
                    </label>
                  ))}
                </div>
              ...
              <div>
                ...
                <select value={cawalsanForm.sumber_info || ""} onChange={(e) => setOrang TuaForm({ ...cawalsanForm, sumber_info: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all cursor-pointer">
                  ...
                  <div className="space-y-2">
                    {q.options.map((opt) => (
                      <label key={opt} className={`flex items-start gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-xl cursor-pointer border-2 transition-all text-xs sm:text-sm font-black ${cawalsanForm[q.key] === opt ? "border-gold-400 bg-gold-50 text-maroon-950 shadow-sm" : "border-ink-50 hover:border-gold-200 bg-ink-50/30 text-ink-700"}`}>
                        <input type="radio" name={`${q.key}-${p.id}`} value={opt} checked={cawalsanForm[q.key] === opt} onChange={() => setOrang TuaForm({ ...cawalsanForm, [q.key]: opt })} className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 mt-0.5 accent-gold-500" />
                        <span>{opt}</span>
                      </label>
                    ))}
                  </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gold-100 shadow-xs space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <textarea value={cawalsanForm.catatan || ""} onChange={(e) => setOrang TuaForm({ ...cawalsanForm, catatan: e.target.value })} rows={3} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all resize-none placeholder:text-ink-400" placeholder="Catatan tambahan pewawancara..." />
              </div>
            </div>
