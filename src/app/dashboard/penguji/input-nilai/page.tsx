...
function InputNilaiContent() {
    ...
    <div key={p.id} className="bg-white rounded-3xl sm:rounded-4xl p-5 sm:p-6 md:p-10 border border-secondary-100 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10 shadow-primary-900/5 app-card">
      ...
      <div className="flex items-center justify-between mb-6 sm:mb-8 pb-6 sm:pb-8 border-b border-ink-100/50">
        ...
        {isParticipantFinished(p) && (
          <div className="hidden sm:flex items-center gap-2 bg-emerald-50 text-[#550000] px-4 py-2 rounded-3xl border border-emerald-100 text-[10px] font-black uppercase tracking-widest">
        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div>
              ...
              <textarea value={hafalanForm.catatan_tambahan || ""} onChange={(e) => setHafalanForm({ ...hafalanForm, catatan_tambahan: e.target.value })} className="w-full px-4 sm:px-5 py-4 bg-white border-2 border-teal-100 rounded-3xl sm:rounded-2xl focus:border-teal-500 outline-none font-medium text-teal-950 min-h-[120px] transition-all resize-none" placeholder="Tuliskan catatan tambahan terkait hafalan santri..." />
            </div>
            ...
            {isSaved ? (
              <>
                ...
                <div>
                  ...
                  <span className={`inline-flex items-center px-3 py-1.5 rounded-2xl text-xs font-black uppercase tracking-wider ${p.detail_hafalan?.rekomendasi === "Diterima" ? "bg-teal-100 text-teal-800" : p.detail_hafalan?.rekomendasi === "Cadangan" ? "bg-gold-100 text-gold-800" : "bg-red-100 text-red-800"}`}>{p.detail_hafalan?.rekomendasi || "-"}</span>
                </div>
                {p.catatan_hafalan && (
        ...
        {!isEditing && (
          <div className="flex justify-end mt-4">
            {(!isSaved || !getLockInfo(p.input_at_hafalan).isLocked) ? (
              ...
              <div className="inline-flex items-center gap-2 px-6 py-3.5 bg-stone-100 text-stone-400 rounded-3xl sm:rounded-2xl text-[10px] sm:text-xs font-black uppercase tracking-widest border border-stone-200 whitespace-nowrap shrink-0">
      ...
      <div className="bg-sky-50/50 border border-sky-100 rounded-2xl sm:rounded-3xl p-5 sm:p-5 md:p-8 space-y-5 sm:space-y-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div>
              <label className="block text-[10px] sm:text-xs font-black text-ink-700 uppercase tracking-widest mb-2 sm:mb-3">Catatan Penguji</label>
              <textarea value={lisanArabForm.catatan_tambahan || ""} onChange={(e) => setLisanArabForm({ ...lisanArabForm, catatan_tambahan: e.target.value })} className="w-full px-4 sm:px-5 py-4 bg-white border-2 border-sky-100 rounded-3xl sm:rounded-2xl focus:border-sky-500 outline-none font-medium text-sky-950 min-h-[120px] transition-all resize-none" placeholder="Tuliskan catatan tambahan terkait lisan arab santri..." />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6 bg-white p-5 sm:p-6 rounded-2xl border border-sky-100/50">
            {isSaved ? (
              <>
                ...
                <div>
                  <p className="text-[10px] font-black uppercase tracking-widest text-ink-400 mb-1.5">Rekomendasi</p>
                  <span className={`inline-flex items-center px-3 py-1.5 rounded-2xl text-xs font-black uppercase tracking-wider ${p.detail_lisan_arab?.rekomendasi === "Diterima" ? "bg-sky-100 text-sky-800" : p.detail_lisan_arab?.rekomendasi === "Cadangan" ? "bg-gold-100 text-gold-800" : "bg-red-100 text-red-800"}`}>{p.detail_lisan_arab?.rekomendasi || "-"}</span>
                </div>
    ...
    return (
      <div className="bg-emerald-50/50 border border-emerald-100 rounded-2xl sm:rounded-3xl p-5 sm:p-5 md:p-8 space-y-5 sm:space-y-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 text-sm">
              <div>
                ...
                <input type="number" min="1" max="100" value={quranForm.tajwid || ""} onChange={(e) => setQuranForm({ ...quranForm, tajwid: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-white border-2 border-emerald-100 rounded-3xl sm:rounded-2xl focus:border-emerald-500 outline-none font-black text-emerald-950 transition-all placeholder:text-ink-400" placeholder="0-100" />
              </div>
              <div>
            ...
            <div>
              ...
              <input type="text" value={quranForm.nama_penguji || activeName} readOnly className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-emerald-50/50 border-2 border-emerald-100 rounded-3xl sm:rounded-2xl font-black text-emerald-950 outline-none cursor-not-allowed" />
            </div>
            ...
            <div>
              ...
              <textarea value={quranForm.catatan || ""} onChange={(e) => setQuranForm({ ...quranForm, catatan: e.target.value })} rows={3} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-white border-2 border-emerald-100 rounded-3xl sm:rounded-2xl focus:border-emerald-500 outline-none font-black text-emerald-950 transition-all resize-none placeholder:text-ink-400" placeholder="Catatan tambahan penguji..." />
            </div>
          ...
          <div>
            {isSaved ? (
              <div className="flex flex-col gap-3 py-4 sm:py-5 bg-white/50 rounded-3xl sm:rounded-2xl px-5 sm:px-6 border border-emerald-100/50 shadow-inner">
                <div className="flex items-center gap-3 sm:gap-4">
                  <CheckCircle className="w-6 h-6 sm:w-7 sm:h-7 text-[#550000] shrink-0" />
                  <div className="flex-1">
                    <p className="text-[#550000] font-black text-sm leading-none">Nilai sudah tersimpan.</p>
                    <div className="mt-2 space-y-1">
                      {(p.score_quran != null || p.nilai_tes_quran != null) && (
                        <p className="text-[#550000]/70 text-[10px] sm:text-xs font-black uppercase tracking-widest">
                ...
                {p.input_at_quran && (
                  <div className={`mt-1 flex items-center gap-2 text-[9px] sm:text-[10px] font-bold uppercase tracking-wider ${getLockInfo(p.input_at_quran).isLocked ? "text-red-600" : "text-[#550000]/70"}`}>
              ...
              <div className="flex items-center gap-3 text-[#550000]/50 py-2">
            ...
            {(!isSaved || !getLockInfo(p.input_at_quran).isLocked) ? (
              ...
              <div className="mt-5 sm:mt-6 inline-flex items-center gap-2 px-6 py-3.5 bg-stone-100 text-stone-400 rounded-3xl sm:rounded-2xl text-[10px] sm:text-xs font-black uppercase tracking-widest border border-stone-200 whitespace-nowrap shrink-0">
                <LockIcon className="w-3.5 h-3.5" /> Edit Terkunci
              </div>
            )}
          </div>
    ...
    return (
      <div className="bg-primary-50/50 border border-primary-100 rounded-2xl sm:rounded-3xl p-5 sm:p-5 md:p-8 space-y-5 sm:space-y-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
        ...
        {isEditing ? (
            ...
            <div className="space-y-5 sm:space-y-6 pt-2">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-5 sm:gap-6">
                ...
                <div className="space-y-3 sm:space-y-4">
                  ...
                  <input type="text" value={calsanForm.nama_pewawancara || activeName} readOnly className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-primary-50/50 border-2 border-primary-100 rounded-3xl sm:rounded-2xl font-black text-primary-950 outline-none cursor-not-allowed" />
                </div>
              </div>
              ...
              <div>
                ...
                <textarea value={calsanForm.catatan || ""} onChange={(e) => setSantriForm({ ...calsanForm, catatan: e.target.value })} rows={4} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/50 border-2 border-ink-100 rounded-3xl sm:rounded-2xl focus:border-primary-500 outline-none font-black text-primary-950 transition-all resize-none placeholder:text-ink-400" placeholder="Catatan pewawancara..." />
              </div>
            </div>
          ...
          <div>
            {isSaved ? (
              <div className="flex flex-col gap-3 py-4 sm:py-5 bg-white/50 rounded-3xl sm:rounded-2xl px-5 sm:px-6 border border-primary-100/50 shadow-inner">
                <div className="flex items-center gap-3 sm:gap-4">
    ...
    return (
      <div className="bg-secondary-50/50 border border-secondary-100 rounded-2xl sm:rounded-3xl p-5 sm:p-5 md:p-8 space-y-5 sm:space-y-6 shadow-2xl shadow-primary/30  shadow-primary/20  shadow-primary/10">
        ...
        {isEditing ? (
          <div className="space-y-5 sm:space-y-6">
            {(() => {
              ...
              return (
                <>
                  ...
                  <div className={isInputtedByAdmin ? "opacity-60 pointer-events-none grayscale" : ""}>
            {/* Dasar Informasi */}
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 bg-white rounded-3xl sm:rounded-2xl p-5 sm:p-6 border border-secondary-100 shadow-xs">
              <div>
                ...
                <input type="text" value={cawalsanForm.nama_orangtua || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, nama_orangtua: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-3xl sm:rounded-2xl focus:border-secondary-500 outline-none font-black text-primary-950 transition-all placeholder:text-ink-400" placeholder="Nama orangtua/wali" />
              </div>
              <div>
                ...
                <input type="text" value={cawalsanForm.asal || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, asal: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-3xl sm:rounded-2xl focus:border-secondary-500 outline-none font-black text-primary-950 transition-all placeholder:text-ink-400" placeholder="Contoh: Sukabumi, Jawa Barat" />
              </div>
            </div>

            {/* Kategori & Sumber */}
            <div className="bg-white rounded-3xl sm:rounded-2xl p-5 sm:p-6 border border-secondary-100 shadow-xs space-y-5 sm:space-y-6">
              <div>
              ...
              <div>
                ...
                <select value={cawalsanForm.sumber_info || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, sumber_info: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-3xl sm:rounded-2xl focus:border-secondary-500 outline-none font-black text-primary-950 transition-all cursor-pointer">
            ...
            <div className="space-y-3 sm:space-y-4">
              {CAWALSAN_QUESTIONS.map((q) => (
                <div key={q.key} className="bg-white rounded-3xl sm:rounded-2xl p-5 sm:p-6 border border-secondary-100 shadow-xs">
            ...
            <div className="bg-white rounded-3xl sm:rounded-2xl p-5 sm:p-6 border border-secondary-100 shadow-xs space-y-5 sm:space-y-6">
              <div>
                ...
                <textarea value={cawalsanForm.karakter || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, karakter: e.target.value })} rows={3} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-3xl sm:rounded-2xl focus:border-secondary-500 outline-none font-black text-primary-950 transition-all resize-none placeholder:text-ink-400" placeholder="Deskripsikan karakter santri yang menonjol..." />
              </div>
              ...
              <div>
                <label className="block text-[10px] sm:text-xs font-black text-ink-800 uppercase tracking-widest mb-2 sm:mb-3">Nama Pewawancara (Otomatis)</label>
                <input type="text" value={cawalsanForm.nama_pewawancara || activeName} readOnly className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-secondary-50/50 border-2 border-ink-100 rounded-3xl sm:rounded-2xl font-black text-primary-950 outline-none cursor-not-allowed" />
              </div>
              ...
              <div>
                ...
                <textarea value={cawalsanForm.catatan || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, catatan: e.target.value })} rows={3} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-3xl sm:rounded-2xl focus:border-secondary-500 outline-none font-black text-primary-950 transition-all resize-none placeholder:text-ink-400" placeholder="Catatan tambahan pewawancara..." />
              </div>
            </div>
          ...
          <div>
            {isSaved ? (
              <div className="flex flex-col gap-3 py-4 sm:py-5 bg-white/50 rounded-3xl sm:rounded-2xl px-5 sm:px-6 border border-secondary-100/50 shadow-inner">
                <div className="flex items-center gap-3 sm:gap-4">
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 sm:space-y-8 pb-32">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between relative z-10 gap-6">
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <div>
              ...
              <p className="text-xs sm:text-sm font-bold text-ink-700 mt-2">Total Terdaftar: <span className="text-primary-700 bg-primary-50 px-2 py-0.5 rounded-2xl border border-primary-100/50">{peserta.length} peserta</span></p>
            </div>
          </div>
        </div>
      ...
      {/* Message */}
      {message && (
        <div className={`mb-4 p-6 sm:p-8 rounded-3xl flex items-center gap-2 text-sm font-semibold ${message.type === "success" ? "bg-green-50 text-[#550000] border border-green-200" : "bg-red-50 text-red-700 border border-red-200"}`}>
