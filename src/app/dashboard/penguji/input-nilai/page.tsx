    ...
    return (
      <div className="bg-maroon-50/50 border border-maroon-100 rounded-2xl sm:rounded-3xl p-5 sm:p-8 space-y-5 sm:space-y-6 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-lg sm:text-xl font-black text-maroon-900 tracking-tight">Seleksi Wawancara Calon Santri</h3>
          {isSaved && !isEditing && (
          ...
          <div className="space-y-5 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 gap-2 sm:gap-3">
                  {criterion.options.map((opt) => (
                    <label key={opt.value} className={`flex items-start gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-xl cursor-pointer border-2 transition-all text-xs sm:text-sm font-black ${calsanForm[criterion.key] === opt.value ? "border-maroon-600 bg-maroon-50 text-maroon-900 shadow-sm" : "border-ink-100 hover:border-maroon-200 bg-ink-50/30 text-ink-700"}`}>
                      <input type="radio" name={`calsan-${criterion.key}-${p.id}`} value={opt.value} checked={calsanForm[criterion.key] === opt.value} onChange={() => setSantriForm({ ...calsanForm, [criterion.key]: opt.value })} className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 mt-0.5 accent-maroon-600" />
                      <span>{opt.label}</span>
                    </label>
                  ))}
                </div>
            ...
            <div className="space-y-5 sm:space-y-6 pt-2">
                  ...
                  <div className="grid grid-cols-1 gap-2 sm:gap-3">
                    {[
                      ...
                      <label key={opt} className={`flex items-start gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-xl cursor-pointer border-2 transition-all text-xs sm:text-sm font-black ${calsanForm.rekomendasi === opt ? "border-maroon-600 bg-maroon-50 text-maroon-900 shadow-sm" : "border-ink-100 hover:border-maroon-200 bg-ink-50/30 text-ink-700"}`}>
                        <input type="radio" name={`rekom-calsan-${p.id}`} value={opt} checked={calsanForm.rekomendasi === opt} onChange={() => setSantriForm({ ...calsanForm, rekomendasi: opt })} className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 mt-0.5 accent-maroon-600" />
                        <span>{opt}</span>
                      </label>
                    ))}
                  </div>
              ...
              <div>
                ...
                <textarea value={calsanForm.catatan || ""} onChange={(e) => setSantriForm({ ...calsanForm, catatan: e.target.value })} rows={4} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/50 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-maroon-500 outline-none font-black text-maroon-950 transition-all resize-none placeholder:text-ink-400" placeholder="Catatan pewawancara..." />
              </div>
            </div>
            ...
            {isSaved ? (
              <div className="flex flex-col gap-3 py-4 sm:py-5 bg-white/50 rounded-xl sm:rounded-2xl px-5 sm:px-6 border border-maroon-100/50 shadow-inner">
                <div className="flex items-center gap-3 sm:gap-4">
                  ...
                  <div>
                    <p className="text-maroon-950 font-black text-sm leading-none">Hasil Wawancara Calon Santri sudah tersimpan.</p>
    ...
    return (
      <div className="bg-gold-50/50 border border-gold-100 rounded-2xl sm:rounded-3xl p-5 sm:p-8 space-y-5 sm:space-y-6 shadow-sm">
        <div className="flex items-center gap-3 mb-2">
          ...
          <h3 className="text-lg sm:text-xl font-black text-maroon-950 tracking-tight">Seleksi Wawancara Orang Tua/Wali</h3>
          {isSaved && !isEditing && (
          ...
          <div className="space-y-5 sm:space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5 sm:gap-6 bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gold-100 shadow-xs">
              <div>
                ...
                <input type="text" value={cawalsanForm.nama_orangtua || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, nama_orangtua: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all placeholder:text-ink-400" placeholder="Nama orangtua/wali" />
              </div>
              <div>
                ...
                <input type="text" value={cawalsanForm.asal || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, asal: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all placeholder:text-ink-400" placeholder="Contoh: Sukabumi, Jakarta" />
              </div>
            </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gold-100 shadow-xs space-y-5 sm:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-2 sm:gap-3">
                  {KATEGORI_OPTIONS.map((opt) => (
                    <label key={opt} className={`flex items-center gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-xl cursor-pointer border-2 transition-all text-xs sm:text-sm font-black ${cawalsanForm.kategori === opt ? "border-gold-400 bg-gold-50 text-maroon-950 shadow-sm" : "border-ink-50 hover:border-gold-200 bg-ink-50/30 text-ink-700"}`}>
                      <input type="radio" name={`kategori-${p.id}`} value={opt} checked={cawalsanForm.kategori === opt} onChange={() => setOrangTuaForm({ ...cawalsanForm, kategori: opt })} className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 accent-gold-500" />
                      <span>{opt}</span>
                    </label>
                  ))}
                </div>
              ...
              <div>
                ...
                <select value={cawalsanForm.sumber_info || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, sumber_info: e.target.value })} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all cursor-pointer">
                  ...
                  <div className="space-y-2">
                    {q.options.map((opt) => (
                      <label key={opt} className={`flex items-start gap-3 sm:gap-4 p-3.5 sm:p-4 rounded-xl cursor-pointer border-2 transition-all text-xs sm:text-sm font-black ${cawalsanForm[q.key] === opt ? "border-gold-400 bg-gold-50 text-maroon-950 shadow-sm" : "border-ink-50 hover:border-gold-200 bg-ink-50/30 text-ink-700"}`}>
                        <input type="radio" name={`${q.key}-${p.id}`} value={opt} checked={cawalsanForm[q.key] === opt} onChange={() => setOrangTuaForm({ ...cawalsanForm, [q.key]: opt })} className="w-4 h-4 sm:w-5 sm:h-5 shrink-0 mt-0.5 accent-gold-500" />
                        <span>{opt}</span>
                      </label>
                    ))}
                  </div>
            ...
            <div className="bg-white rounded-xl sm:rounded-2xl p-5 sm:p-6 border border-gold-100 shadow-xs space-y-5 sm:space-y-6">
              ...
              <div>
                ...
                <textarea value={cawalsanForm.catatan || ""} onChange={(e) => setOrangTuaForm({ ...cawalsanForm, catatan: e.target.value })} rows={3} className="w-full px-4 sm:px-5 py-3.5 sm:py-4 bg-ink-50/30 border-2 border-ink-100 rounded-xl sm:rounded-2xl focus:border-gold-500 outline-none font-black text-maroon-950 transition-all resize-none placeholder:text-ink-400" placeholder="Catatan tambahan pewawancara..." />
              </div>
            </div>
