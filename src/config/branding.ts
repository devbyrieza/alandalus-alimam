export const BRANDING = {
  ...
  address: process.env.NEXT_PUBLIC_ADDRESS || "Jl. KH Mama Oyon, Cihaur, Kec. Cicantayan, Kabupaten Sukabumi, Jawa Barat 43155",
  phone: process.env.NEXT_PUBLIC_PHONE || "+62 851-1152-4441",
  email: process.env.NEXT_PUBLIC_EMAIL || "alandalusalimam@gmail.com",
  igUrl: process.env.NEXT_PUBLIC_IG_URL || "https://www.instagram.com/alandalusalimam/",
  ytUrl: process.env.NEXT_PUBLIC_YT_URL || "#",
  fbUrl: process.env.NEXT_PUBLIC_FB_URL || "https://www.facebook.com/wahab.rajasam/",
};
